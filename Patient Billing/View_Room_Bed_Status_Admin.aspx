<%@ Page Language="VB" AutoEventWireup="false" CodeFile="View_Room_Bed_Status_Admin.aspx.vb"
    MasterPageFile="~/hacims_masterpage_admin.master" Inherits="Patient_Billing_View_Room_Bed_Status_Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="Div1" runat="server" style="margin-top:5px; margin-bottom:5px;" >


<asp:FormView ID="FormView1" runat="server"  HorizontalAlign="Left" Width="100%"><EditItemTemplate>
                PayID:
...
<asp:HiddenField ID="HiddenField_Pfname" runat="server" Value='<%# Eval("pfname", "{0}") %>' />
  ...
  <asp:SqlDataSource ID="patient_detail" runat="server" ConnectionString="<%$ ConnectionStrings:Reg_ConnectionString %>"
    ...
    <asp:Button ID="btnallbill" runat="server" OnClick="btnallbill_Click" Text="All Patient Running Bill" style="margin-left: 1173px;" />
    ...
    <asp:Panel ID="pnlGrid" runat="server" Visible="true">
        ...
        <asp:GridView ID="GridViewTest" runat="server" AutoGenerateColumns="False" CssClass="Grid_2" ShowFooter="true" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Reg_No" HeaderText="Reg No"  ItemStyle-Width="95px" ControlStyle-Width="85px"  HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                ...
                <asp:BoundField DataField="Remarks" HeaderText="Remarks" SortExpression="RemarkRoom/Bed Details" />
                ...
                <asp:TemplateField  HeaderText="Running Bill" >
                 ...
                 <asp:TemplateField  HeaderText="Collection Summary" >
                    <ItemTemplate>
                        <asp:LinkButton ID="btnCollectionSummary" runat="server" OnClick="btnCollectionSummary_Click" CommandArgument='<%# Eval("Reg_No") %>'
                            ToolTip='<%# Eval("Yearly_No") %>'
                            Text="Collection Summary"></asp:LinkButton>
                    </ItemTemplate>

                </asp:TemplateField>
                <asp:TemplateField  HeaderText="Payment">
                    <ItemTemplate>
                        <asp:LinkButton ID="btnPayment" runat="server" OnClick="btnPayment_Click" CommandArgument='<%# Eval("Reg_No") %>'
                            ToolTip='<%# Eval("Yearly_No") %>'
                            Text="Payment"></asp:LinkButton>
                    </ItemTemplate>
                ...
                <asp:TemplateField Visible="false" HeaderText="Services"   >
                    <ItemTemplate>
                        <asp:LinkButton ID="Slnk_btn" runat="server"  CommandArgument='<%# Eval("Reg_No") %>'
                            ToolTip='<%# Eval("Yearly_No") %>' OnClick="lnk_btn_Click"  >Services</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>


                <asp:TemplateField HeaderText="Out-Standing Bill">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Discharge" Visible="True" ControlStyle-Width="80px">
                    <ItemTemplate>
                        <asp:HiddenField ID="hfDischargeButton" runat="server"  Value='1' />
              ...
              <%--<asp:TemplateField HeaderText="Discharge" Visible="True" ControlStyle-Width="80px">
                ...
                <asp:TemplateField HeaderText="Forward" Visible="false">
                 ...
                 <asp:TemplateField HeaderText="Clearance Status" Visible="false" >
                    <ItemTemplate>
  ...
  <asp:HiddenField ID="reg11" runat ="server" />
     ...
     <asp:HiddenField ID="hf_FloorID" runat ="server" />
        <div style="  margin-left: 97px;    margin-bottom: 47px;    background-color: aquamarine;" >
            <table>
                <tr>
                    <td><b>MR # :</b></td>
                    <td>
    ...
    <asp:SqlDataSource ID="SqlDataSourceFloor" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
        ProviderName="<%$ ConnectionStrings:Basic_Data_ConnectionString.ProviderName %>"
        SelectCommand="SELECT 0 as Ward_id,'--ALL--' as Ward_Name UNION SELECT DISTINCT  Ward_id,Ward_Name FROM  admin_Hospital_Wards WHERE (isDeleted = 0)-- and SubDept_Id=@SubDeptId ">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSourceUpdate" runat="server" CacheExpirationPolicy="Sliding"
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="DisStatus" Type="String" DefaultValue="0" />
             ...
             <asp:ControlParameter ControlID="bedid" Name="bedid" />
             <asp:SessionParameter SessionField="Emp_Id" Name="Dischargeby" Type="Int32" DefaultValue="0" />
        </UpdateParameters>
    </asp:SqlDataSource>
</asp:Content>
