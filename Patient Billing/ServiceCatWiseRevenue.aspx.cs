...
public partial class Patient_Billing_ServiceCatWiseRevenue : System.Web.UI.Page
{
    ...
    private void getDropdown()
    {
        ...
        DataTable dt = dbManager.ExecuteDataTableWithQuery("select 'All' Patient_type,0 as Patient_Type_ID union all select Patient_type,Patient_Type_ID from Patient_type where Active=1 ", "Basic_Data_ConnectionString", new SqlParameter[0]);
    ...
    private void ShowReport()
        ...
        try
        {
            ...
            ds = dbMgr.ExecuteDataSet("Report_ServiceCatWiseRevenue", "Basic_Data_ConnectionString", para);

          
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("ServiceCatWiseRevenue.rdlc");
