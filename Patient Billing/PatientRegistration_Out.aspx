                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="textboxplname" 
                                runat="server" TabIndex="9" SkinID="captxt" MaxLength="20">
                                                </asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="textboxrfname" Style="background-color: #f9dde2;" MaxLength="20"
                                                runat="server" TabIndex="11" SkinID="captxt"></asp:TextBox>
                                           <%-- <span class="marks">*
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="textboxrlname" runat="server" MaxLength="20" class="input_txt"
                                                TabIndex="13" SkinID="captxt"></asp:TextBox>
            ...
            <td width="50%" valign="top">
                <table cellspacing="0" cellpadding="0" border="0" class="tbl_form" width="100%">
                    <tr>
                        ...
                        <td width="35%">
                            ...
                            <asp:TextBox AccessKey="a" ID="textboxage" runat="server" AutoCompleteType="disabled"
                                TabIndex="15" Width="28px" MaxLength="2"></asp:TextBox>&nbsp;<asp:DropDownList ID="DropDownListBIndicator"
                    ...
                    <tr>
                        ...
                        <td width="35%">
                            <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="textboxnic1" TabIndex="17" runat="server" AutoPostBack="True" MaxLength="15"
                    ...
                    <tr>
                        ...
                        <td width="35%">
                            <asp:TextBox ID="textboxmcode" runat="server" TabIndex="18" MaxLength="11" 
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" class="tbl_form" width="100%">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="DropDownList_Employee_name" TabIndex="23" runat="server" DataSourceID="SqlDataSource_Employee"
...
WHERE     (Patient_Billing_Party.Patient_Type_Id = @Party_Type_Id)">
 <SelectParameters>
    ...
    <div align="center">
        ...
        <asp:LinkButton ID="LinkButton1" runat="server" TabIndex="26" 
