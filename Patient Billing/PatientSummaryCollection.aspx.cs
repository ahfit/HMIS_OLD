...
public partial class Patient_Billing_PatientSummaryCollection : System.Web.UI.Page
{
    ...
    protected void LoadReport()
    {
            ...
            try
            {
                ...
                cmd = new SqlCommand("PatientBill_DoctorServices_Summary", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@RegNo", Request.QueryString["RegNo"]);
                ...
                string reportPath = Server.MapPath("PatientSummaryCollection.rdlc");
