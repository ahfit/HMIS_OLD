<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master"
    AutoEventWireup="true" CodeFile="ServicesStrengthActivity.aspx.cs" Inherits="DashBoards_ServicesStrengthActivity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="sdsPatientCount" runat="server"
     ...
     SelectCommand="ServicesStrengthActivity_Report" SelectCommandType="StoredProcedure"
    >
        <SelectParameters>
