...
Partial Class PatientRegistration_Card
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            DropDownList1.SelectedValue = "131"
    ...
    Sub patientinsert()
        ...
        Try
            ...
            Try
                mycommand.Parameters.AddWithValue("@Email_address", TextBox_Email_Address.Text)
            Catch ex As Exception
            ...
            If rblPatientType_Sub.SelectedValue = "4" Then
                mycommand.Parameters.AddWithValue("@S_ID", 0)
                mycommand.Parameters.AddWithValue("@Amount", "0")
            Else
