<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master"
    AutoEventWireup="true" CodeFile="PatientTypeWiseDiscountSummary.aspx.cs" Inherits="Patient_Billing_PatientTypeWiseDiscountSummary" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div class="bxmain inner_content" style="width:100%; margin-bottom:5px;">
        <h2>
            <span>Discount Summary Patient</span>
        </h2>
        <table>
            ...
            <tr>
                ...
                <td style="padding-bottom:5px;width:25%;">
                  <asp:DropDownList ID="ddl_Hospital" runat="server" Width="202px"  Enabled="false">
                ...
                <td style="width:25%;text-align:right;padding-bottom:5px;">
                    Discount Head :</td>
                <td style="padding-bottom:5px;width:25%;">
                    <asp:DropDownList ID="ddlDiscountType" runat="server" Width="202px" >
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
