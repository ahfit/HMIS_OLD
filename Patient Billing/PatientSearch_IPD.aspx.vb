...
Partial Class Patient_Billing_patientsearch_IPD
    ...
    Sub search1(ByVal indx As Integer)
        ...
        GridViewSearch.DataSource = search_DataSet_IPD()
    ...
    End Sub
    Function search_DataSet_IPD() As DataTable
        ...
        Dim search_DSIPD As DataTable = New DataTable()
        Dim objManager As DbManager = New DbManager()

        search_DSIPD = objManager.ExecuteDataTable("Search_Patient_For_Receptionist_IPD", "Reg_ConnectionString", sqlParams)
        Return search_DSIPD
    End Function
        ...
        Try
            ...
            If GridViewSearch.Rows.Count <> 0 Then
                ...
                For i As Integer = 0 To GridViewSearch.Rows.Count - 1
                    ...
                    End If
                    GridViewSearch.Rows(i).Cells(23).Text = GridViewSearch.Rows(i).Cells(21).Text
    ...
    Protected Sub GridViewSearch_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridViewSearch.RowCommand
        ...
        ElseIf e.CommandName = "Services" Then
            ...
            Session.Add("Patient_Type_ID", GridViewSearch.Rows(e.CommandArgument).Cells(19).Text)
        ...
        ElseIf e.CommandName = "IPDSLIP" Then
            ...
            Session.Add("registrationNo", ENC.Encrypt_Main(GridViewSearch.Rows(e.CommandArgument).Cells(8).Text, True))
            Session.Add("YearlyNo", GridViewSearch.Rows(e.CommandArgument).Cells(7).Text)
            Response.Redirect("~/Patient Billing/PatientRunningBill_New_Latest.aspx?regno=" + GridViewSearch.Rows(e.CommandArgument).Cells(8).Text + "&YearlyNo=" + GridViewSearch.Rows(e.CommandArgument).Cells(7).Text)
        ElseIf e.CommandName = "PT_Change_Room" Then

            Session.Add("registrationNo", ENC.Encrypt_Main(GridViewSearch.Rows(e.CommandArgument).Cells(8).Text, True))
            Session.Add("YearlyNo", GridViewSearch.Rows(e.CommandArgument).Cells(7).Text)
            Session.Add("Patient_Type", GridViewSearch.Rows(e.CommandArgument).Cells(24).Text)
            'Response.Redirect("~/PAtient Billing/ChangeRoom.aspx?PT=" + GridViewSearch.Rows(e.CommandArgument).Cells(23).Text)
            Response.Redirect("~/PAtient Billing/ChangeRoom.aspx?PT=" + GridViewSearch.Rows(e.CommandArgument).Cells(24).Text)
