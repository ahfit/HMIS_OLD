<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Patient_Payment.aspx.vb"
    MasterPageFile="~/hacims_masterpage_billing.master" Inherits="Patient_Registration_Indoor_Patient_Paymen" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function Addlabel() {
            alert('Amount Enter is greater than Due Payment... ');
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr align="center">
            ...
            <td>
                <%--<asp:Button ID="btnDiscount" runat="server" Text="Manual Discount" OnClick="btnDiscount_Click"/>--%>
        ...
        <tr>
            <td width="55%" valign="top">
                ...
                <div align="center">
                    &nbsp;<asp:TextBox ID="TXT_Load_patient" runat="server" AutoPostBack="true" Visible="False"></asp:TextBox>
                    <div runat="server" id="DIV_P_Payment">
                        <asp:Button ID="Button_lab_Test" runat="server" Text="Built voucher forward to LAB" Visible="true"  />
                ...
                <div class="bxmain" style="width: 99%;">
                    <asp:GridView ID="GridView_For_Services" runat="server" AutoGenerateColumns="False"
                        DataSourceID="SqlDataSource_For_Grid" Width="98%" EmptyDataText="No Service Assigned">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Amount" HeaderText="Amount" SortExpression="Amount" FooterStyle-Font-Bold="true" />
                            <asp:TemplateField HeaderText="System Discount" SortExpression="SystemDiscount">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_SystemDiscount" runat="server" Text='<%# Bind("SystemDiscount") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:Label ID="lblSystemDiscountTotal" runat="server" Text="0"></asp:Label>
                                </FooterTemplate>
                                <FooterStyle Font-Bold="true" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Manual Discount" SortExpression="ManualDiscount">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_ManualDiscount" runat="server" Text='<%# Bind("ManualDiscount") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:Label ID="lblManualDiscountTotal" runat="server" Text="0"></asp:Label>
                                </FooterTemplate>
                                <FooterStyle Font-Bold="true" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Company">
                                ...
                                <ItemTemplate>
                                    <asp:TextBox ID="TextBox_company"  runat="server" Width="72px" Text='<%# Bind("PanelAmount") %>'></asp:TextBox>
                                </ItemTemplate>
                                <FooterStyle Font-Bold="true" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Patient">
                                ...
                                <ItemTemplate>
                                    <asp:TextBox ID="TextBox_Patient"  Text='<%# Bind("Patient_Value") %>'
                                        runat="server" Width="54px"></asp:TextBox>
                                </ItemTemplate>
                                <FooterStyle Font-Bold="true" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    <asp:CheckBox ID="CheckBox_Header" runat="server" Enabled="true" AutoPostBack="True"
                                        OnCheckedChanged="CheckBox_Header_CheckedChanged" /><br />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField ID="hf_Service_discount" runat="server" Value='<%# Eval("SystemDiscount", "{0}") %>' />
                ...
                <asp:Panel ID="pnl_Radiology_Sample" runat="server" ScrollBars="Horizontal" Width="98%">
                    ...
                    <asp:Button ID="Button_Rad_For_Payment" runat="server" Text="Add to Bill" Visible="false" />
                    <asp:Button ID="Button_CheckAll" runat="server" Text="Check All" Visible="false" />
                    <asp:Button ID="Button_Un_Check_All" runat="server" Text="Uncheck All"  Visible="false"/></asp:Panel>
            </td>
            <td valign="top">
                <div class="bxmain" style="width: 100%;">
                    <h4>
                        <span style="text-align: right; width: 100%; color: Maroon">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            Final Bill :
                            <asp:CheckBox ID="CKFinal" runat="server" AutoPostBack="True" />
                        </span>
                    </h4>
                    <div id="div_final" runat="server" style="display: none">
                        <asp:TextBox ID="txt_remarks" runat="server" Height="160px" TextMode="MultiLine"></asp:TextBox>
                    </div>
                    <p>
                        &nbsp;</p>
                </div>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td valign="top" width="60%">
                                <fieldset class="fset_1" style="width: 94%; margin-left: 2px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl_form">
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label_advance_Pay" runat="server" Text="Advance Payment :"></asp:Label>
                                            </td>
                                            <td colspan="2">
                                                <strong>
                                                    <asp:Label ID="Label_Ad_Payment" runat="server" CssClass="txt_bold"></asp:Label>
                                                </strong>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <asp:Label ID="Label_Discount" runat="server" CssClass="txt_bold" Style="color: #900;
                                                    font-size: 12px; font-weight: bold;">0</asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                            ...
                                            <td colspan="2">
                                                <asp:Label ID="Label_Refund" runat="server" CssClass="txt_bold" Style="font-weight: bold;"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                            ...
                                            <td>
                                                <strong>
                                                    <asp:Label ID="Label_Remaining_Balance" runat="server" CssClass="txt_bold" Style="color: #060;
                                                        font-size: 12px; font-weight: bold;"></asp:Label></strong>
                                                       </td> 
                                            <td>
                                            ...
                                            <asp:RadioButtonList ID="rdoRefund" runat="server" RepeatDirection="Horizontal" Visible="false">
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 18px">
                                                <asp:Label ID="Label_Cash" runat="server" Style="font-weight: bold;"></asp:Label>
                                               </td>
                                            <td style="height: 18px">
                                                <asp:CheckBox ID="chkboxAmount" AutoPostBack="true" onchange="checkReceivalbe(this)"
                                                    runat="server" Text="Receivable" />
                                                <asp:TextBox ID="txtboxAmount" Visible="false" runat="server" AutoPostBack="true"
                                                    SkinID="intdata" Width="80px"></asp:TextBox>
                                               </td><td> &nbsp;</td>
                                        </tr>
                                        <tr id="trReceivalbe" visible="false" runat="server">
                                            <td align="right">
                                                Receivable Party:
                                            </td>
                                            <td colspan="2">
                                                <asp:DropDownList ID="ddlReceivableParties" runat="server" DataSourceID="sqlReceivableParties"
                                                    DataTextField="Party_Name" DataValueField="Party_Id">
                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="sqlReceivableParties" runat="server" SelectCommand="SELECT Party_Id,Party_Name FROM Parties WHERE Party_Type_Id=3"
                                                    SelectCommandType="Text" ConnectionString="<%$ ConnectionStrings:Finance_ConnectionString %>"
                            ...
                            <td valign="top" width="40%">
                                <fieldset class="fset_1" style="width: 94%; margin-left: 4px;">
                                    <legend>Advance Payment</legend>
                                    <asp:GridView ID="gvd_advance" runat="server" AutoGenerateColumns="False" CssClass="Grid_1"
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
                                    ProviderName="<%$ ConnectionStrings:Basic_Data_ConnectionString.ProviderName %>"
                                    SelectCommand="SELECT DISTINCT YearlyNo, CONVERT (varchar, Pay_DateTime, 107) AS Date, CONVERT (varchar, Pay_DateTime, 108) AS Time, Amount, Check_No, Bank_Name, Branch_Name, Payment_No, Status, Payment_Type FROM Advance_Payment WHERE (RegNo = @RegNo) AND (YearlyNo = @YearlyNo) AND (Status = 0) and (Amount>0)"
                                    UpdateCommand="UPDATE Advance_Payment SET Status = 1 WHERE (Payment_No = @Payment_No)">
                                    <SelectParameters>
                                        <asp:QueryStringParameter Name="RegNo" QueryStringField="regno" />
                                        <asp:QueryStringParameter Name="YearlyNo" QueryStringField="payid" />
                                    </SelectParameters>
                                    <UpdateParameters>
                                        <asp:ControlParameter ControlID="HiddenField_Payment_No" Name="Payment_No" PropertyName="Value" />
                                    </UpdateParameters>
                                </asp:SqlDataSource>
                            </td>
                        </tr>
                                    ...
                                    <li><strong>&nbsp; Credit Card</strong></li><li>
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="tbl_form">
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    <asp:TextBox ID="TextBox_Credit_Card_No" runat="server" Width="100px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="TextBox_Bank_Name" runat="server" Width="100px"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                    Approval # :
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="TextBox_approval_no" runat="server" Width="100px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="tbl_form">
                                            <tr>
                                                ...
                                                <td width="25%" style="height: 25px">
                                                    <asp:TextBox ID="TextBox_Cheque" runat="server" AutoPostBack="true" Width="100px">0</asp:TextBox>
                                                </td>
                                                <td align="right" width="25%" style="height: 25px">
                                                    Cheque # :
                                                </td>
                                                <td width="25%" style="height: 25px">
                                                    <asp:TextBox ID="TextBox_Cheque_No" runat="server" Width="100px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="TextBox_Cheque_Branch" runat="server" Width="100px"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                    Cheque Date :
                                                </td>
...
<%@ Register Assembly="Infragistics2.WebUI.WebDateChooser.v6.1, Version=6.1.20061.28, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb"
    Namespace="Infragistics.WebUI.WebSchedule" TagPrefix="igsch" %>--%>
                                                    <asp:TextBox ID="WebDateChooser_Cheque_Date" runat="server" TextMode="date"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </li>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="padding: 10px; margin-bottom: 10px;">
                                                <asp:Label ID="lblDiscountMsg" runat="server" Style="padding: 6px 10px; color: Red;
                                                    font-size: 13px; border: solid 1px #ccc; border-radius: 15px; font-weight: bold;"></asp:Label>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                ...
                <div class="bxmain">
                        ...
                        <tr>
                            ...
                            <td style="height: 18px">
                                <asp:Button ID="Button1" runat="server" Text="Save" OnClientClick="return Validation()"
                                    Visible="False" />
                                <asp:Button ID="Button_Report" runat="server" Text="Save &amp; Print" OnClientClick="javascript: return confirm('Are you sure you want to Save and print?')" />
                                <asp:Button ID="btn_refundReport" runat="server" Text="Refund Report" OnClientClick="javascript: return confirm('Are you sure you want to Save and print?')"
                                    Visible="false" />
                                <asp:HyperLink ID="hylk_discount" runat="server" CssClass="btn_hacims" Visible="false">Discount</asp:HyperLink>
                                <asp:Button ID="Button_Discount" runat="server" Text="Discount" Visible="true" />
                                <asp:Button ID="Btn_Revoke_discount" runat="server" OnClientClick="return Validation()"
                                    Text="Revoke Discount" Visible="False" />
                                <asp:Button ID="Btn_Grant_discount" runat="server" OnClientClick="return Validation()"
                                    Text="Grant Discount" Visible="False" />
                                <asp:SqlDataSource ID="SDS_Grant_Discount" runat="server" ConnectionString="<%$ ConnectionStrings:BasicDataConnectionString %>"
                                ...
                                <asp:Label ID="LabelAmountInsert" runat="server" CssClass="err" Visible="False"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    ...
                    <asp:SqlDataSource ID="SDS_Patient_Bill" runat="server" ConnectionString="<%$ ConnectionStrings:BasicDataConnectionString %>"
                        InsertCommand="usp_Patient_services_payment" InsertCommandType="StoredProcedure"
                        ProviderName="<%$ ConnectionStrings:BasicDataConnectionString.ProviderName %>">
                        <InsertParameters>
                            <asp:Parameter Name="services" Type="String" />
                            <asp:Parameter Name="advances" Type="String" />
                            <asp:Parameter Direction="ReturnValue" Name="RETURN_VALUE" Type="Int32" />
                            <asp:Parameter Name="forward_To_LAB" Type="Boolean" />
                        </InsertParameters>
                    </asp:SqlDataSource>
                    <asp:SqlDataSource ID="SDS_Revoke_discount" runat="server" ConnectionString="<%$ ConnectionStrings:BasicDataConnectionString %>"
                ...
                <asp:SqlDataSource ID="SqlDataSource_test_Booking_OT" runat="server" ConnectionString="<%$ ConnectionStrings:OTConnectionString %>"
                    ...
                    <InsertParameters>
                        ...
                        <asp:ControlParameter ControlID="HF_PS_ID" Name="PS_ID" PropertyName="Value" Type="Int32" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:ControlParameter ControlID="HiddenField_Main_ID_Radiology" Name="Main_ID" PropertyName="Value" />
                    </UpdateParameters>
                </asp:SqlDataSource>
                <asp:SqlDataSource ID="SqlDataSource_OT_test_booking" runat="server" ConnectionString="<%$ ConnectionStrings:OTConnectionString %>"
                    ProviderName="<%$ ConnectionStrings:Radiology_ConnectionString.ProviderName %>"
                ...
                <asp:SqlDataSource ID="SqlDataSourceCounterClose" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
                    ...
                    <InsertParameters>
                        ...
                        <asp:SessionParameter Name="EMP_ID" SessionField="emp_id" Type="Int32" />
                        <asp:ControlParameter ControlID="HiddenFieldreturnID" Name="refund_id" PropertyName="Value"
                            Type="Decimal" />
                ...
                <asp:SqlDataSource ID="SDS_Refund" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
                    InsertCommand="Insert_Patient_Refund_Amount" ProviderName="<%$ ConnectionStrings:Basic_Data_ConnectionString.ProviderName %>"
                    InsertCommandType="StoredProcedure">
                    <InsertParameters>
                        <asp:SessionParameter Name="Reg_No" SessionField="registrationNo" />
                        <asp:SessionParameter Name="YearlyNo" SessionField="YearlyNo" />
                        ...
                        <asp:ControlParameter ControlID="HiddenField_smpID" Name="SMP_ID" PropertyName="Value" />
                        <asp:ControlParameter ControlID="HiddenFieldreturnID" Name="Refund_id" PropertyName="Value"
                            Type="Decimal" Direction="InputOutput" />
                    </InsertParameters>
                </asp:SqlDataSource>
                ...
                <asp:SqlDataSource ID="SqlDataSource_parties" runat="server" ConnectionString="<%$ ConnectionStrings:PatientBilllingConnectionString %>"
                    ...
                    <SelectParameters>
                        <asp:ControlParameter ControlID="HiddenField_Party_ID" Name="Party_Id" 
                            PropertyName="Value" />
                    </SelectParameters>
                </asp:SqlDataSource>
                <asp:HiddenField ID="HiddenField_Party_ID" runat="server" Value="0" />
                ...
                <asp:SqlDataSource ID="sds_final_bill_discharge" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
    ...
    <asp:SqlDataSource ID="SqlDataSource_For_View" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
        ProviderName="<%$ ConnectionStrings:Basic_Data_ConnectionString.ProviderName %>"
        SelectCommand="Payment_GetPaidServices" SelectCommandType="StoredProcedure"
    ...
    <asp:HiddenField ID="IsReceiveable" runat="server" />
</asp:Content>
