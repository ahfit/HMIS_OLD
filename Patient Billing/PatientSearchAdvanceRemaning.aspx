<%@ page language="VB" autoeventwireup="false" masterpagefile="~/hacims_masterpage_admin.master" CodeFile="~/Patient Billing/PatientSearchAdvanceRemaning.aspx.vb" inherits="Patient_Billing_patientsearchAdvanceRemaning"%>
...
<asp:GridView ID="GridViewSearch" runat="server" AllowPaging="True"
              ...
              <Columns>
                  ...
                  <asp:ButtonField CommandName="Payment" Text="payment" />
