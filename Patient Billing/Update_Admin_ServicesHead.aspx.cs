...
public partial class Patient_Billing_Update_Admin_ServicesHead : System.Web.UI.Page
{
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType==DataControlRowType.DataRow)
        {
            ...
            SqlCommand cmd = new SqlCommand("Select SH_Id,SH_Name from Admin_Service_Head", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable ds = new DataTable();
            da.Fill(ds);
            ddlStatus.DataSource = ds;
            ddlStatus.DataValueField = "SH_Id";
            ddlStatus.DataTextField = "SH_Name";
            ddlStatus.DataBind();

            SqlCommand cmd1 = new SqlCommand("Select SH_ID from  Admin_Services where S_ID=@sid", con);
