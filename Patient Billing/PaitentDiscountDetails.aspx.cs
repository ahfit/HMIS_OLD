...
public partial class Patient_Billing_PaitentDiscountDetails : System.Web.UI.Page
{
    ...
    protected void LoadReport()
    {
        ...
        {
            con.Open();
            cmd = new SqlCommand("usp_patientTypeWiseDiscountDicountDetail", con);
            ...
            string reportPath = Server.MapPath("~/Patient Billing/PatientDiscountDetails.rdlc");
            ReportViewer1.LocalReport.ReportPath = reportPath;
            ReportViewer1.LocalReport.DataSources.Add(rds);


            ReportParameter rp = new ReportParameter("ReportParameter1", Convert.ToDateTime(startDateChooser.Value.ToString()).ToString("dd MMM,yyyy"));
            ReportParameter rp2 = new ReportParameter("ReportParameter2", Convert.ToDateTime(endDateChooser.Value.ToString()).ToString("dd MMM,yyyy"));
