...
Partial Class PharmacySearch
    ...
    Protected Sub lnkMedicine_Click(sender As Object, e As EventArgs)
        ...
        Dim reg As Label = row.FindControl("lblRegNo")
    ...
    Function search_DataSet_Pharmacy() As DataTable
        ...
        search_DSPharmacy = objManager.ExecuteDataTable("Search_Patient_For_Receptionist", "Reg_ConnectionString", sqlParams)
    ...
    Protected Sub lnkForward_Click(sender As Object, e As EventArgs)
        ...
        Dim yearlyNo As Label = row.FindControl("lblVisitNo")
        forwardToWelfare(row.Cells(8).Text, row.Cells(7).Text)
        Label1.Text = "Forwarded Successfully!"
        Label1.ForeColor = System.Drawing.Color.Green
        search1(0)

    End Sub
    Private Sub forwardToWelfare(ByVal regNo As String, ByVal yearlyNo As String)
        Dim dbm As DbManager = New DbManager()
        Dim sp As SqlParameter() = {New SqlParameter("@Reg_No", regNo), New SqlParameter("@yearly_no", yearlyNo),
                                    New SqlParameter("@by_sub_dept_id", Session("SubDeptID")), New SqlParameter("@EmpId", Session("emp_id"))}
        dbm.ExecuteNonQuery("uspInsertForwardForMedicineDiscount", "Reg_ConnectionString", sp)
    End Sub
    ...
    Protected Sub GridViewSearch_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridViewSearch.PreRender
        ...
        Try
            ...
            If GridViewSearch.Rows.Count <> 0 Then
                ...
                GridViewSearch.HeaderRow.Cells(8).Text = "Reg #"
                ...
                For i As Integer = 0 To GridViewSearch.Rows.Count - 1
                    ...
                    '  GridViewSearch.Rows(i).Cells(9).Text = GridViewSearch.Rows(i).Cells(8).Text & " " & GridViewSearch.Rows(i).Cells(9).Text & " " & GridViewSearch.Rows(i).Cells(10).Text & " " & GridViewSearch.Rows(i).Cells(11).Text
                    ...
                    'GridViewSearch.Rows(i).Cells(8).Visible = False
                ...
                Next
                For Each gv As GridViewRow In GridViewSearch.Rows
                    Dim hfforwardStatus As HiddenField = gv.FindControl("hfforwardStatus")
                    Dim lnkForward As LinkButton = gv.FindControl("lnkForward")
                    If hfforwardStatus.Value > 0 Then
                        lnkForward.Text = "Forwarded"
                        lnkForward.Enabled = False
                        lnkForward.Style.Add("font-style", "italic")
                        lnkForward.Style.Add("color", "gray")
