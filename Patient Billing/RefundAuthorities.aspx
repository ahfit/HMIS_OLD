<%@ page title="" language="C#" masterpagefile="~/hacims_masterpage_admin.master" autoeventwireup="true" inherits="Patient_Billing_RefundAuthorities, App_Web_okqm0ubs" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="bxmain inner_content" style=" padding-bottom:10p;"><span><h2> Employees</h2></span>
    <table width="100%">
        <tr>
    ...
    <div style=" margin-top:10px;  padding-top:10px;"  class="bxmain inner_content"><span><h2>Approved Authorities</h2></span>
