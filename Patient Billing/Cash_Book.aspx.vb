...
Partial Class Patient_Billing_Cash_Book
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            WebDateChooser1.MaxDate = Date.Now.Date.AddDays(1)
    ...
    Protected Sub GridView_Counter_Close_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView_Counter_Close.PreRender
        ...
        If GridView_Counter_Close.Rows.Count > 0 Then
            ...
            Dim amount As Decimal = 0.0, Tpanel As Decimal = 0.0, panel As Decimal = 0.0, credit As Decimal = 0.0, receivable As Decimal = 0.0, bank As Decimal = 0.0
            ...
            For Each row As GridViewRow In GridView_Counter_Close.Rows
                ...
                If payment_type.Text.Trim() = "Refund" Or payment_type.Text.Trim() = "Advance Refund" Then
                    ...
                    'panelAmount.Text = CInt(panel.ToString().Replace("(", "").Replace(",", "").Replace(")", ""))
                    creditAmount.Text -= CInt(credit.ToString().Replace("(", "").Replace(",", "").Replace(")", ""))
                    reciveableAmount.Text -= CInt(receivable.ToString().Replace("(", "").Replace(",", "").Replace(")", ""))
                    bankAmount.Text -= CInt(bank.ToString().Replace("(", "").Replace(",", "").Replace(")", ""))
                ...
                End If
                If panelAmount.Text = "" Then
                    panelAmount.Text = 0
                End If
                If payment_type.Text = "Advance Refund" Then

                    panel = panel + (Convert.ToDecimal(panelAmount.Text) * (-1))
                Else
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            'SqlDataSource_ShiftDataforCloud.Insert()
    ...
    Private Sub GetCounterType()
        ...
        End Try
    End Sub
    Protected Sub lnk_Discount_Click(sender As Object, e As EventArgs)

        Dim lnk As LinkButton = sender
        Dim RegNo As String = lnk.CommandArgument
        Dim PayID As String = lnk.ToolTip

        Response.Redirect("~/Patient%20Billing/Patient_Search_Discount.aspx?regno=" + RegNo + "&payid=" + PayID)

    End Sub

    Protected Sub GridView_Counter_Close_RowDataBound(sender As Object, e As GridViewRowEventArgs)
        'If e.Row.RowType = DataControlRowType.DataRow Then
        '    Dim lnk_Discount As LinkButton = TryCast(e.Row.FindControl("lnk_Discount"), LinkButton)
        '    If lnk_Discount IsNot Nothing Then
        '        Dim isVisible As Integer = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "IsVisible"))
        '        lnk_Discount.Visible = (isVisible = 1) ' Show if 1, hide if 0
        '    End If
        'End If
    End Sub
End Class
