<%@ page language="VB" autoeventwireup="false" masterpagefile="~/hacims_masterpage_admin.master" inherits="PatientSearch, App_Web_gswfk1g0" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
<asp:GridView ID="GridViewSearch" runat="server" AllowPaging="True" AutoGenerateColumns="False"
              ...
              <Columns>
                  ...
                  <asp:ButtonField CommandName="Transfer" Text="Update Department & Consultant" />
    ...
    <asp:SqlDataSource ID="SqlDataSource_SubDept" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="DDLDepartment" Name="Dept_Id" PropertyName="SelectedValue" />
                                ...
                                <td style="width:25%; text-align:right;">Doctor : </td>
                    ...
                    SelectCommand="select 0 as EmpID ,' Self' as Name union
SELECT EmpID,ISNULL(EFName, '') + ' ' + ISNULL(EMName, '') + ' ' + ISNULL(ELName, '') AS Name
FROM Employee 
...
ORDER BY Name,EmpID">
                     ...
                     <tr>
                        <td valign="middle"  style="width:25%; text-align:right;">Complaints : </td>
                        <td style="width:25%; text-align:left;">
                        ...
                        <td style="width:25%; text-align:right;" >Room No: </td>
                        <td style="width:25%; text-align:left;" ><asp:TextBox ID="TextBoxDiagnosis" 
                                runat="server" AccessKey="f" CssClass="input_txt"
                                    TabIndex="28" Width="198px" Visible="False"></asp:TextBox>
                            <asp:TextBox ID="TextBox_RoomNo" runat="server" AccessKey="f" 
                                CssClass="input_txt" TabIndex="28" Width="198px"></asp:TextBox>
                         </td>
                    </tr>
                     <tr>
        ...
        <tr>
            <td colspan="4" align="center">
                <asp:Button ID="btnTransferTo" runat="server" Text="Reffer To" Width="100px" />
    ...
    UpdateCommand="usp_Update_Payment_TransferTo" 
    ...
    >
        <UpdateParameters>
            ...
            <asp:Parameter Name="Refer_Department" Type="Int32" />
            <asp:Parameter Name="Refer_SubDepartment" Type="Int32" />
            ...
            <asp:Parameter DefaultValue="" Name="RegNo" Type="String" />
