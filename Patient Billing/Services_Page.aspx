<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Services_Page.aspx.vb" MasterPageFile="~/hacims_masterpage_billing.master"
            ...
            <td valign="top" width="40%">
                ...
                <div class="bxmain">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl_form">
                        ...
                        <tr runat="server" id="pkg" style="display:none">
...
UNION
SELECT     --ISNULL(Prefix, '') + ' ' + 
ISNULL(EFName, '') + ' ' + ISNULL(EMName, '') + ' ' + ISNULL(ELName, '') AS [Employee Name], EmpID
FROM         Employee
WHERE     (Is_Consultant=1) and EmpID !=81232  Order by [Employee Name]"></asp:SqlDataSource>
                </div>
                <div style="text-align: right">
                    <asp:Button Visible="false" ID="btnSaveCheckedServices" runat="server" Text="Save Services" />
                </div>
                <div style="height: 350px;margin-top:1.5%; overflow: auto; overflow-x: hidden;">
                            ...
                            <asp:GridView ID="GridView2" runat="server" CssClass="Grid_1" Width="98%" DataSourceID="SqlDataSource_For_Grid"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Qty">
                                        <ItemTemplate>
                                            <asp:TextBox Width="20px" SkinID="intdata" runat="server" Text="1" ID="txtboxQty"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Date">
                                        <ItemTemplate>
                                            <asp:TextBox Width="25px" SkinID="intdata"  runat="server" ID="txtboxDate"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                ...
                <asp:SqlDataSource ID="SqlDataSource_For_Grid" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
                    ...
                    <InsertParameters>
                        ...
                        <asp:ControlParameter Name="rpDate" Type="Int16" ControlID="HiddenField_Date" PropertyName="Value" />
                        ...
                        <asp:ControlParameter ControlID="HiddenField_Refer_Other" Name="Refer_From_Other"
                            PropertyName="Value" Type="String" DefaultValue="" />

                         <asp:Parameter Name="DoctorId" Type="Int32" />
                        <asp:Parameter Name="PanelAmount" Type="Int32" />
                ...
                <asp:SqlDataSource ID="SqlDataSource_Packages" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
                    ProviderName="<%$ ConnectionStrings:Basic_Data_ConnectionString.ProviderName %>"
                    SelectCommand="SELECT 0 AS Asc_id, ' All' AS Asc_Name UNION SELECT CONVERT (varchar, Asc_id) AS Asc_id, Asc_Name FROM Admin_Service_Category WHERE Active=1 ORDER BY Asc_Name">
            ...
            <td valign="top" width="60%">
                                ...
                                <Columns>
                                   ...
                                   <%-- <asp:TemplateField HeaderText="Charges">
                                    ...
                                    <asp:TemplateField HeaderText="Date">
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtdate" runat="server" Text='<%# Bind("RpDate") %>' Style="width: 73px; pointer-events: none; "></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                ...
                <asp:SqlDataSource ID="SqlDataSource_Grid2" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
                    ...
                    DeleteCommand="DELETE FROM Patient_Services WHERE (ID = @ID) and S_ID!=3161;DELETE FROM Discount_Sub WHERE (ID = @ID); ">
                    <SelectParameters>
                ...
                <table>
                    <tr>
                        ...
                        SelectCommand="SELECT     Admin_Service_Package.ASP_ID,
                                        ...
                                        FROM         Admin_Service_Package where HospitalId=@Hospital_Id ">
                        <SelectParameters>
