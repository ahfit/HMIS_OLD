...
public partial class Patient_Billing_UserWiseServiceCatRevenue : System.Web.UI.Page
{
    ...
    private void ShowReport()
        ...
        try
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["EmpId"]))
            {
                 ds = dbMgr.ExecuteDataSet("Report_ServiceAccountWise_BYEMP", "Basic_Data_ConnectionString", para);
            }
            else
            {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("UserWiseServiceCatRevenue.rdlc");
