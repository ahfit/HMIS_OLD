<%@ Page Title="" Language="VB" MasterPageFile="~/Hacims_MasterPage_Admin_New.master" AutoEventWireup="false" CodeFile="Refund_Approval.aspx.vb" Inherits="Patient_Billing_Refund_Approval" %>
            ...
            <td colspan="2">
                <asp:GridView ID="GridView_Record" runat="server" DataSourceID="SDS_Record" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="R_Status" HeaderText="Approve" 
                        ...
                        <asp:TemplateField HeaderText="Reject">
                            <ItemTemplate>
                                <asp:LinkButton ID="lbtn_Reject" runat="server" onclick="lbtn_Click"
        ...
        <tr>
            <td>
                <asp:SqlDataSource ID="SDS_Record" runat="server" 
                    ...
                    SelectCommand="Select_Refund_Approval" SelectCommandType="StoredProcedure" 
