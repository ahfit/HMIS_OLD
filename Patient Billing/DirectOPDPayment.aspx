<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DirectOPDPayment.aspx.vb" MasterPageFile="~/hacims_masterpage_admin.master" Inherits="Patient_Registration_DirectOPDPayment" %>
...
<asp:GridView ID="GridViewSearch" runat="server" AutoGenerateColumns="False"
              ...
              <Columns>
                  ...
                  <asp:ButtonField CommandName="Advance" Text="Advance Payment" Visible="False" />
              </Columns>
            </asp:GridView>
