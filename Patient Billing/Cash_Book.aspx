...
ORDER BY  ISNULL(Employee.EFName, '') + ' ' + ISNULL(Employee.EMName, '') + ' ' + ISNULL(Employee.ELName, '') asc">
    ...
    <br>
    <asp:GridView ID="GridView_Counter_Close" runat="server" AutoGenerateColumns="False" Width="100%" ShowFooter="True" DataKeyNames="CashBook_ID" OnRowDataBound="GridView_Counter_Close_RowDataBound">
        ...
        <Columns>
            ...
            <asp:TemplateField>
                ...
                <HeaderTemplate>
                    <asp:CheckBox ID="chkboxAll" runat="server" AutoPostBack="true" OnCheckedChanged="chkboxAll_CheckedChanged" Checked="true" Enabled="false" />
                </HeaderTemplate>
            </asp:TemplateField>
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton ID="lnk_Discount" runat="server" Text="Discount"  CommandArgument='<%# Eval("Reg_No")%>' ToolTip='<%# Eval("YearlyNo")%>' OnClick="lnk_Discount_Click" Visible="false"></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
    ...
    <asp:HiddenField ID="HiddenFieldClosingDate" runat="server" />
         <asp:SqlDataSource ID="SqlDataSource_ShiftDataforCloud" runat="server" ConnectionString="<%$ ConnectionStrings:BasicDataInfoConnectionString %>"
           InsertCommand="usp_InsertLocalDBDashBoardData" InsertCommandType="StoredProcedure">
        <InsertParameters>
