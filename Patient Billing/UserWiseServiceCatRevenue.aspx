<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master"
    AutoEventWireup="true" CodeFile="~/Patient Billing/UserWiseServiceCatRevenue.aspx.cs" Inherits="Patient_Billing_UserWiseServiceCatRevenue" %>
    ...
    <div class="bxmain inner_content " style="width: 100%;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="40%" class="tbl_form">
             ...
             <tr>
                ...
                <td style="width: 20%;">
                    <asp:DropDownList ID="ddHospital" OnSelectedIndexChanged="ddHospital_SelectedIndexChanged" runat="server" DataTextField="Hospital_Name" DataValueField="Hospital_ID" AutoPostBack="true" DataSourceID="SqlDataSource_Hospital">
