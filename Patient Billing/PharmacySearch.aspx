<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PharmacySearch.aspx.vb"  MasterPageFile="~/hacims_masterpage_admin.master" Inherits="PharmacySearch" %>
...
<asp:GridView ID="GridViewSearch" runat="server" AllowPaging="True" AutoGenerateColumns="False"
              ...
              <Columns>
                   <asp:TemplateField>
                      <ItemTemplate>
                          <asp:HiddenField ID="hfforwardStatus" runat="server" Value='<%# Eval("forwardStatus") %>' />
                          <asp:LinkButton ID="lnkForward" runat="server" Text="Forward To Welfare" OnClick="lnkForward_Click" Visible="false"></asp:LinkButton>
                      </ItemTemplate>
                  </asp:TemplateField>
                 <%-- <asp:ButtonField CommandName="Medicine" Text="Medicine"  />--%>
                  <asp:TemplateField>
                      <ItemTemplate>
                          <asp:LinkButton ID="lnkMedicine" runat="server" Text="Medicine" OnClick="lnkMedicine_Click"></asp:LinkButton>
                           <asp:HiddenField ID="hfdpatienttype" value='<%# Eval("PatientType") %>' runat="server" />
                      </ItemTemplate>
                  </asp:TemplateField>
