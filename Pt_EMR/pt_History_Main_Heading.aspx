<%@ Page Language="VB" AutoEventWireup="false" validateRequest="false" 
    CodeFile="pt_History_Main_Heading.aspx.vb" 
    MasterPageFile="~/hacims_masterpage.master" Inherits="Pt_EMR_pt_History_Main_Heading" %>
...
var setfocus = function() {  $("#ctl00_ContentPlaceHolder1_TextBox_Remarks").focus(); } 
      ...
      <tr>
        ...
        <div id="TabbedPanels1" class="TabbedPanels">
          <ul class="TabbedPanelsTabGroup" style="margin-left:10px;">
            ...
            <li class="TabbedPanelsTab" tabindex="0" onclick="setfocus();">Remarks</li>
            </ul>
   ...
   <asp:ScriptManager ID="ScriptManager1" runat="server"> </asp:ScriptManager>
          ...
          <asp:Panel ID="Panel1" runat="server" Width="100%">
            ...
            <div class="TabbedPanelsContent"> 
                            ...
                            <asp:TextBox ID="TextBox_Remarks" runat="server" Height="250px" Width="100%" TextMode="MultiLine"></asp:TextBox>
...
var cookies = Spry.Utils.Cookie("read","tabbedpanels_main_heading");
...
Spry.Utils.addUnLoadListener(function(){
    ...
    Spry.Utils.Cookie('create','tabbedpanels_main_heading',TabbedPanels1.getCurrentTabIndex());
});
</script>
