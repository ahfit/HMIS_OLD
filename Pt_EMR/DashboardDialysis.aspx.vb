...
Partial Class DashboardDialysis
    ...
    Protected Sub BindAppointmentList()
        ...
        If Session("emp_id") <> Nothing Then
            ...
            Dim ds As DataSet = dbManager.ExecuteDataSet("GetPatientForDialysis", "Basic_Data_ConnectionString", New SqlParameter() {
    ...
    Protected Sub gvdLoadData_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvdLoadData.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim dialysisID As String = GetDialusisPatient(hfregno.Value)

            If dialysisID.Equals("") Then
                CheckUpStartSession.Enabled = False
            Else
                CheckUpStartSession.Enabled = True
            End If
    ...
    Protected Sub lnkbtnCreate_Click(sender As Object, e As EventArgs)
        ...
        Session.Add("YearlyNo", hfYearly_No.Value)
    ...
    Private Function GetDialusisPatient(ByVal regno As String) As String
        Dim DialysisID As String = ""
        Dim constr As String = ConfigurationManager.ConnectionStrings("TreatmentConnectionString").ConnectionString
        Dim con As SqlConnection = New SqlConnection(constr)
        Dim command As SqlCommand = New SqlCommand("uspSelectDialysisPatient_DialysisID", con)
