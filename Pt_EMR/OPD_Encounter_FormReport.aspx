<%@ Page Language="VB" AutoEventWireup="true" CodeFile="OPD_Encounter_FormReport.aspx.vb" Inherits="OPD_Encounter_FormReport" MaintainScrollPositionOnPostback="true" MasterPageFile="~/hacims_masterpage.master" %>
...
$(document).ready(function(e) {
 ...
 <style type="text/css" media="print">
 	...
 	header,#patient_info_small,.view_style,.pageTitle,.copyright { display:none; }
    ...
    <style type="text/css">
      ...
      .bx_01_content { width: 100%; min-height:none; background1:red; padding-top:5px; } 
...
.view_style { float:right; list-style:none; margin-top:-20px; }
...
a.openIt { width:25px; height:25px; border-radius:100px; display:block; float:right; margin-right:0px;  box-shadow: 0 3px 3px rgba(0, 0, 0, 0.1); border:#ccc solid 1px; margin-top:-28px; 
 ...
 background-size: 6px 11px; display:none;
   }
a.closeIt { width:25px; height:25px; border-radius:100px; display:block; float:right; margin-right:0px;  box-shadow:inset 0 0px 6px rgba(0, 0, 0, 0.3); border:#999 solid 1px; margin-top:-28px; 
 ...
 background-size: 13px 6px; display:none;
   }  
...
<div class="slideLeftMenu"><div id="menuScroll"><asp:Label ID="SideMenu" runat="server" Visible="true"></asp:Label></div></div>
<div class="main_bx">      
 		 <div class="pageContent">
			<ul class="view_style">	
			<li><a href="#" class="show_grid" title="Grid"></a></li> 
			<li><a href="#" class="show_row"title="Row"></a></li> 
			</ul>
  ...
  <div class="connectedSortable" id="sortable_listone">
   ...
   <div class="bx_01" id="box_pr_complaints">
    <h3>Presenting Complaints</h3>  <a href="#" class="openIt" id="presentingComplaints_bx_toggle"></a>
    
    	<table style="width:100%;"><tr><td> <ul class="pCHtml"></ul></td></tr></table>
    
        <div class="bx_01_content" id="presentingComplaints_bx" style="display:none; min-height:1px;">
                ...
                <asp:UpdatePanel ID="updatepanel1" runat="server">
                            <ContentTemplate>
                                                ...
                                                <asp:SqlDataSource ID="SqlDataSourceSaveComplaints" runat="server" ConnectionString="<%$ ConnectionStrings:TreatmentConnectionString %>"
                                                    ...
                                                    <asp:DataList ID="dataListComplaints"  Width="100%" runat="server" DataSourceID="SqlDataSourceShowComplaints" Style="display:none;">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("Complaints") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:DataList>
   ...
   <!--///////////////////////////////////////////////////////////////////////////////////////////////////////////-->
    ...
    <h3>History</h3><a href="#" class="openIt" id="history_bx_toggle"></a>
         <asp:Repeater ID="repeaterHistory" DataSourceID="SqlDataSourceHistory" runat="server">
                                   <ItemTemplate>
                                        <ul class="medication_cnt">
                                            <li style="border-bottom: #cccccc dotted 1px; border-right: 0; border-left: 0;color:black" ><strong
                                                class="mname">
                                                <asp:Label ID="lblHeading" style="color:black" runat="server" Text= '<%# Eval("MH_Heading")%>'></asp:Label>
                                             
                                            </strong></li>
                                            
                                            <li style="height: auto;    padding-bottom: 4px;    font-size: 12px; color: blue;   padding-left: 25px;" >   
                                                <asp:Label ID="lblremarks" style="font-weight:100"  runat="server" Text= '<%# Eval("Remarks")%>'></asp:Label>
                                             
                                            </li>
                                        </ul>
                                    </ItemTemplate>
                                </asp:Repeater>
                                <asp:SqlDataSource ID="SqlDataSourceHistory" runat="server" ConnectionString="<%$ ConnectionStrings:Treatment_AdminConnectionString %>"
                                                             
                                                            ProviderName="<%$ ConnectionStrings:TreatmentConnectionString.ProviderName %>"
                                                            SelectCommand="Select * from OPD_Encounter_Form_Remarks remarks  join Treatment.dbo.Admin_History_Main_Heading main on main.MH_Code=remarks.MH_Code  where  Yearly_No=@YearlyNo"  >
                                                            <SelectParameters>
                                                                <asp:SessionParameter Name="YearlyNo" SessionField="YearlyNo" />
        ...
        <div class="bx_01_content" id="history_bx" style="display:none;">
             ...
             <asp:TreeView ID="TreeView1" runat="server" CssClass="Grid_tree" ShowLines="True" SelectedNodeStyle-CssClass="SelectedNodeStyle" ExpandDepth="0"> </asp:TreeView>
                             ...
                             <asp:HiddenField ID="HiddenField_count_val" runat="server"></asp:HiddenField>
                                                ...
                                                <div style="display: none;">
                                                    <asp:Button Style="margin-top: 5px" ID="Button_Save" runat="server" Text="Save" CssClass="btn1"></asp:Button></div>
  ...
  <!--///////////////////////////////////////////////////////////////////////////////////////////////////////////-->
    ...
    <h3>Examinations</h3><a href="#" class="openIt" id="examination_bx_toggle"></a>
        <div class="bx_01_content" id="examination_bx"  >
             <asp:Repeater ID="repeaterExamination" DataSourceID="SqlDataSourceExamination" runat="server">
                                   <ItemTemplate>
                                        <ul class="medication_cnt">
                                            ...
                                            <li>   
                                                <asp:Label ID="lblremarks" style="font-weight:100;margin-left:25px" runat="server" Text= '<%# Eval("Remarks")%>'></asp:Label>
                                             
                                            </li>
                                        </ul>
                                    </ItemTemplate>
                                </asp:Repeater>
                                <asp:SqlDataSource ID="SqlDataSourceExamination" runat="server" ConnectionString="<%$ ConnectionStrings:Treatment_AdminConnectionString %>"
                                                             
                                                            ProviderName="<%$ ConnectionStrings:TreatmentConnectionString.ProviderName %>"
                                                            SelectCommand="Select 'General' MH_Heading,Remarks from OPD_Encounter_Form_Remarks remarks   where  Yearly_No=@YearlyNo and Type_val='PHY'"  >
                                                            <SelectParameters>
                                                                <asp:SessionParameter Name="YearlyNo" SessionField="YearlyNo" />
         ...
         <div class="dropdownb"  style="display:none;">
  ...
  <ul class="tabs_left_exam"></ul>
                                                ...
                                                <asp:TreeView  style="display:none;" ID="TreeViewExamination" runat="server" CssClass="Grid_tree" ShowLines="True"
  ...
  <!--///////////////////////////////////////////////////////////////////////////////////////////////////////////-->
    ...
    <h3>Diagnosis</h3><a href="#" class="openIt" id="diagnosis_bx_toggle"></a>
     <asp:UpdatePanel ID="updatepanelForDiagnose" runat="server">
                        ...
                        <asp:DataList ID="DataList_CurrentVisitDiagnosis" runat="server" DataKeyField="Diagnosis_ID"
                                   ...
                                   <HeaderTemplate><ul class="list_diagnosis"> </HeaderTemplate>
                                    <ItemTemplate><li>
          		 ...
          		 <asp:LinkButton Visible="false" ID="LinkButton_Cancel" runat="server"  CommandArgument='<%# Eval("Diagnosis_ID") %>'
                  CommandName="remove"    CssClass="cancelLink">Cancel</asp:LinkButton>
        ...
        <div class="bx_01_content hidebx" id="diagnosis_bx">
  
  			
                               

		
         <div class="bx_style_1" style="width:100%; margin-top:10px; margin-bottom:0;display:none">
                        ...
                        <table style="width:100%;display:none">
                                            <tr>
                                                ...
                                                Style="width:80%"></asp:TextBox> <asp:Button ID="btnAddDiagnosis" runat="server" Text="Save" Style="height:32px; min-width:65px; line-height:30px;" /> </li>
    ...
    <h3>Medicine</h3><a href="#" class="openIt" id="medicine_bx_toggle"></a>
        <asp:DataList ID="DataList_ConfirmedPrescriptions" runat="server" DataKeyField="priscription_id"
                                    ...
                                    <ul class="medication_cnt">
                                     ...
                                     <li> <asp:ImageButton ID="btn_delete"
                                                ...
                                                ImageUrl="~/resources/images/img_delgray.png" CssClass="right_btn_delete" Visible="false" OnClick="btn_delete_Click" /></li>
        ...
        <div class="bx_01_content" id="medicine_bx" style="display:none;">
     ...
     <ul class="small_tabs">
       ...
       <div id="CurrentMedicine">
                                ...
                                <asp:RadioButtonList RepeatDirection="Horizontal" ID="rdbtnMedicines"  Visible="false" runat="server">
                                ...
                                <div  class="bx_style_1" style="width:100%; float:left;display:none">

<ul class="form_list_s" style=" width:auto;">
                                 
                                 <li> <label>Name</label> <asp:TextBox AccessKey="n" Style="width:250px" ID="TextBox_specificMedicine" runat="server" CssClass="input_txt" AutoPostBack="false"></asp:TextBox>
                                  ...
                                  <li style="margin-left:10px;"> <label>Route</label> <asp:DropDownList ID="DropDownList_route" runat="server" Style="width: 100%" DataSourceID="SqlDataSource_route"
                                   ...
                                   <li style="margin-left:5px;"> <label>Frequency</label> <asp:DropDownList ID="DropDownList_frequencyName" runat="server" Width="85px" DataSourceID="SqlDataSource_frequency"
                                   ...
                                   <ul id="CollapsiblePanel1" style="display:none;">
                                    ...
                                    <li style="margin-left:5px;"> <label>Days</label> <asp:TextBox ID="TextBox_days" runat="server" CssClass="input_txt" Style="width:50px" AutoPostBack="false">1</asp:TextBox>
                                                    <asp:CheckBox ID="CheckBox_CT" runat="server" Text="CT" Visible="False"></asp:CheckBox></li>
                                     <li style="margin-left:10px;"> <label>Start Date</label><igsch:WebDateChooser ID="WebDateChooserStartDate" runat="server" CssClass="drop_date" Style="border:#ccc solid 1px; height:30px;"
                                                    ...
                                                    </igsch:WebDateChooser> </li>
                                      <li style="margin-left:5px;"> <label>Med. Type</label> <asp:DropDownList ID="ddlMedicineType" runat="server" Style="width: 100%">
                                       ...
                                       <li style="margin-left:5px;"> <label>Before Meal</label><asp:DropDownList ID="DropDownList_Meal" runat="server" Width="87px" Visible="false">
                                        ...
                                        <li style="margin-left:5px;"> <label>After Meal</label><asp:TextBox ID="txtboxAfterMeal" TextMode="MultiLine" Style="width: 100%; height: 35px;" runat="server"></asp:TextBox></li>
                                         <li style="margin-left:5px;"> <label>Comments</label><asp:TextBox ID="TextBoxInstruction" Style="width: 100%; height: 35px;" runat="server" TextMode="MultiLine" CssClass="input_txt"></asp:TextBox></li>
                                ...
                                <div align="center" style="padding: 10px;display:none" >
                                    ...
                                    <asp:Button ID="ButtonSaveMedicine" runat="server" Text="Save" Visible="false" OnClick="ButtonSaveMedicine_Click"
                                ...
                                <asp:DataList ID="datalistForPreviousMedicine" OnItemDataBound="datalistForPreviousMedicine_ItemDataBound" runat="server" DataKeyField="priscription_id" RepeatLayout="Flow"
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <ul class="form_list_s" style=" width:100%;">
                                                           <li style="display:block; width:100%; margin-top:0px; margin-bottom:5px; border-bottom:#ccc dotted 1px;"><label style="font-weight:bold;">Select Medicine</label>
                                                            <asp:CheckBox ID="assign" runat="server" ToolTip='<%# Eval("priscription_id") %>' /> <span style="color:#039; font-weight:bold;"><%# Eval("Medicine_Name") %></span>
                                                        ...
                                                        <li style="margin-left:5px;"><label>Days</label>
                                                          ...
                                                          <li style="margin-left:10px;"><div style="float:left;"><label>Start Date</label>
                                                                ...
                                                                </igsch:WebDateChooser></div></li>
                                                            <li style="margin-left:10px;"><label>Med. Type</label>
  ...
  <div class="connectedSortable" id="sortable_listtwo">
    ...
    <h3>Pathology</h3><a href="#" class="openIt" id="pathology_bx_toggle"></a>
               <asp:DataList ID="DataList_Test" runat="server" DataSourceID="SqlDataSourceTestNew"
                           ...
                           <li style="border-color:#999;"><asp:Label ID="Label_TestDate" runat="server" Style="font-weight:bold;" Text='<%# Eval("TestDate") %>'></asp:Label> </li>           
                                            ...
                                            <ItemTemplate>
                                                <li style="height: auto; padding-bottom: 4px;  font-size: 12px; padding-left: 25px;">
                                                    <asp:Label ID="TB_NameLabel" Style="color:#09C;" runat="server" Text='<%# Eval("TBName") %>'></asp:Label>
                                                                <asp:ImageButton Visible="false" CommandArgument='<%# Eval("TB_ID") %>' ImageUrl="~/resources/images/img_delgray.png" CssClass="right_btn_delete" ToolTip="Remove"  Style="float:right; width:10px; margin-top:4px; height:10px;" OnClick="imgDeletePath_Click" runat="server" ID="imgDeletePath" />
                                                </li>
                                            </ItemTemplate>
                                        </asp:DataList>
                                    </ul>
        ...
        <div class="bx_01_content" id="pathology_bx" style="display:none;">
     ...
     <ul class="small_tabs">
        ...
        <li style="display:none" ><a href="#" class="last" id="show_PreviousTest">Previous Test</a></li>
                        ...
                        <div style="display:none" class="bx_style_1" style="width:100%; margin-top:10px;">
                        
                        <table  class="tbl_form2c">
                                            <tr>
                                                
                                                <td>
                                                     <asp:TextBox AccessKey="n" PlaceHolder="Enter Test Name" ID="TextBox_Test" runat="server" Style="width:100%;" AutoPostBack="true"></asp:TextBox>
                                            <asp:Button Text="Add" ID="btnAddPathology" Visible="false" OnClick="btnAddPathology_Click" runat="server" />
                                                </td>
                                            </tr>
                                        </table>
                        </div>
...
(select MAX(PayID) from Payment) and  RegNo=@RegNo  order by PayID desc)">
 ...
 <!--///////////////////////////////////////////////////////////////////////////////////////////////////////////-->
    ...
    <h3>Investigation</h3><a href="#" class="openIt" id="radiology_bx_toggle"></a>
             <asp:DataList ID="DataList_Radiology" runat="server" DataSourceID="SqlDataSourceRadiology"
                                                    Width="100%" RepeatLayout="Flow">
                                                    <ItemTemplate>
                                                        <ul class="list_diagnosis">
                                                           
                                                                    <li style="border-color:#999;"><asp:Label ID="Label_Date" Style="font-weight:bold;" runat="server" Text='<%# Eval("DateTime")  %>'></asp:Label></li>
                                                            <asp:DataList ID="DataList_Radiology_Sub" runat="server" RepeatDirection="Vertical" RepeatLayout="Flow"
                                                                ...
                                                                <ItemTemplate>
                                                                   <li style="height: auto; padding-bottom: 4px;  font-size: 12px; padding-left: 25px;">
                                                                       ...
                                                                       <asp:ImageButton Visible="false" OnClick="imgDeletRadiology_Click" CommandArgument='<%# Eval("Radiology_SubId")%>' runat="server" ID="imgDeletRadiology" ImageUrl="~/resources/images/img_delgray.png" CssClass="right_btn_delete"  Style="float:right; width:10px; margin-top:4px; height:10px;" ToolTip="Remove" />
                                                                    </li>
                                                                </ItemTemplate>
                                                            </asp:DataList>
...
Radiology.dbo.TestGroup ON Radiology.dbo.Test_Booking.MG_ID = Radiology.dbo.TestGroup.TGID WHERE   (Radiology_Order_Main.YearlyNo = @YearlyNo) AND (Radiology_Order_Main.RegNo =@RegNo) AND (CONVERT(varchar, Radiology_Order_Main.Date_Time, 103) &#13;&#10;                      = @Date)">
        ...
        <div class="bx_01_content" id="radiology_bx" style="display:none;">
         
         <div class="small_tabs_cnt" style="display:none">
     <ul class="small_tabs">  
        <li><a href="#" class="first active" id="show_RadCurrentTest" >Current Test</a></li>        
        <li style="display:none"><a href="#" s class="last" id="show_RadPreviousTest">Previous Test</a></li>
        </ul>
     </div> 
                        ...
                        <div id="RadCurrentTest">
										...
										<div  class="bx_style_1" style="width:100%; margin-top:10px;display:none">
                                        <table class="tbl_form2c">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:Button Text="Add" ID="btnAddRadiologyTest" Visible="false" OnClick="btnAddRadiologyTest_Click" runat="server" />
                                                </td>
                                            </tr>
                                        </table>
                                        </div>
                                        ...
                                        <asp:DataList ID="DataListPreviousTestParent" runat="server" DataSourceID="SqlDataSourceRadiologyPreviousTest_Parent"
                                            ...
                                            <ItemTemplate>
                                                <ul class="list_diagnosis">
                                                            ...
                                                            <li style="border-color:#999;"><asp:Label ID="Label_Date" Style="font-weight:bold;" runat="server" Text='<%# Eval("DateTime") %>'></asp:Label> <span title="Yearly Number"><%#  "(" & Eval("YearlyNo") & ")" %></span></li>
...
<!--///////////////////////////////////////////////////////////////////////////////////////////////////////////-->
    ...
    <h3>Physician Notes</h3><a href="#" class="openIt" id="physicianNotes_bx_toggle"></a>
         <div class="bx_01_content">
              <strong> Follow Up Days :</strong>  <asp:Label ID="lblfollowupdays" runat="server"></asp:Label>
                                <br />

                          <strong>  Follow Up Notes :</strong> <asp:Label ID="lblfollowupnotes" runat="server"></asp:Label>
        </div>
        <div class="bx_01_content" id="physicianNotes_bx" style="display:none;">
        		 ...
        		 <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                            <ContentTemplate>
                                ...
                                <asp:TextBox ID="txtPhycicianNotes" Visible="false" runat="server" TextMode="MultiLine" Style="width: 100%; height:100px;"></asp:TextBox>
                                <div align="center" style="padding-top: 10px;display:none">
    ...
    <h3>Referal Doctor Notes</h3><a href="#" class="openIt" id="referalDoctorNotes_bx_toggle"></a>
        <div class="bx_01_content" id="referalDoctorNotes_bx" style="display:none;">
        <asp:UpdatePanel ID="updatepanel7" runat="server">
						 ...
						 <tr>
                        <td>Department</td>
                        <td><asp:DropDownList AutoPostBack="true" ID="ddlDept" runat="server">
                                            </asp:DropDownList><asp:RequiredFieldValidator ID="vaddlDept" runat="server" ControlToValidate="ddlDept"
                                                ErrorMessage="*" ForeColor="Red" Text="*" ValidationGroup="mainAppForRef" InitialValue=""></asp:RequiredFieldValidator>  </td>
                         </tr> 
                         
                          <tr>
                                   <td>Consultant</td>
                                   <td><asp:DropDownList ID="ddlConsultant" runat="server">
                                            </asp:DropDownList> <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlConsultant"
                                      ...
                                      <tr>  
                                        <td></td><td><asp:HiddenField ID="hdnReferalNotes" runat="server" />
                                <asp:TextBox ID="txtReferalNotes" runat="server" TextMode="MultiLine" Style="width: 100%; height:60px;"></asp:TextBox>
                                <asp:HiddenField ID="hdnReferalId" runat="server" Value="0" /></td>
                                        </tr>
                                  <tr>
                                  <td></td>
                                  <td><asp:Button ID="btnSaveReferal" CausesValidation="true" ValidationGroup="mainAppForRef"
