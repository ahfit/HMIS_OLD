...
//            $('.medication li:nth-child(odd)').addClass('alternate');
    ...
    <style type="text/css">
 	  ...
 	  .bx_01 { width:98%; float:none; box-sizing:border-box; padding: 10px; padding-top:15px; min-height:30px; padding-bottom:15px;  }    
      .bx_01 h3 { margin-top:-20px; }
...
.view_style  li a.grid { width:25px; height:25px;  display:block; background:url(../resources/images/img_grid.png) 0px 0px no-repeat; background-size:25px; margin-right:20px;   }
.view_style  li a.row { width:25px; height:25px;  display:block; background:url(../resources/images/img_row.png) 0px 0px no-repeat; background-size:25px; margin-right:10px;    }
...
a.openIt { width:25px; height:25px; border-radius:100px; display:block; float:right; margin-right:0px;  box-shadow: 0 3px 3px rgba(0, 0, 0, 0.1); border:#ccc solid 1px; margin-top:-28px; 
 background:#f1f1f1 url(../resources/images/img_downarrow.png) 5px 9px no-repeat;  
...
a.closeIt { width:25px; height:25px; border-radius:100px; display:block; float:right; margin-right:0px;  box-shadow:inset 0 0px 6px rgba(0, 0, 0, 0.3); border:#999 solid 1px; margin-top:-28px; 
 background:#f1f1f1 url(../resources/images/img_uparrow.png) 5px 7px no-repeat;  
 background-size: 13px 6px;
   }  
...
$(document).ready(function(e) {
	 ...
	 //full_width
			 ...
			 $(document).on("click",".grid_width",function(e){
		   
						  e.preventDefault();
						  
						  //$(".bx_01").css("width","48.5%").css("float","left");
		 	 ...
		 	 // $(".bx_01_content").each(function(index, element) {
//              	
// 							
//							if($(".list_diagnosis").html().length!=0) {
//								
//								
//								
//								}
...
<div class="main_bx">      
 		 <div class="pageContent">
			<ul class="view_style">	
			<li><a href="#" class="grid" title="Grid"></a></li> 
			<li><a href="#" class="row" title="Row"></a></li> 
			</ul>
   ...
   <div class="bx_01">
    <h3>Presenting Complaints</h3>  <a href="#" class="openIt" id="presentingComplaints_bx_toggle"></a>
        ...
        <div class="bx_01_content" id="presentingComplaints_bx" style="display:none; min-height:75px;">
                ...
                <asp:UpdatePanel ID="updatepanel1" runat="server">
                     ...
                     <div class="bx_style_1" style="width:100%; margin-bottom:0; float:none;">
                     <table><tr><td><ul class="form_list_s" style="width:100%; margin-left:10px;">
 <li><label></label><asp:TextBox ID="TextBoxComplaint_Name" PlaceHolder="Complaint" runat="server" Width="250px"></asp:TextBox> <asp:Button ID="ButtonSearch" runat="server" Text="Search" Width="55px" Visible="false" />  </li>
 <li style="margin-left:10px;"><label></label> <asp:TextBox ID="TextBoxDuration" runat="server" SkinID="intdata" PlaceHolder="Duration" Width="70px"></asp:TextBox></li>
 <li style="margin-left:5px;"><label></label>
 ...
 <li style="margin-left:10px;"><label></label> <asp:LinkButton ID="LinkButton_Add" CssClass="btn_hacims lnkBtnNormalText" runat="server" OnClick="LinkButton_Add_Click">Save</asp:LinkButton>
   ...
   <!--///////////////////////////////////////////////////////////////////////////////////////////////////////////-->
    <div class="bx_01" style="display1:none;">
  ...
  <!--///////////////////////////////////////////////////////////////////////////////////////////////////////////-->
    <div class="bx_01" style="display:none1;">
    <h3>Examinations</h3><a href="#" class="openIt" id="examination_bx_toggle"></a>
        <div class="bx_01_content" id="examination_bx" style="display:none;">
         <div class="dropdownb">
...
<ul class="form_list_s" style=" width:auto;">
                    ...
                    <div style="display:none">
                      <h3 id="GeneralInformation" style="display:none">General Information</h3>
  ...
  <!--///////////////////////////////////////////////////////////////////////////////////////////////////////////-->
    ...
    <h3>Pathology</h3><a href="#" class="openIt" id="pathology_bx_toggle"></a>
     ...
     <ul class="small_tabs">
        ...
        <li><a href="#" class="last" id="show_PreviousTest">Previous Test</a></li>
        </ul>
     </div> 
...
(select MAX(PayID) from Payment) and  RegNo=@RegNo  order by PayID desc)">
 ...
 <!--///////////////////////////////////////////////////////////////////////////////////////////////////////////-->
    <div class="bx_01">
    <h3>Radiology</h3><a href="#" class="openIt" id="radiology_bx_toggle"></a>
     ...
     <ul class="small_tabs">  
        ...
        <li><a href="#" class="last" id="show_RadPreviousTest">Previous Test</a></li>
        </ul>
     </div> 
        ...
        <div class="bx_01_content" id="physicianNotes_bx" style="display:none;">
        		 ...
        		 <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                            <ContentTemplate>
                                ...
                                <asp:TextBox ID="txtPhycicianNotes" runat="server" TextMode="MultiLine" Style="width: 100%; height:100px;"></asp:TextBox>
