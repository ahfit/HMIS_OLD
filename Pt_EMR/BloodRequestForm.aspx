<%@ page language="C#" autoeventwireup="true" inherits="BloodRequestForm, App_Web_jeeclgcn" masterpagefile="~/hacims_masterpage.master" enableeventvalidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
                ...
                Width="100%" OnPreRender="GridView2_PreRender">
                  ...
                  <Columns>
                    ...
                    <asp:TemplateField HeaderText="ML">
                      <ItemStyle  />              
                      <ItemTemplate>
                        <asp:TextBox ID="TextBox1" runat="server" CssClass="input_txt" Width="56px" AutoPostBack="True" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
...
<div class="bxmain" style="margin-left:10px; width:96%;">
  ...
  <tr>
    ...
    <td ><asp:TextBox ID="TextBox_bags" runat="server" OnTextChanged="TextBox_bags_TextChanged" CssClass="input_txt" Width="50px" ></asp:TextBox><strong>&nbsp;Quantity</strong>&nbsp;
...
ErrorMessage="RequiredFieldValidator">*</asp:RequiredFieldValidator>
  ...
  <tr>
    ...
    <td>
        <igsch:webdatechooser id="WebDateChooser_WhenNeeded" runat="server" CssClass="drop_date"> 
    ...
    <td><asp:Label ID="Label_sample_No" runat="server" CssClass="err" ></asp:Label>
        ...
        <tr>
            <td align="right" valign="top">
                Remarks :</td>
            <td>
                <asp:TextBox ID="TextBox_Remarks" runat="server" Height="50px" TextMode="MultiLine" Width="250px"></asp:TextBox></td>
        </tr>
</table></p>
...
<br />
   ...
   <div align="center" >
       ...
       <asp:HiddenField ID="HiddenField_BloodRequest_Id" runat="server" />
       <asp:HiddenField ID="HiddenField_Comp_PotencyML" runat="server" />
...
<%--  </ContentTemplate>
                ...
                SelectCommand="SELECT Component_id, Component_Name, Component_unit, Com_Qty FROM Blood_Component" OnSelecting="SqlDataSource_Component_Selecting" ProviderName="<%$ ConnectionStrings:BloodBank_ConnectionString.ProviderName %>"> </asp:SqlDataSource>
                ...
                ProviderName="<%$ ConnectionStrings:BloodBank_ConnectionString.ProviderName %>">
                    <InsertParameters>
                      ...
                      <asp:ControlParameter ControlID="HiddenField_Comp_Potency" Name="Potency" PropertyName="Value" />
                        <asp:ControlParameter ControlID="HiddenField_Qty" Name="Qty" PropertyName="Value"
                            Type="Int32" />
                        <asp:ControlParameter ControlID="HiddenField_Unit" Name="Unit" PropertyName="Value"
                            Type="String" />
                        <asp:ControlParameter ControlID="HiddenField_Comp_PotencyML" Name="PotencyML" PropertyName="Value"
                            Type="String" />
                    </InsertParameters>
    </asp:SqlDataSource>
