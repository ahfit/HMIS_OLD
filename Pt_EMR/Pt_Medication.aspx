...
<div class="slideLeftMenu"><div id="menuScroll"><asp:Label ID="LabelSideMenu" runat="server" Visible="true"></asp:Label></div></div>
 <div class="main_bx">
         ...
         <li><a href="#" id="previouseMedicine_show">Previouse Medicine</a></li>
           ...
           <div class="leftMenu_div" style="min-height:530px;">
    ...
    <cc1:AutoCompleteExtender ID="GetMedicationAllergic" runat="server" CompletionInterval="10"
        ...
        <div id="currentMedicine_content" class="hideall">
         ...
         <asp:Button ID="ButtonSearch" runat="server" Text="Search" Width="50px" CausesValidation="False"
						...
						<div  class="bx_style_1" style="width:100%; vertical-align:top; float:left;">
					
                       <ul class="form_list_s" style=" width:100%;">
                    <li><label>Medicine Name</label>
                    
                     <asp:TextBox ID="TextBox_specificMedicine" CssClass="input_txt" Width="300px" runat="server"
                    ...
                    <asp:DropDownList ID="DropDownList_frequencyName" runat="server" AutoPostBack="True"
                                            ...
                                            <asp:DataList ID="DataList_Frequency" runat="server" DataKeyField="Frequency_Sub_Id"
                                                ...
                                                <ItemTemplate>
                                                    <div class="medbg">
                                                        <asp:Label ID="FrequencyLabel" runat="server" Text='<%# Eval("Frequency") %>' Style="display: block;  font-size: 9px;"></asp:Label>
                                                        <asp:TextBox ID="TextBox_dosage2" runat="server" Width="30px" Style="height:20px; display: inline; border-radius:2px;">1</asp:TextBox>
                     ...
                     <li style="margin-left:10px;"><div style="float:left;"><label>Start Date</label>
                       ...
                       <igsch:WebDateChooser ID="WebDateChooserStartDate" runat="server" CssClass="drop_box"
                                        Width="100px" Value="2008-01-16" Style="border:#ccc solid 1px; height:33px;">
                    ...
                    <li style="margin-left:10px;"><label>Meal</label> 
                   ...
                   <asp:TextBox ID="txtboxBeforeMeal" Visible="false" TextMode="MultiLine" Style="width: 100%;" runat="server"></asp:TextBox> 
                    
                    
                   <asp:DropDownList ID="ddlMedicineType" runat="server" Visible="false">
                     ...
                     <asp:TextBox ID="txtboxAfterMeal" TextMode="MultiLine" Visible="false" Style="width: 100%;" runat="server"></asp:TextBox>
                     
                    </li>
                     
                     <li style="margin-left:10px; float:none1; overflow:hidden1;"><label>Physician Notes</label>
                     
                      <asp:TextBox ID="TextBoxInstruction" TextMode="MultiLine" runat="server" CssClass="input_txt"   Width="100%"></asp:TextBox>
...
<asp:LinkButton ID="lnkReport" runat="server" Text="View Slip" CssClass="plainBtn" PostBackUrl="~/Pt_EMR/MedicineSlip.aspx"></asp:LinkButton> </div>   
                                    ...
                                    <ItemTemplate>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="Grid_1">
                                            <tr>
                                                ...
                                                <th align="center" colspan="1">Physician Notes</th>
        ...
        <div id="previouseMedicine_content" class="hideall" style="display:none;">
          ...
          <span style="display: block; text-align: center; padding-bottom: 10px; margin-top:-20px;">
                         ...
                         <asp:DataList ID="datalistForPreviousMedicine" OnItemDataBound="datalistForPreviousMedicine_ItemDataBound" runat="server" DataKeyField="priscription_id"
                            ...
                            <ItemTemplate>
                               ...
                               <div class="bx_style_1" style="width:100%; float:left;">
                                        ...
                                        <li style="margin-left:10px;"><label>Route</label><asp:DropDownList ID="DropDownList_routeForPreviousMedicine" runat="server" Style="width: 100%" DataSourceID="SqlDataSource_route"
                                                        DataValueField="Id" DataTextField="Description">
                                                    </asp:DropDownList></li>
                                        <li style="margin-left:5px;"><label>Frequency</label><asp:DropDownList ID="DropDownList_frequencyNameForPreviousMedicine" runat="server" Width="85px" DataSourceID="SqlDataSource_Frequency"
                                                                    ...
                                                                    </asp:DropDownList><asp:TextBox ID="TextBox_FrequencyForPreviousMedicine" runat="server" Width="16px"
                                                                        AutoPostBack="false" CssClass="dataListAltItemStyle " Style="display: none">1</asp:TextBox> <ul id="CollapsiblePanel1" style="display:none;">
                                                        <li>
                                        ...
                                        <li style="margin-left:5px;"><label>Days</label> <asp:TextBox ID="TextBox_daysForPreviousMedicine" runat="server" CssClass="input_txt" Style="width:50px;" AutoPostBack="true">1</asp:TextBox></li>
                                        <li style="margin-left:10px;"><label>Start Date</label><igsch:WebDateChooser ID="WebDateChooserPreviousStartDate" runat="server" CssClass="drop_date"
                                                            Width="100px" Style="border:#ccc solid 1px; height:33px;">
                                                            <CalendarLayout Culture="English (United Kingdom)">
                                                            </CalendarLayout>
                                                        </igsch:WebDateChooser></li>
                                        <li style="margin-left:10px;" ><label>Meal</label><asp:DropDownList ID="DropDownList_MealForPreviousMedicine" runat="server" Width="87px" Visible="true">
                                                            <asp:ListItem Value="NA">.NA</asp:ListItem>
                                                            <asp:ListItem Value="Before Meal">Before</asp:ListItem>
                                                            <asp:ListItem Value="After Meal">After</asp:ListItem>
                                                        </asp:DropDownList>
                                                        <asp:TextBox Visible="false" ID="txtboxBeforeMealForPreviousMedicine" TextMode="MultiLine" Style="width: 100%; height: 35px;" runat="server"></asp:TextBox></li>
                                        <li style="margin-left:10px;"><label>Physician Notes</label> <asp:TextBox ID="TextBoxInstructionForPreviousMedicine" Style="height: 35px; width:100%;" runat="server" TextMode="MultiLine" CssClass="input_txt"></asp:TextBox>
                                                            <asp:TextBox Visible="false" ID="txtboxAfterMealForPreviousMedicine" TextMode="MultiLine" Width="100%"  Style="height: 35px;" runat="server"></asp:TextBox></li>
