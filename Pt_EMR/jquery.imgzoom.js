    ...
    function zoom(duration, callback, out) {
        ...
        $(fx).animate({ pos: out ? 0 : 1 }, duration, function () {
            ...
            if (!out) {
                ...
                var leftOffSet = endX - $container.offset().left + $wrap.offset().left;
                var rightOffSet = endY - $container.offset().top + $wrap.offset().top;
