...
-->
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("[id*='LabelSideMenu'] ul li a").click(function (e) {            
        ...
        $(function () {
            $('[id$="labaelExamination"] ul li a').click(function (e) {
                var text = $(this).attr('href');
    ...
    <style type="text/css">
		...
		.list_diagnosis li .diseaseDate { font-weight:bold; }
		.list_diagnosis li .codeName {   }
		.list_diagnosis li .diseaseName {  font-weight:bold; color:#C30;  }
			...
			$(document).on("click",".add_btn",function(e){
			 ...
			 $(document).on("click",".closeBox",function(e){
		  	...
		  	e.preventDefault();
						 ...
						 $("#pr_complaints,#lightbox_bg").fadeOut(200); 
			 ...
			 $(document).on("click","#ctl00_ContentPlaceHolder1_LinkButton_Add",function(e){
		   
						 $("#pr_complaints,#lightbox_bg").fadeOut(200,function(){ updateComplaints(); }); 
    ...
    <style type="text/css">
 	  ...
 	  .bx_01 { width: 98%; float:left; box-sizing:border-box; padding: 10px; padding-top:15px; min-height:100px;  }    
      .bx_01 h3 { margin-top:-25px; }
      .bx_01_content { width: 100%; min-height:100px; } 
	  
	  a.add_btn { width: 40px; height: 40px; display: block;   background: #fff; line-height: 40px; font-size: 40px; font-weight: bold; text-decoration: none; border:#ccc solid 1px; border-radius: 100%; text-align: center; color: #ccc; float: right;   position:absolute;  box-shadow: 0px 4px 4px #dee1e5; display1:none; margin-top:-15px; right:2%;     }
      
      a.add_btn:hover { color: #999; }
  
     
	 
	 .pCHtml { list-style:none;}
	 .pCHtml li { padding-left:10px; background:url(../resources/images/img_bullet_1.png) 0px 8px no-repeat; background-size:4px 4px; width:100%; font-weight:bold; color:#cb2d2d;  }
...
<div class="main_bx">
             ...
             <ul class="pCHtml"></ul>  
               ...
               <asp:UpdatePanel ID="updatepanel1" runat="server">
                     ...
                     <asp:HiddenField ID="hfName" runat="server" />
                      ...
                      <div class="lightbox" id="pr_complaints" style="width:650px;">
						<a href="#" class="closeBox"></a>
					    <h4 class="lightbox_title">Add Presenting Complaints</h4>
                     <asp:Panel ID="pnlPresentingComplaints" runat="server" DefaultButton="LinkButton_Add">
                     
                     
                     <ul class="form_list">
 <li><label>Complaint</label><asp:TextBox ID="TextBoxComplaint_Name" runat="server" Width="250px"></asp:TextBox> <asp:Button ID="ButtonSearch" runat="server" Text="Search" Width="55px" Visible="false" />  </li>
 <li><label>Duration</label> <asp:TextBox ID="TextBoxDuration" runat="server" SkinID="intdata" Width="70px"></asp:TextBox></li>
 <li><label>&nbsp;</label>
          <asp:DropDownList ID="DropDownListDuration" runat="server" Width="75px" style="height:30px;">
 ...
 <li><label>&nbsp;</label> <asp:LinkButton ID="LinkButton_Add" CssClass="btn_hacims lnkBtnNormalText" runat="server" OnClick="LinkButton_Add_Click" style="height:30px; line-height:30px;">Save</asp:LinkButton>
            ...
            </div>   <a href="#" class="add_btn" title="Add Presenting Complaints">+</a>  
    </div> 
  
   <!--///////////////////////////////////////////////////////////////////////////////////////////////////////////-->
    <div class="bx_01" style="display:none;">
    <h3>History</h3>
        <div class="bx_01_content">
   				...
   				<asp:UpdatePanel ID="updatepanel8" runat="server">
                            ...
                            <div class="bx_infos_patients">
                                                    <div class="bxinfo_margin">
                                                        ...
                                                        <asp:TreeView ID="TreeView1" runat="server" CssClass="Grid_tree" ShowLines="True"
                            ...
                            <asp:Panel ID="panel_Remarks" Visible="false" runat="server">
                             ...
                             <div style="margin-left: 31px; display: none;" class="bx_infos_patients">
                                ...
                                <iframe id="iframhistory" runat="server" width="100%" height="700px"></iframe>                 
                             ...
                             <asp:HiddenField ID="HiddenField_count_val" runat="server"></asp:HiddenField>
                                                ...
                                                <span style="display: none;">
                                                    <asp:Button Style="margin-top: 5px" ID="Button_Save" runat="server" Text="Save" CssClass="btn1"></asp:Button></span>
  ...
  <!--///////////////////////////////////////////////////////////////////////////////////////////////////////////-->
   ...
   <div class="bx_infos_patients">
                                            <div class="bxinfo_margin">
                                                <asp:Label ID="labaelExamination" runat="server"></asp:Label>
  			  ...
  			  <iframe id="IframeExamination" runat="server" width="100%" height="300px"></iframe>
  ...
  <!--///////////////////////////////////////////////////////////////////////////////////////////////////////////-->
    ...
    <h3>Diagnosis</h3>
        <div class="bx_01_content">
		 ...
		 <div class="lightbox" id="add_diagnosis" style="width:650px;">
						<a href="#" class="closeBox"></a>
					    <h4 class="lightbox_title">Add Diagnosis</h4>
        
		<ul class="form_list" style="width:100%;">
        <li><label><asp:Label ID="Label_messageAddDiagnosis" runat="server" CssClass="err"></asp:Label></label>
        <asp:TextBox ID="TextBox_Diagnosis_search" PlaceHolder="Diagnosis" runat="server" AutoPostBack="True" CssClass="input_txt"
                                                Style="width:300px"></asp:TextBox>
        </li>
        <li><asp:CheckBoxList ID="chkboxDepartmentDiagnoses" runat="server" RepeatColumns="5" RepeatDirection="Horizontal"></asp:CheckBoxList> <asp:Button ID="btnAddDiagnosis" runat="server" Text="Save" Style="height:30px; line-height:30px;" /> </li>
                                ...
                                <asp:DataList ID="DataList_CurrentVisitDiagnosis" runat="server" DataKeyField="Diagnosis_ID"
                                    DataSourceID="SqlDataSource_DataListCurrnentDiagnosis" RepeatLayout="Flow" Width="100%">
       ...
       <asp:SqlDataSource ID="SqlDataSourceGridView" runat="server" ProviderName="<%$ ConnectionStrings:TreatmentConnectionString.ProviderName %>"
  		...
  		</div>  <a href="#" class="add_btn" title="Add Diagnosis">+</a>       
    </div><!--bx_01-->
                            ...
                            <table class="tbl_form" cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox AccessKey="n" ID="TextBox_Test" runat="server" Style="width: 65%;" AutoPostBack="true"></asp:TextBox>
        ...
        <div class="bx_01_content">
         ...
         <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                            <ContentTemplate>
                                ...
                                <br />
                                <asp:TextBox ID="txtPhycicianNotes" runat="server" TextMode="MultiLine" Style="width: 99%; height: 161px"></asp:TextBox>
                                <div align="center" style="padding-top: 10px;">
                                    <asp:Button ID="Button_phy_Notes" runat="server" Text="save" CssClass="btn1"></asp:Button>
                                </div>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                            ...
                            <ContentTemplate>
                                ...
                                <table cellpadding="2" cellspacing="2">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:RequiredFieldValidator ID="vaddlDept" runat="server" ControlToValidate="ddlDept"
                                ...
                                <asp:TextBox ID="txtReferalNotes" runat="server" TextMode="MultiLine" Style="width: 100%; height: 120px;"></asp:TextBox>
                                ...
                                <div align="center" style="padding-top: 10px;">
                                    <asp:Button ID="btnSaveReferal" CausesValidation="true" ValidationGroup="mainAppForRef"
                                        runat="server" Text="save" CssClass="btn1"></asp:Button>
                                </div>
                            </ContentTemplate>
                        </asp:UpdatePanel>
        </div>
