<%@ page language="C#" autoeventwireup="true" masterpagefile="~/hacims_masterpage_admin.master" inherits="Machine_Attendance_Employee_LateDetail, App_Web_aiw43tag" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="bxmain inner_content" style="width:100%">
        <h2><span>Detail Late Report</span></h2>
            ...
            <td colspan="2">
                ...
                <asp:SqlDataSource ID="SDS_Branch" runat="server"
                    ConnectionString="<%$ ConnectionStrings:DutyRoaster %>"
                        SelectCommand="SELECT 'All' as Dept_Name ,0 as Dept_ID union  select  [Dept_Name], [Dept_ID] from Department where (Hospital_ID = @HospitalID)
