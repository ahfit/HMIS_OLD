...
Partial Class HR_EmployeeAttendanceLogs
    ...
    Private Sub ShowReport()
        ...
        Try
            con.Open()
            cmd = New SqlCommand("usp_GetEmployeeAttendanceLogs", con)
            ...
            da.Fill(dt)
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("EmployeeAttendanceLogs.rdlc")
