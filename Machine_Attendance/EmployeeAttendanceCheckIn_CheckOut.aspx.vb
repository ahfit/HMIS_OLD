...
Partial Class HR_EmployeeAttendanceCheckIn_CheckOut
    ...
    Private Sub ShowReport()
        ...
        Try
            con.Open()
            cmd = New SqlCommand("SelectOverAllTimeInTimeOut", con)
            ...
            cmd.Parameters.AddWithValue("@inoutmode", RBL_Emp_stat.SelectedValue)
            'cmd.Parameters.AddWithValue("@EmpNo", txtbox_EmpNo.Text)
            Dim da As SqlDataAdapter = New SqlDataAdapter(cmd)
            Dim dt As DataTable = New DataTable()
            da.Fill(dt)
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("EmployeeCheckInCheckOut.rdlc")
