<%@ page language="VB" autoeventwireup="false" masterpagefile="~/hacims_masterpage_admin.master" inherits="Administrator_Add_New_Company, App_Web_2qu1gl2y" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
    ...
    <asp:TextBox ID="TextBox_Email"  runat="server"  ></asp:TextBox></td>
        ...
        <asp:TextBox ID="TextBox_STR_No"  runat="server"  ></asp:TextBox></td>
            ...
            <tr>
              ...
              <td colspan="2" ><asp:TextBox ID="TextBox_ACNo"  runat="server"  ></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right" >&nbsp;</td>
                <td colspan="2" ><asp:Button ID="Button_Save_Name" Text="Save"   runat="server"  />
