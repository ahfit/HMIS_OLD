<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="EmployeePromotionHistory.aspx.cs" Inherits="HR_EmployeePromotionHistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="bxmain inner_content" style="width: 100%">
        <h2>
            <span>Employee Promotion History
            </span>
        </h2>
        <table>
            <tr>
