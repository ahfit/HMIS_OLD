...
public partial class HR_EmployeePromotionHistory : System.Web.UI.Page
{
    ...
    protected void LoadReport()
    {
        ...
        try
        {
            SqlCommand sc = new SqlCommand("usp_GetEmployeePromotionHistoryReport", conn);
            ...
            sc.Parameters.AddWithValue("@Promotion", 1);
            //sc.Parameters.AddWithValue("@Hospital_ID", DDL_Company.SelectedValue);

            SqlDataAdapter sda = new SqlDataAdapter(sc);
            sda.Fill(dt);
            string path = Server.MapPath("EmployeePromotionHistory.rdlc");
