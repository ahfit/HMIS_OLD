<%@ page language="C#" autoeventwireup="true" masterpagefile="~/hacims_masterpage_admin.master" inherits="HR_Advertisement_New_Advertisement, App_Web_sbolykjk" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
    ...
    <div class="bxmain inner_content" style="width: 100%;">
        ...
        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:HyperLinkField Text="Report" DataNavigateUrlFields="Ad_Id" Target="_blank" DataNavigateUrlFormatString="~/HR/Advertisement/Advertisement_Report.aspx?Id={0}" />
            </Columns>
        </asp:GridView>

    </div>
    <asp:Panel runat="server" ID="PanelAddPosts" Visible="false" CssClass="lightbox" Width="">
        <div class="bxmain inner_content" style="width: 800px">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tbl_form">
                ...
                <tr>
                    ...
                    <td class="Panelstyle1">Experience</td>
                    <td>
                        <asp:TextBox runat="server" ID="txtPostExperience" TextMode="MultiLine" Width="200px" Height="70px" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="center">
