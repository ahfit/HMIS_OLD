...
Imports System.Data
Imports DbClass
Partial Class Search_EmployeeRequestHODtoHR
    ...
    Protected Sub Button_Search_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button_Search.Click
        ...
        GridView1.DataSource = db.ExecuteDataTable("uspSelectEmployeeForLeave_HODtoHR", "Leave_ManagementConnectionString", sqlParams)
        GridView1.DataBind()
