...
public partial class HR_EmployeeAppointmentLetter : System.Web.UI.Page
{
    ...
    protected void LoadReport()
    {
        ...
        try
        {
            ...
            cmd = new SqlCommand("usp_GetAppointmentLetter", con);
            ...
            rds.Name = "DataSet1";
            rds.Value = dt;
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("Employeeappointmentletter.rdlc");
