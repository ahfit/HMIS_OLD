<%@ page title="" language="C#" masterpagefile="~/hacims_masterpage_admin.master" autoeventwireup="true" inherits="HR_ApplicantForm, App_Web_5t2nflla" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
//                   return true;
            ...
            $('[id$="txtboxObtained"], [id$="txtboxTotal"]').blur(function () {

                var obtained = $('[id$="txtboxObtained"]').val();
                var total = $('[id$="txtboxTotal"]').val();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div width="100%" align="center">
              ...
              <%--  <tr>
                ...
                <tr align="right" style="width:100px;height:30px">
                    ...
                    <td colspan="2" align="center">
                        ...
                        <div style="height:150px;overflow-y:scroll;border:solid;margin-bottom:10px;border-color:ActiveBorder;margin-left:20px">                   
                            ...
                            <Columns>
                               ...
                               <%-- <asp:TemplateField HeaderText="Select Post">
                                ...
                                <asp:TemplateField HeaderText="Delete Post">
                                    <ItemTemplate>
                                        <asp:Button ID="btnDeletePost" CommandName='<%# Bind("Apply_For_Id") %>' runat="server" Text="Delete" OnClick="btnDeletePost_Click" />
        ...
        ErrorMessage="Please Enter CNIC No">*</asp:RequiredFieldValidator></span></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="TextBox_mobile_No" MaxLength="11" SkinID="intdata" runat="server" CssClass="input_txt"></asp:TextBox>
        ...
        <div>
           ...
           <asp:Label ID="lblPassword" Visible="false" runat="server" ForeColor="Red" Font-Bold="true"
            ...
            <asp:LinkButton ID="lnkpasword" Text="changePassword" Visible="false"  runat="server" OnClick="lnkpasword_Click"></asp:LinkButton>
        ...
        <div runat="server" id="appDetails" class="bxmain">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl_form">
                <tr>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Qualification">
                                 ...
                                 <asp:TemplateField HeaderText="Countries Visited">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkbtnCountriesVisited" OnClick="lnkbtnCountriesVisited_Click" runat="server"
                                            Text="Countries Visited"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                    ...
                    <asp:Button runat="server" ID="btnReport" Text="Print Form" OnClick="btnReport_Click" Visible="false" />
                    </td>
                    </tr>
                </tr>
            </table>
            ...
            <div style="display: inline; float: left; width: 100%;" class="bxmain inner_content">
                ...
                <table>
                    <tr style="line-height: 1.5;">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlQulaification" runat="server"></asp:DropDownList>
                        </td>
                    ...
                    <td class="style2" style="font-weight: bold; text-align: right;">
                        ...
                        <td>
                            <asp:TextBox ID="txtboxPercentage" TextMode="Number" SkinID="intdata" runat="server"></asp:TextBox>
                        </td>                                            
                    </tr>
                    ...
                    <tr style="line-height: 3;">
                        ...
                        <td style="padding-left: 20px; text-align: center" colspan="2">
                            <asp:Button ID="btnSaveQualification" runat="server" Text="Save" ValidationGroup="mainApp" OnClick="btnSaveQualification_Click" />
            ...
            <div style="display: inline; float: left; width: 100%;" class="bxmain inner_content">
                ...
                <table>
                    <tr style="line-height: 1.5;">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlAdvertiseforpost" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlAdvertiseforpost_SelectedIndexChanged"></asp:DropDownList>
        ...
        <div class="lightbox">
            <div style="display: inline; float: left; width: 100%;" class="bxmain inner_content">
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="10">
                            <asp:GridView ID="ReserachPaperPGrid" runat="server" AutoGenerateColumns="false" Width="100%">
                                <Columns>
        ...
        <div class="lightbox">
            <div style="display: inline; float: left; width: 100%;" class="bxmain inner_content">
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="10">
                            <asp:GridView ID="FormalTrainingGrid" runat="server" AutoGenerateColumns="false" Width="100%">
                                <Columns>
                                <asp:BoundField DataField="Name" HeaderText="Name" />
    ...
    <asp:Panel ID="panelExperience" runat="server" Visible="false" CssClass="lightbox_bg">
        <div class="lightbox">
            <div style="display: inline; float: left; width: 100%;" class="bxmain inner_content">
                <h2>
                    <span>Employment Record </span></h2>
                <table>
                    <tr style="line-height: 1.5;">
                        <td class="style2" style="font-weight: bold; text-align: right;">
            ...
            <div style="display: inline; float: left; width: 100%;" class="bxmain inner_content">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbl_form" >
                          <tr>
                            ...
                            ControlToValidate="TextBoxRePassword" CssClass="err" Display="Dynamic" ErrorMessage="New Password And Confirm Password Faild are Not Same" ID="CompareValidatorCheckPassword" runat="server"
                          ...
                          <tr>
                            ...
                            ControlToValidate="TextBoxRePassword" CssClass="err" Display="Dynamic" ErrorMessage="Enter Re- Password" ID="RequiredFieldValidatorRePassword" runat="server"></asp:RequiredFieldValidator>
</td>
                            </tr>
                          <tr>
                            <td align="right" >&nbsp;</td>
                            <td ><asp:Button ID="ButtonUpdatePassword" runat="server" Text="Update" OnClick= "ButtonUpdatePassword_Click"  />
                                <asp:Button Text="Close" CausesValidation="false" ID="btnCloseChangePasswordPanel" OnClick="btnCloseChangePasswordPanel_Click" runat="server" />
                            </td>
