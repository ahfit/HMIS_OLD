<%@ page language="VB" debug="true" autoeventwireup="false" masterpagefile="~/hacims_masterpage_admin.master" inherits="PatientAppointmant_box, App_Web_xjzmobwq" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
            ...
            <td style="width: 300px;" valign="top">
                <div class="bx_infos_patients" style="height: 500px;">
                    ...
                    <div class="bxinfo_margin" style="height: auto; max-height: 410px;">
                        <asp:DataList ID="DataList_DoctorsList" runat="server"  DataKeyField="EmpID" Style="margin-left: 4px; 
                            ...
                            <ItemTemplate>
                                <div style="border-bottom: #999 dotted 0px; padding-bottom: 8px; padding-top: 5px;
                                    ...
                                    <strong>
                                        <asp:Label ID="Label_PatientName" Style="color: #202f3f;" runat="server" Text='<%# Eval("EmployeeName") %>'></asp:Label></strong>&nbsp;<span
                                ...
                                <td align="left">
                                    <asp:DataList ID="DataList_SelectDateAppointment" runat="server" DataSourceID="SqlDataSource_SelectedDateAppointmentSumary"
                                        ...
                                        <ItemTemplate>
                                            ...
                                            | &nbsp;</span>Paid &nbsp;(
                                            <asp:Label ID="Label1" runat="server" CssClass="txtb" ForeColor="Red" Text='<%# Eval("Paid") %>'></asp:Label>
                                            ) &nbsp;&nbsp;
                                            | &nbsp;</span>Unpaid &nbsp;(
                                            <asp:Label ID="Label2" runat="server" CssClass="txtb" ForeColor="Red" Text='<%# Eval("Unpaid") %>'></asp:Label>
                                            ) &nbsp;&nbsp;
                                            | &nbsp;</span>Canceled &nbsp;(
