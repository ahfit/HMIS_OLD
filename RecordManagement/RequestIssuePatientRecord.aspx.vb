...
Partial Class RecordManagement_RequestIssuePatientRecord
    ...
    Sub search1(ByVal indx As Integer)
        If indx = 0 Then
            Try
                ...
                Dim dtaset As DataSet = searchpanel1.search1_advance_Search(Panel2, "Search_Record_Management_Patients_File_Issue", constring)
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                'sqlDs_PatientRecordIssue.SelectParameters("Patient_File_ID").DefaultValue = Request.QueryString("File_Id")
