<%@ Page Title="" Language="VB" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="false" CodeFile="IssuePendingPatientRecord.aspx.vb" Inherits="RecordManagement_IssuePatientRecord" %>
              ...
              <Columns>
                  <asp:TemplateField>
                    <ItemTemplate>
                        ...
                        <asp:Button ID="btnRecordActivity" OnClick="btnRecordActivity_Click"  CommandArgument='<%#Eval("Patient_File_ID") %>' runat="server" Text="Request" Visible="false" />
                        ...
                        <asp:HiddenField ID="hdfIssueTo" runat="server" Value='<%#Eval("EmpID") %>' />
                        <asp:HiddenField ID="hdfConsultantID" runat="server" Value='<%#Eval("ConsultantID") %>' />
                        <asp:HiddenField ID="hdfDeptID" runat="server" Value='<%#Eval("DeptID") %>' />
                    </ItemTemplate>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:SqlDataSource ID="sqlDs_SubDept" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>" 
                    ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT  SubDept_Id   Dept_ID,SubDept_Name Dept_Name
FROM         subdepartment
