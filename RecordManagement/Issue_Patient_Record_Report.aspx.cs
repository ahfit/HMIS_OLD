...
public partial class RecordManagement_Issue_Patient_Record_Report : System.Web.UI.Page
{
    ...
    protected void LoadReport()
    {
        ...
        if (Request.QueryString["File_ID"]!=null)
        {
            ...
            string reportPath = Server.MapPath("~/RecordManagement/Issue_Patient_Record_Report.rdlc");
