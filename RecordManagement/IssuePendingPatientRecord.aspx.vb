...
Partial Class RecordManagement_IssuePatientRecord
    ...
    Sub search1(ByVal indx As Integer)
        If indx = 0 Then
            Try
                ...
                Dim dtaset As DataSet = searchpanel1.search1_advance_Search(Panel2, "Search_Record_Management_Patients_PR", constring)
    ...
    Protected Sub GridViewSearch_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridViewSearch.PreRender
        Try
            ...
            If GridViewSearch.Rows.Count <> 0 Then
                ...
                'GridViewSearch.HeaderRow.Cells(24).Visible = False
                For i As Integer = 0 To GridViewSearch.Rows.Count - 1
                    ...
                    'GridViewSearch.Rows(i).Cells(24).Visible = False
                Next
            End If
        Catch ex As Exception
    ...
    Protected Sub btnIssueFile_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim issueTo As HiddenField = gvRow.FindControl("hdfIssueTo")
        Dim consultantID As HiddenField = gvRow.FindControl("hdfConsultantID")
        Dim deptID As HiddenField = gvRow.FindControl("hdfDeptID")
        ddlSubDept.DataBind()
        ddlSubDept.SelectedValue = deptID.Value
        ddlSubDept.Enabled = False
        ddlConsultant.DataBind()
        ddlConsultant.SelectedValue = consultantID.Value
        ddlConsultant.Enabled = False
        ddlIssuedTo.SelectedValue = issueTo.Value
        ddlIssuedTo.Enabled = False
        ddlIssuedBy.Enabled = False
