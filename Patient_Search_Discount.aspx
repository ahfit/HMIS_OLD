<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_billing.master" AutoEventWireup="true" CodeFile="~/Patient Billing/Patient_Search_Discount.aspx.cs" Inherits="Patient_Billing_Patient_Search_Discount" %>
                    ...
                    <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtn_cancel" runat="server" CausesValidation="False" CommandName="Select"
                                Text="Discount" Visible='<%# Eval("Column1") %>' OnClick="lbtn_cancel_Click"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <tr>
                        ...
                        <td style="width: 100px; height: 24px">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Reg_ConnectionString %>"
                                InsertCommand="INSERT INTO Forward_To_Sub_Dept (Reg_No, yearly_no, to_sub_Dept, by_doctor, by_sub_dept_id, forward_date, request_type_id, To_Emp_Id, Description,AfterBill) VALUES     (@Reg_No,@yearly_no,@to_sub_Dept,@by_doctor,@by_sub_dept_id,getdate(),@request_type_id,@To_Emp_Id,@Description,1)"
