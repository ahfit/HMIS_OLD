<%@ page title="" language="VB" masterpagefile="~/hacims_masterpage_admin.master" autoeventwireup="false" inherits="PayRoll_ViewSalaryReports, App_Web_0baqw4fh" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
        ...
        <table style="width: 50%; margin: auto;">
            <tr>
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource_Hospital" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="sqlDs_Department" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
...
ORDER BY Dept_Name" runat="server">
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="sqlDs_AccountHead" ConnectionString="<%$ ConnectionStrings:PayRoll_ConnectionString %>"
...
SELECT     Salary_Allowance_Deduction_Setup.E_ID, Salary_Allowance_Deduction_Setup.Sort_Order, 
Salary_Allowance_Deduction_Setup.Allowance_Deduction, 
                      Expenditure.E_Code, Expenditure.E_Name
FROM         Salary_Allowance_Deduction_Setup INNER JOIN
                      Expenditure ON Salary_Allowance_Deduction_Setup.E_ID = Expenditure.E_ID
where Salary_Allowance_Deduction_Setup.Allowance_Deduction = case when @AllowanceDeduction=1 then  'Deduction' else 'Allowance' end" 
                        runat="server">
                        <SelectParameters>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="sqlDs_Design" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
                        SelectCommand="
...
ORDER BY Designation_Name" runat="server"></asp:SqlDataSource>
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="sqlDs_Employee" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="sqlDsMonth" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
...
ORDER BY Month_No" runat="server"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="sqlDsSalaryReport" runat="server" ConnectionString="<%$ ConnectionStrings:PayRoll_ConnectionString %>"
    ...
    <asp:SqlDataSource ID="sqlDsSalaryYearlyReport" runat="server" ConnectionString="<%$ ConnectionStrings:PayRoll_ConnectionString %>"
    ...
    <asp:SqlDataSource ID="SqlDsSalaryAllowDeductionReports" runat="server" ConnectionString="<%$ ConnectionStrings:PayRoll_ConnectionString %>"
