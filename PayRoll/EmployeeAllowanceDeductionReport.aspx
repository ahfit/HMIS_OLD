<%@ Page Title="" Language="VB" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="false" CodeFile="EmployeeAllowanceDeductionReport.aspx.vb" Inherits="Payroll_EmployeeAllowanceDeductionReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  style="display: none" ></iframe>
    <div class="bxmain inner_content" style="width: 100%">
        <h2><span>Employee Account Heads Detail Report</span></h2>
...
WHERE     (@SubDept_Id =0 or Employee.SubDeptId = @SubDept_Id) and ER.EmpID=@empid  order by Name,EmpID"
            ...
            <tr>
                <td align="right" class="style1">
                    <strong>Head Type :</strong></td>
                <td colspan="2">
                    <asp:DropDownList ID="ddlHeadType" runat="server"
                        CssClass="drop_down">
                        <asp:ListItem Value="-1" Text="--ALL--"></asp:ListItem>
                        <asp:ListItem Value="0" Text="Fix"></asp:ListItem>
                        <asp:ListItem Value="1" Text="Variable"></asp:ListItem>
                    </asp:DropDownList>
                    </td>
                </tr>
            <tr>
                <td align="right" class="style1">
                    <strong>Allowance/Deduction :</strong></td>
                <td colspan="2">
                    <asp:DropDownList ID="ddlAllowanceDeduction" runat="server"
                        CssClass="drop_down">
                        <asp:ListItem Value="0" Text="--ALL--"></asp:ListItem>
                        <asp:ListItem Value="1" Text="Allowances"></asp:ListItem>
                        <asp:ListItem Value="2" Text="Deductions"></asp:ListItem>
                    </asp:DropDownList>
                    </td>
                </tr>
