<%@ page title="" language="C#" masterpagefile="~/hacims_masterpage_admin.master" autoeventwireup="true" inherits="PayRoll_EmployeeBasicSetupAllow_Ded, App_Web_tchaehmk" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
  ...
  <div class="bxmain inner_content" id="" style="width:100%;">
   <h2><span>Employee Basic Setting</span></h2>
    <table class="style1">
        ...
        <tr runat="server" id="srchResultHeader" style="display: none;">
        ...
        <tr>
            <td class="style3">
                &nbsp;</td>
            <td>
            <asp:Button ID="btnAdd" Text="Add Allowances" runat="server" OnClick="btnAdd_Click" /><asp:Button
                ID="btnDelete" runat="server" Text="Delete Allowances" 
...
<%--        <tr>
        ...
        <tr>
            <td class="style3"  >
            <div class="bxmain inner_content" style="width:97%" ><span><h2>All Allowances</h2></span>
            ...
            <div class="bxmain inner_content" style="width:100%" ><span><h2>Selective Allowances</h2></span>
