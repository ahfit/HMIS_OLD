<%@ page title="" language="C#" masterpagefile="~/hacims_masterpage_admin.master" autoeventwireup="true" inherits="PayRoll_ArrearDeduction, App_Web_tchaehmk" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource_Department" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
                        ...
                        SelectCommand="select Dept_ID, Dept_Name from Department where @HospitalId  = 0  or Hospital_ID = @HospitalId">
                        <SelectParameters>
...
where E_ID = 1670">
                        ...
                        <tr>
                            ...
                            <td class="style1">
                                <asp:TextBox ID="txtAllDedAmount0" runat="server" Font-Size="15px" 
                                    ontextchanged="txtAllDedAmount0_TextChanged" AutoPostBack="True"></asp:TextBox>
                            </td>
                            <td class="header" align="right">
                                Amount</td>
                            <td>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:PayRollConnectionString %>"
        SelectCommand="SELECT     MonthlySalaryDetail.id, MonthlySalaryDetail.EmpId, Employee.Name, Salary_Allowance_Deduction_Setup.Head_Name, Employee.Designation, Employee.Department, 
                      ...
                      MonthlySalaryDetail.EntryDate, MonthlySalaryDetail.ApproveStatus
