<%@ page title="" language="C#" masterpagefile="~/hacims_masterpage_admin.master" autoeventwireup="true" inherits="PayRoll_EmpTypeWiseSalaryDetail, App_Web_tchaehmk" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
FROM         Department
WHERE     (Hospital_ID = 4)
ORDER BY Dept_Name"></asp:SqlDataSource>
            </td>
        </tr>
        <tr>
            <td class="style2" align="right">
