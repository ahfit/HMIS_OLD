<%@ Page Title="" Language="C#" MasterPageFile="~/Hacims_MasterPage_Admin_New.master" AutoEventWireup="true" CodeFile="socialsecurityLetter.aspx.cs" Inherits="PayRoll_SocialSecurityLetter" %>
    ...
    <div class="inner_content bxmain">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="tbl_form">
            <tr>
                ...
                <td  width="70%" >
                    <asp:DropDownList ID="Dropdownlist_company" runat="server" TabIndex="5" Width="202px"
                        ...
                        AutoPostBack="True" OnSelectedIndexChanged="Dropdownlist_company_SelectedIndexChanged">
                    </asp:DropDownList>
            ...
            <tr>
                <td colspan="2">
                    <br />
                      <h2>Employee's Social Security Letter..</h2>
                    <div align ="right" >
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="grdSalary" runat="server" ShowFooter="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="SSN_No" HeaderText="Social Security #" ReadOnly="True" SortExpression="SSN_No" />
                                    <%--<asp:BoundField DataField="CurrentSalary" HeaderText="Basic Salary" ReadOnly="True" SortExpression="CurrentSalary"  />--%>
                                    
                                    <asp:TemplateField HeaderText="Basic Salary" SortExpression="CurrentSalary"  >
                                        <ItemTemplate>
                                            <asp:Label ID="lblCurrentSalary" runat="server" Text='<%# Eval("CurrentSalary") %>'></asp:Label>
                                        </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="SS Amount" SortExpression="SocailSecurityAmount"  >
                                        <ItemTemplate>
                                            <asp:Label ID="lblIndividualSalary" runat="server" Text='<%# Eval("SocailSecurityAmount") %>'></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource_AllEmployeesSalary" runat="server" ConnectionString="<%$ ConnectionStrings:PayRoll_ConnectionString %>"
                        SelectCommand="SocialSecurityLetter" SelectCommandType="StoredProcedure" 
             ...
             <tr>
                <td colspan="2">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="GridViewBankLetters" 
                                ...
                                AllowSorting="true">
                                <Columns>
                                    <asp:BoundField DataField="From_Account" HeaderText="Letter Details" SortExpression="From_Account" />
                                    <asp:BoundField DataField="LetterNo" HeaderText="Letter No." SortExpression="LetterNo" />
                                    <asp:BoundField DataField="Check_No" HeaderText="Check No." SortExpression="Check_No" Visible="false"/>
                                    ...
                                    <asp:HyperLinkField DataNavigateUrlFields="SBT_id" DataNavigateUrlFormatString="../SocialSecurityLetterRpt.aspx?SBTID={0}" Target="_blank" Text="Show letter" />
                                </Columns>
                            </asp:GridView>
                            <asp:UpdateProgress ID="UpdateProgress1" runat="server">
                                <ProgressTemplate>
                                    <div style="position: fixed; text-align: center; height: 100%; width: 100%; top: 0; right: 0; left: 0; z-index: 9999999; background-color: #ffffff; opacity: 0.7;">
                                        <span style="border-width: 0px; position: fixed; padding: 50px; background-color: #ffffff; font-size: 36px; left: 40%; top: 40%;">
                                            <img src="../../images_hacims/process.gif" width="120px" height="120px" style="background: #ffffff" />
                                        </span>
                                    </div>
                                </ProgressTemplate>
                            </asp:UpdateProgress>
                    ...
                    <asp:SqlDataSource ID="SDS_BankLetters" runat="server" ConnectionString="<%$ ConnectionStrings:PayRoll_ConnectionString %>"
                        SelectCommand="SELECT SBT_id, Total_Amount,'Social Security Letter' AS From_Account, '' Check_No, Approved_Date, Transfer_Date, Salary_Month, Salary_Year, LetterNo FROM SS_Main T   WHERE (Salary_Month = @Salary_Month) AND (Salary_Year = @Salary_Year);" 
                        CancelSelectOnNullParameter="False" >
                            <SelectParameters>
