...
public partial class PayRoll_CashLetter : System.Web.UI.Page
{
    ...
    {
        if ( txtLetterNo.Text == string.Empty || WebDateChooser_Date.Value == null)
        {
        ...
        else
        {
         ...
         {
            string url = "../cashLetterRpt.aspx?SBTID=" + HiddenField_sbtid.Value;
    ...
    void Save()
    {
        ...
        try
        {
            ...
            else
            {
                ...
                Open();
                SqlCommand cmd = new SqlCommand("usp_CashSalaryTransfer", con);
    ...
    {
        Open();
        SqlCommand comand = new SqlCommand("Usp_DeleteCTransactionForSalary", con);
