<%@ Page Title="" Language="C#" MasterPageFile="~/Hacims_MasterPage_Admin_New.master" AutoEventWireup="true" CodeFile="Cashletter.aspx.cs" Inherits="PayRoll_CashLetter" %>
    ...
    <div class="inner_content bxmain">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="tbl_form">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource_AccountNumber" runat="server" ConnectionString="<%$ ConnectionStrings:Finance_ConnectionString %>"
                        SelectCommand="Select Distinct E.E_Name Account_No, E.E_Code Account_ID from Head_Master_Table H  Inner join Expenditure E on H.E_Code = E.E_Code where H.Head_Type ='Cash'">
                    </asp:SqlDataSource>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2">
                    <br />
                      <h2>Employee's Salary Without Cash Letter..</h2>
                    <div align ="right" >
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="grdSalary" runat="server"
                                ...
                                CssClass="grid_dash" DataKeyNames="EmpID"
                    ...
                    <asp:SqlDataSource ID="SqlDataSource_AllEmployeesSalary" runat="server" ConnectionString="<%$ ConnectionStrings:PayRoll_ConnectionString %>"
                        SelectCommand="BankCoverLetterReport_WithOutAcc" SelectCommandType="StoredProcedure" 
             ...
             <tr>
                <td colspan="2">
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="GridViewBankLetters"
                                ...
                                <Columns>
                                    ...
                                    <asp:HyperLinkField DataNavigateUrlFields="SBT_id" DataNavigateUrlFormatString="../cashLetterRpt.aspx?SBTID={0}" Target="_blank" Text="Show letter" />
                                </Columns>
                            </asp:GridView>
                    ...
                    <asp:SqlDataSource ID="SDS_BankLetters" runat="server" ConnectionString="<%$ ConnectionStrings:PayRoll_ConnectionString %>"
                        SelectCommand="SELECT SBT_id, Total_Amount,'' From_Account, '' Check_No, Approved_Date, Transfer_Date, Salary_Month, Salary_Year, LetterNo FROM Cash_Transfer_Main T   WHERE (Salary_Month = @Salary_Month) AND (Salary_Year = @Salary_Year);" 
                        CancelSelectOnNullParameter="False" >
                            <SelectParameters>
