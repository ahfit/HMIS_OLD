<%@ Page Title="" Language="C#" MasterPageFile="~/Hacims_MasterPage_Admin_New.master" AutoEventWireup="true" CodeFile="EOBILetter.aspx.cs" Inherits="PayRoll_SocialSecurityLetter" %>
            ...
            <tr>
                <td colspan="2">
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="grdSalary" runat="server" ShowFooter="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Account_Number" HeaderText="EOBI #" ReadOnly="True" SortExpression="Account_Number" />
                                    ...
                                    <asp:TemplateField HeaderText="EOBI Amount" SortExpression="Salary_Payable">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Company Amount" SortExpression="Salary_Payable">
                                        <ItemTemplate>
                                            <asp:Label ID="lblIndividualSalary" runat="server" Text='<%# Eval("Salary_Payable") %>'></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource_AllEmployeesSalary" runat="server" ConnectionString="<%$ ConnectionStrings:PayRoll_ConnectionString %>"
                        SelectCommand="getEOBILetterData" SelectCommandType="StoredProcedure" 
             ...
             <tr>
                <td colspan="2">
                    ...
                    <asp:SqlDataSource ID="SDS_BankLetters" runat="server" ConnectionString="<%$ ConnectionStrings:PayRoll_ConnectionString %>"
                        SelectCommand="SELECT SBT_id, Total_Amount,'' From_Account, '' Check_No, Approved_Date, Transfer_Date, Salary_Month, Salary_Year, LetterNo FROM EOBI_Main T   WHERE (Salary_Month = @Salary_Month) AND (Salary_Year = @Salary_Year);" 
                        CancelSelectOnNullParameter="False" >
                            <SelectParameters>
