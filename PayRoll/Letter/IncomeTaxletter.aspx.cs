...
public partial class PayRoll_IncomeTaxletter1 : System.Web.UI.Page
{
    ...
    void Save()
    {
        ...
        try
        {
            ...
            else
            {
                ...
                Open();
                SqlCommand cmd = new SqlCommand("IncomeTaxTransfer", con);
    ...
    {
        Open();
        SqlCommand comand = new SqlCommand("Usp_DeleteIncomeTaxLetter", con);
