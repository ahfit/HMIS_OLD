<%@ page title="" language="C#" masterpagefile="~/hacims_masterpage_admin.master" autoeventwireup="true" inherits="PayRoll_Employee_Allow_Ded_BrkUp, App_Web_tchaehmk" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
ORDER BY Dept_Name" >
            ...
            <td class="style2" colspan="2">
                <asp:GridView ID="GV_Employee_Allowance_Deduction" runat="server" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Conveyance_Allowance" HeaderText="Bonus" ReadOnly="True" 
                        ...
                        <asp:BoundField DataField="OverTime" HeaderText="Over Time" ReadOnly="True" 
        ...
        SelectCommand="Employee_AllowanceDeduction_BrkUp_rpt" 
