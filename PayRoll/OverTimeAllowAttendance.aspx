<%@ page title="" language="C#" masterpagefile="~/hacims_masterpage_admin.master" autoeventwireup="true" inherits="PayRoll_OverTimeAllowAttendance, App_Web_tchaehmk" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RadioButtonList ID="RadioButtonList_SearchType" runat="server" 
                            ...
                            <asp:ListItem Value="2" Selected="True">List</asp:ListItem>
                        </asp:RadioButtonList>
