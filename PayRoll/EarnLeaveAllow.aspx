<%@ page title="" language="C#" masterpagefile="~/hacims_masterpage_admin.master" autoeventwireup="true" inherits="PayRoll_EarnLeaveAllow, App_Web_tchaehmk" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
where E_ID = 1679">
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <table class="diagnosis_list">
                        ...
                        <tr>
                            ...
                            <td class="style1">
                                <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="Larger" ForeColor="#FF0066" 
                                    Text='<%# Eval("EarnLeaveDays") %>'></asp:Label>
                            </td>
                            <td align="right" class="header">
                                &nbsp;</td>
                            <td>
                        ...
                        <tr>
                            <td class="header" align="right">
                                Days of Earn Leave:</td>
                            <td class="style1">
                                <asp:TextBox ID="txtAllDedAmount0" runat="server" Font-Size="15px" 
                                     AutoPostBack="True" ontextchanged="txtAllDedAmount0_TextChanged"></asp:TextBox>
                            </td>
                            <td class="header" align="right">
                                Amount</td>
                            <td>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" CancelSelectOnNullParameter="False" runat="server"
        ...
        SelectCommand="usp_EarnLeaveDays" SelectCommandType="StoredProcedure">
        <SelectParameters>
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="id"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="EarnLeaveDays" HeaderText="Days" SortExpression="EarnLeaveDays" />
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:PayRollConnectionString %>"
        SelectCommand="SELECT     MonthlySalaryDetail.id, MonthlySalaryDetail.EmpId, Employee.Name, Salary_Allowance_Deduction_Setup.Head_Name, Employee.Designation, Employee.Department, 
                      ...
                      MonthlySalaryDetail.EntryDate, MonthlySalaryDetail.ApproveStatus,MonthlySalaryDetail.EarnLeaveDays
...
WHERE     (MonthlySalaryDetail.ApproveStatus = 0) and (MonthlySalaryDetail.E_ID = @E_ID) AND (MonthlySalaryDetail.SalaryMonth = @SalaryMonth) 
AND (MonthlySalaryDetail.SalaryYear = @SalaryYear)
