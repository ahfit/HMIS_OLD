...
public partial class PayRoll_IncomeTaxRpt : System.Web.UI.Page
{
    ...
    private void ShowReport()
    {
        try
        {
            ...
            string reportPath = Server.MapPath("~/Payroll/IncomeTaxLetterFinal.rdlc");



            DataTable dt = DB.ExecuteDataTable("usp_IncomeTaxLetterRpt", "PayRoll_ConnectionString", para);//  ds.Tables["usp_BankLetterRpt"];
            double sum = 0;
