<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master"
    AutoEventWireup="true" CodeFile="AddEmployeeAdvancerpt.aspx.cs" Inherits="PayRoll_AddEmployeeAdvancerpt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="bxmain">
    <div   class="bxmain inner_content"><span><h2>Add Employee Advances</h2></span>
        <div style="width:100%;text-align:center;">
        <asp:Label ID="lblMsg"  runat="server" Style="font-size: 13px; font-weight: bold;"></asp:Label></div>
        <table style="width: 100%; line-height: 30px;">
            <tr style="display:none;">
                ...
                <td>
                    <asp:RadioButtonList ID="rdoType" RepeatDirection="Horizontal" runat="server" AutoPostBack="true" OnSelectedIndexChanged="rdoType_SelectedIndexChanged1">
               ...
               <tr>
                ...
                <td>
                  <asp:DropDownList runat="server" ID="ddlEmployee" AutoPostBack="true" OnSelectedIndexChanged="ddlEmployee_SelectedIndexChanged">
            ...
            <tr style="display:none">
                ...
                <td>
                 ...
                 <td align="right" class="style3">
                       Installment Started From Month :
                    </td>
                    <td>
    ...
    <br />
    <div style="width: 90%;display:none;  margin: 0 auto;" class="bxmain inner_content"><span><h2>Employee Loan Details</h2></span>
                ...
                <asp:GridView ID="grdViewEmployeeAdvanceLoanDetails" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="InstallmentAmountCal" HeaderText="Installment Amount" SortExpression="InstallmentAmountCal" />
        ...
        <div class="lightbox">
            <div style="display: inline; float: left; width: 100%;" class="bxmain inner_content">
                ...
                <div style="height:300px;overflow-y:auto; text-align:center" class="bxmain inner_content">
                    ...
                    <div style="float:left;width:100px;font-size:13px;font-weight:bold;"><asp:Label ID="lblAmount" runat="server"></asp:Label> </div>
                 </div>
