<%@ page title="" language="C#" masterpagefile="~/hacims_masterpage_admin.master" autoeventwireup="true" inherits="PayRoll_Voucher_For_SalaryPayable, App_Web_tchaehmk" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
select * from Employee_Type"
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Button ID="btn_PostVoucher" runat="server" Text="Post Voucher" 
                    OnClick="btn_PostVoucher_Click" />
                    
                <asp:Label ID="lbl_mg" runat="server" Font-Bold="True" ForeColor="#FF0066"></asp:Label>
                    
                <asp:SqlDataSource ID="SqlDataSource_Post_Voucher" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:Finance_ConnectionString %>" 
                    InsertCommand="JV_SalaryPayable" InsertCommandType="StoredProcedure" 
                    ProviderName="<%$ ConnectionStrings:Finance_ConnectionString.ProviderName %>">
                    <InsertParameters>
                        <asp:SessionParameter Name="By_Emp_Id" SessionField="empid" Type="Int32" />
                        <asp:ControlParameter ControlID="ddlMonth" Name="month" 
                            PropertyName="SelectedValue" Type="String" />
                        <asp:ControlParameter ControlID="ddlYear" Name="year" 
                            PropertyName="SelectedValue" Type="String" />
                        <asp:ControlParameter ControlID="RadioButtonList_SalryType" Name="SalayType" 
                            PropertyName="SelectedValue" Type="String" />
                        <asp:ControlParameter ControlID="DropDownList1" Name="Job_Type" 
                            PropertyName="SelectedValue" Type="String" />
                    </InsertParameters>
                </asp:SqlDataSource>
            </td>
