<%@ page language="VB" autoeventwireup="false" masterpagefile="~/hacims_masterpage_admin.master" inherits="Pathology_Update_Component_Max_length, App_Web_42zygch0" enableeventvalidation="false" theme="theme_hacims" viewstateencryptionmode="Never" maintainscrollpositiononpostback="true" %>
...
<div class="bxmain"> <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbl_form" >


                          <tr>
                            <td width="25%" align="right" valign="middle" >Main Group :</td>
                            <td colspan="2" valign="middle" width="25%"><asp:DropDownList AutoPostBack="True"  DataTextField="TGName" DataValueField="TGID" ID="DropDownListMGroup" runat="server"  DataSourceID="SqlDataSourceMGroup"> </asp:DropDownList></td>
                              <td width="25%" align="right" valign="middle" >Sub Group :</td>
                            <td width="25%"  valign="middle"><asp:DropDownList AutoPostBack="True"  DataTextField="TSGName" DataValueField="TSGID" ID="DropDownListSubGroup" runat="server"  DataSourceID="SqlDataSourceSubGroup">
                            </asp:DropDownList></td>
      </tr>
                            <tr>
