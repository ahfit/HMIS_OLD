<%@ page language="VB" autoeventwireup="false" inherits="Administrator_Admin_RunTimeQuery, App_Web_42zygch0" enableeventvalidation="false" theme="theme_hacims" viewstateencryptionmode="Never" maintainscrollpositiononpostback="true" %>
    ...
    <td width="957" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        <td width="20" height="32" valign="top"><!--DWLayoutEmptyCell-->&nbsp;</td>
            <td width="937" valign="middle" class="text_heading_02">Physical Examination  &gt;&gt; <span class="text_lables3">Element Values </span></td>
          </tr>
                  ...
                  <td height="449" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <td width="916" height="68" valign="top" dir="ltr"><table width="100%" border="0" cellpadding="0" cellspacing="0"  >
                          ...
                          <tr>
                            <td align="right" valign="middle"  style="height: 30px">
                              ...
                              <td colspan="2" valign="middle" dir="ltr" style="height: 30px"><span style="height: 34px">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <asp:Button ID="ButtonRefresh" runat="server" Width="86px" Text="Refresh"/>
                                  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                              </span></td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2" valign="middle" dir="ltr">
                                    <table>
                                        <tr>
                                            ...
                                            <td rowspan="5" style="width: 45px">
                                                <asp:RadioButtonList ID="RadioButtonList2" runat="server" Height="124px" Width="53px">
                                                    <asp:ListItem Selected="True">=</asp:ListItem>
                                                    <asp:ListItem>Like</asp:ListItem>
                                                    <asp:ListItem>&gt;</asp:ListItem>
                                                    <asp:ListItem>&lt;</asp:ListItem>
                                            ...
                                            <td style="width: 124px; height: 29px">
                                                <asp:TextBox ID="TextBoxEqual2" runat="server" Width="115px"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td rowspan="2" style="width: 99px; text-align: center">
                                                <asp:DropDownList Css ID="DropDownListOperater" runat="server" Width="60px">
                                                    <asp:ListItem>And</asp:ListItem>
                                                    <asp:ListItem>Or</asp:ListItem>
                                                    <asp:ListItem>None</asp:ListItem>
                                                </asp:DropDownList></td>
                                            <td style="width: 124px; height: 18px">
                                                <asp:TextBox ID="TextBoxLike2" runat="server" Width="115px"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 133px; height: 18px">
                                                <asp:TextBox ID="TextBoxGreater1" runat="server" Width="115px"></asp:TextBox></td>
                                            <td style="width: 124px; height: 18px">
                                                <asp:TextBox ID="TextBoxGreater2" runat="server" Width="115px"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 133px; height: 18px">
                                            ...
                                            <td style="width: 124px; height: 18px">
                                                <asp:TextBox ID="TextBoxLess2" runat="server" Width="115px"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 133px; height: 10px">
                                            </td>
                                            <td style="width: 99px; height: 10px"><asp:Button ID="ButtonNext" runat="server" Width="86px" Text="Next Option"/></td>
                          ...
                          <tr>
                            ...
                            <td style="text-align: center; height: 23px;">
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                &nbsp; &nbsp;
                                <asp:Button ID="ButtonViewResult" runat="server" Width="138px" Text="View Result"/></td>
                      ...
                      <tr>
                        <td colspan="2" valign="top" dir="ltr" style="height: 344px"><span style="text-align: center">
                          <asp:GridView ID="GridViewElementValues" runat="server"
                        Width="100%" >
                            ...
                            <AlternatingRowStyle CssClass="GridAltItem" />
                              <Columns>
                                  <asp:HyperLinkField DataNavigateUrlFields="PayID,RegNo" DataNavigateUrlFormatString="../Patient_Past_Profile.aspx?YearlyNo={0}&amp;RegNo={1}"
                                      Text="View" />
                              </Columns>
                          </asp:GridView>
