<%@ page language="C#" autoeventwireup="true" inherits="Radiology_Dialy_Test_Report, App_Web_44exovlo" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
 ...
 <td>
    ...
    <table class="style1">
        ...
        <td width = "50%" >
            ...
            <asp:HiddenField ID="Hdfield_StartDate" runat="server" />
        ...
        <td width = "50%" >
            ...
            <asp:HiddenField ID="HiddenField_EDate" runat="server" />
...
<input type="button" value="Print" onclick="printSpecial()" id="btn_print" autofocus="autofocus"
      ...
      <div id="PrintDiv">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="Daily_Rediology_Patient" CancelSelectOnNullParameter="False" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:ControlParameter ControlID="Hdfield_StartDate" DefaultValue="" 
                    Name="Start_Date" PropertyName="Value" Type="DateTime" />
                <asp:ControlParameter ControlID="HiddenField_EDate" Name="End_Date" 
