<%@ page language="VB" autoeventwireup="false" inherits="Pathology_Patient_Result_Report_HTML, App_Web_hx1j4vz4" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
    ...
    <div>
     <table style="width: 924px">
           <tr>
               ...
               <td style="width: 89px">
                   <asp:DropDownList ID="DropDownList_TB_ID" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource_TB_ID"
           ...
           <tr>
               ...
               <td style="width: 89px">
                   <asp:RadioButtonList ID="RBL_group" runat="server" AutoPostBack="True" 
                       ...
                       <asp:ListItem Value="1" Selected="True">Group</asp:ListItem>
