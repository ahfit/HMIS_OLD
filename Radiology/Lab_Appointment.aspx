<%@ page language="VB" autoeventwireup="false" masterpagefile="~/hacims_masterpage_billing.master" inherits="Lab_Appointment, App_Web_hx1j4vz4" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
.list_style {background-color:#b9daff;  }
 </style>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="tbl_form" style="margin-top: 5px;
                                        ...
                                        <tr>
                                            <td align="right" width="25%">
                                                Name :</td>
                                            <td width="25%">
                                                <asp:Label ID="TB_NameLabel" runat="server" Text='<%# Eval("TB_Name") %>'></asp:Label></td>
                                            <td align="right" width="25%">
                                                Group Name :</td>
                                            <td align="left" width="25%">
                                                <asp:Label ID="TGNameLabel" runat="server" Text='<%# Eval("TGName") %>'></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                Appointment Date :</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:DropDownList ID="ddlExternalLab" runat="server" DataTextField="External_Lab" DataValueField="External_Lab_ID" Visible="False">
                                                </asp:DropDownList>&nbsp;
<asp:HyperLink ID="hl_AddLab" runat="server" CssClass="openimages add_icon" NavigateUrl="~/Radiology/Add_External_Lab.aspx" Visible ="false">Add Lab.</asp:HyperLink>


                                                <asp:SqlDataSource ID="SQL_ExternalType" runat="server" ConnectionString="<%$ ConnectionStrings:Radiology_ConnectionString %>" SelectCommand="SELECT [External_Lab], [External_Lab_ID] FROM [Admin_External_Lab]"></asp:SqlDataSource>
                                            </td>
                                        </tr>
                                    </table>
                ...
                <asp:SqlDataSource ID="SqlDataSource_Booking_Service" runat="server" ConnectionString="<%$ ConnectionStrings:Radiology_ConnectionString %>"
                    SelectCommand="SELECT     case when Test_Booking_Services.Total_test = 1 then Test_Booking.TB_Name else Test_Booking.TB_Name + ' ( '+CONVERT(varchar,Test_Booking_Services.Total_test)+' )' end as TB_Name, TestGroup.TGName, Test_Booking_Services.ID, Test_Status.Status, Test_Booking_Services.Main_ID,Test_Booking_Services.TB_ID&#13;&#10;FROM         Test_Booking_Services INNER JOIN&#13;&#10;                      Test_Booking ON Test_Booking_Services.TB_ID = Test_Booking.TB_ID INNER JOIN&#13;&#10;                      TestGroup ON Test_Booking.MG_ID = TestGroup.TGID INNER JOIN&#13;&#10;                      Path_Result_Delivery ON Test_Booking_Services.Main_ID = Path_Result_Delivery.Main_ID INNER JOIN&#13;&#10;                      Test_Status ON Test_Booking_Services.Status = Test_Status.Status_ID&#13;&#10;&#13;&#10;WHERE (Path_Result_Delivery.Yearly_No = @YearlyNo) AND (Path_Result_Delivery.Reg_no = @RegNo) and (Test_Booking_Services.Status=14 or Test_Booking_Services.Status=12)  and Test_Booking_Services.Main_ID=@Main_ID"
                    DeleteCommand="DELETE FROM Test_Booking_Services WHERE (ID = @ID)" UpdateCommand="return_status"
                    UpdateCommandType="StoredProcedure" InsertCommand="INSERT_Pt_External_Lab_Record" InsertCommandType="StoredProcedure">
                    <SelectParameters>
