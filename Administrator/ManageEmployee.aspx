<%@ Page Language="VB" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="false" CodeFile="ManageEmployee.aspx.vb" Inherits="Administrator_ManageEmployee" title="Untitled Page" %>
...
<h2><span>Manage Employee</span> </h2>
</div>
...
<table  class="tableWidth">
    <tr>
        ...
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton ID="lnkBtnActivateDeactivate" OnClick="lnkBtnActivateDeactivate_Click" 
    ...
    <asp:SqlDataSource 
        ...
        SelectCommand="usp_GetEmployeeList" 
        ...
        <UpdateParameters>
            ...
            <asp:SessionParameter Name="ByEmp_ID" SessionField="emp_id" Type="String" />
        </UpdateParameters>
