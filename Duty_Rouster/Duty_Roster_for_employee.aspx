<%@ page language="VB" autoeventwireup="false" masterpagefile="~/hacims_masterpage_admin.master" inherits="Duty_Roster_for_employee, App_Web_eqmkimbh" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
<asp:GridView ID="GridView_Emp_Shift" runat="server" AllowPaging="True" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" CssClass="Grid_1" DataKeyNames="Emp_Duty_Roster" DataSourceID="SqlDataSource_Emp_Shift" Width="100%">
    ...
    &nbsp;
                ...
                ProviderName="<%$ ConnectionStrings:Basic_Data_ConnectionString.ProviderName %>" SelectCommand="SELECT SubDept_Name, SubDept_Id FROM SubDepartment WHERE (Dept_Id = @Deptid)">
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceEmployeeName" 
        runat="server" 
...
WHERE     (Employee.EmpID NOT IN
                          (SELECT     Emp_ID
                            ...
                            WHERE     (convert(varchar, Duty_Start_Date, 103) = @Date_Start) AND (convert(varchar, Duty_End_Date , 103)= @Date_End))) AND (Employee.DeptID = @DeptID) AND (Employee.SubDeptId = @SubDeptId)">
                          <SelectParameters>
