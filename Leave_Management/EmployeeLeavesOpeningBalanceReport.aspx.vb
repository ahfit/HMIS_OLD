...
Partial Class Leave_EmployeeLeavesOpeningBalanceReport
    ...
    Private Sub ShowReport()
        ...
        Try
            con.Open()
            cmd = New SqlCommand("usp_GetEmployeeLeavesOpeningBalance", con)
            ...
            da.Fill(dt)
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("EmployeeLeavesOpeningBalanceReport.rdlc")
