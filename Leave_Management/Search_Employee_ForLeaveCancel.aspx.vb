...
Imports System.Data
Partial Class LM_Search_Employee_ForLeaveCancel
    ...
    Protected Sub Button_Search_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button_Search.Click
        ...
        Dim sqlParams As SqlParameter() = {
                             ...
                             New SqlParameter("@AuthorityId", Session("emp_id")),
                              New SqlParameter("@LevelId", 2)
     }

        GridView1.DataSource = db.ExecuteDataTable("uspSelectEmployeeForCancelLeave", "Leave_ManagementConnectionString", sqlParams)
        GridView1.DataBind()
