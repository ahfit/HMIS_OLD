...
Partial Class HR_EmpLeaveBalanceCalcu
    ...
    Private Sub ShowReport()
        ...
        Try
            con.Open()
            cmd = New SqlCommand("GetEMpLeaveCalculation", con)
            ...
            cmd.Parameters.AddWithValue("@deptid", DDL_Branch.SelectedValue)
            ...
            da.Fill(dt)
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("BalanceLeaveRecord.rdlc")
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        'Dim fileName As String = ("EmpLeaveBalanceCalc_output_" _
        '            + (Session("emp_id").ToString + ".pdf"))
        'Dim fileName2 As String = ("EmpLeaveBalanceCalc_Print_" _
        '            + (Session("emp_id").ToString + ".pdf"))
        'deleteFile(fileName)
