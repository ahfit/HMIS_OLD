...
Partial Class Employee_Leaves_Approve_Reject
    ...
    Private Sub Approve_Reject_leave(status As Boolean)
        ...
        Try
            ...
            SqlDataSource_Leaves_For_Approval.UpdateParameters("DesignationId").DefaultValue = Session("DesignationID").ToString()
            ...
            Alert(msg, "../HR/Search_Employee_AR.aspx?SubDeptId=" + Request.QueryString("SubDeptId").ToString())
        Catch ex As Exception
            Show(ex.Message)
        End Try
