<%@ Page Title="" Language="VB" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="false" CodeFile="EmployeeApprovedLeavesByHODReport.aspx.vb" Inherits="Leave_EmployeeApprovedLeavesByHODReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  style="display: none" ></iframe>--%>
    ...
    <div class="bxmain inner_content" style="width: 100%; display:none;">
        <h2><span>Employee Leaves Balance</span></h2>
