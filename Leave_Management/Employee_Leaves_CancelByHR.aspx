<%@ Page Language="VB" AutoEventWireup="false"  MasterPageFile="~/hacims_masterpage_admin.master" CodeFile="Employee_Leaves_CancelByHR.aspx.vb"
    Inherits="LM_Employee_Leaves_CancelByHR" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    &nbsp;<div class="bxmain inner_content">
        <h2> Employee Leave Cancel Request By HR</h2>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="tbl_form">
               ...
               <asp:FormView ID="FormView1" runat="server" DataKeyNames="EmpID" DataSourceID="dsEmployeeInfo"
                ...
                <tr>
                    <td style="width:33%;  vertical-align:top;" >
                        <div class="bxmain inner_content" >
                           ...
                           EnableModelValidation="True">
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="Grid_1" EmptyDataText="No Record Found . . ." Width="98%">
                                <Columns>
                    ...
                    <tr>
                        <td align="right">
                            <asp:SqlDataSource ID="SqlDataSource_Leaves_For_Approval" runat="server" ConnectionString="<%$ ConnectionStrings:Leave_ManagementConnectionString %>"
                                ...
                                UpdateCommand="Usp_CancelLeaveRequest" UpdateCommandType="StoredProcedure">
                                <UpdateParameters>
                    ...
                    <td style="width:33%; vertical-align:top; " >
                        <div class="bxmain inner_content"><h2>Employee Cancel Leave Request</h2>
 ...
 convert(varchar, Employee_Leaves.End_Date ,103) as End_Date, Employee_Leaves.Leave_Days, Employee_Leaves.Description,
  Employee_Leaves.Type_Detail_Id, Employee_Leaves.Office_Ins_Id, Leave_Type_Detail.Leave_Name,
   ISNULL(Employee.EFName, '') + ' ' + ISNULL(Employee.EMName, '') + ' ' + ISNULL(Employee.ELName, '') AS [Employee Name] ,
	...
	inner join EmployeeLeaveCancelLogs ECL on teld.id = ECL.LeaveID AND ApproveStatus = 'HR'
