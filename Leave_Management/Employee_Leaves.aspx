<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Leaves.aspx.vb"
    MasterPageFile="~/hacims_masterpage_admin.master" Inherits="Leave_Management_Employee_Leaves" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class ="inner_content bxmain">
        <h2> Add leave(s) Request</h2>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td colspan="3">

                <asp:FormView ID="FormView1" runat="server" DataKeyNames="EmpID" OnDataBound="FormView1_DataBound" DataSourceID="dsEmployeeInfo"
                                    ...
                                    <td valign="top">
                                        <ul class="empinfo">
                                            ...
                                            <li>Emp # <strong>
                                                ...
                                                <span class="spl">|</span> <strong>
                                                    <asp:Label ID="LabelStatus" runat="server" Text='<%# Eval("Marital_Status")%>' ToolTip="Marital Status"></asp:Label></strong>
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
        ...
        <tr>
            <td valign="top" width="25%">
                <div class="inner_content bxmain" style="width: 97%;">
                    <h2>
                        <span>Leave Balance</span></h2>
                    <div style="border-style: solid; border-width: 0px; height: 190px; overflow-x: hidden; overflow-y: auto;">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="tbl_form">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <igsch:WebDateChooser ID="WebDateChooser_Start_Date" runat="server" CssClass="drop_date" Width="200px">
                        ...
                        <tr>
                            ...
                            <td>
                                <igsch:WebDateChooser ID="WebDateChooser_End_Date" CssClass="drop_date" runat="server" Width="200px">
                                    <AutoPostBack ValueChanged="True" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox_Leave_Day" runat="server" Enabled="false" Width="202px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td>
                                <asp:TextBox ID="TextBox_Salary_Day" runat="server" Width="202px" Enabled="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
            ...
            <td valign="top" width="25%">
                ...
                <div style="border-style: solid; border-width: 1px; height: 222px; overflow-x: hidden; overflow-y: auto;">
                    ...
                    <asp:HiddenField ID="HfDocumentRequired" runat="server" />
...
INNER JOIN Leave_Types ON Leave_Type_Detail.Leave_Type_id = Leave_Types.Leave_Type_Id" InsertCommandType="StoredProcedure">
    ...
    <asp:SqlDataSource ID="SqlDataSource_Employee_Leaves" runat="server" ConnectionString="<%$ ConnectionStrings:Leave_ManagementConnectionString %>"
        DeleteCommand="usp_DeleteEmployeeLeaves" DeleteCommandType="StoredProcedure"
    ...
    <div class ="inner_content bxmain">
        <h2 style="border-bottom:dotted 1px;">
           Previous Leave Record(s):
           
           </h2>
        <p>
            <span></span>&nbsp;</p>
        <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" DataKeyNames="Emp_Leave_Id"
            DataSourceID="SqlDataSource_Employee_Leaves" Width="100%" 
            AllowPaging="True">
            <Columns>
                <asp:BoundField DataField="Employee_Name" HeaderText="Employee Name" SortExpression="Employee_Name" />
                 ...
                 <asp:BoundField DataField="Emp_Leave_Id" HeaderText="Leave No." SortExpression="Emp_Leave_Id" />
                ...
                <asp:TemplateField  HeaderText="Approve / Reject">
                    <ItemTemplate>
                       ...
                       <%-- <asp:LinkButton  ID="LinkButton1" runat="server" onclick="LinkButton1_Click" 
                            ...
                            Visible='<%# Eval("HSStatus") %>'></asp:LinkButton>--%>
                ...
                <asp:TemplateField HeaderText="Delete">
                    <ItemTemplate>
                        <asp:LinkButton ID="lb_delete" runat="server" CausesValidation="False" Visible='<%# Eval("VisibleDeleteButon")%>'
                              Text="Delete" onclick="lb_delete_Click" OnClientClick="return confirmationDelete()"></asp:LinkButton>
                        <br />
    ...
    <asp:Panel ID="Panel2" runat="server"  Visible = "false" ><%--CssClass = "lightbox"--%>
        <table cellpadding="0" cellspacing="0" width="100%" class="tbl_form">
            <tr>
    ...
    <asp:Panel ID="pnl_app_delete" runat="server" Width ="350px" Visible = "false">
    ...
    <asp:HiddenField ID="HfSalaryDay" runat="server" Value="1" />
