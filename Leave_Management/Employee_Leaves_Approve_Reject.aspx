<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/hacims_masterpage_admin.master" CodeFile="Employee_Leaves_Approve_Reject.aspx.vb"
    Inherits="Employee_Leaves_Approve_Reject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    &nbsp;<div class="bxmain inner_content">
        <h2>Employee Leave Approval By HOD</h2>
                ...
                <tr>
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td width="60%" style="height: 15px">
                                        <asp:DropDownList ID="DropDownList_Leave_Name" runat="server" DataSourceID="SqlDataSource_Leave_Type_Detail" Width="80%"
                                            DataTextField="Leave_Name" DataValueField="Type_Detail_id" AutoPostBack="True" OnSelectedIndexChanged="DropDownList_Leave_Name_SelectedIndexChanged" Enabled="false">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">Leave Category:</td>
                                    <td>
                                        <asp:DropDownList ID="DropDownList_L_Sub_Cat" runat="server"
                                            Width="80%" AutoPostBack="True" Enabled="false">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox Enabled="false" ID="TextBox_Leave_Day" runat="server" Width="80%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="height: 18px">
                                        <asp:TextBox Enabled="false" ID="TextBox_Salary_Day" runat="server" Width="80%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="right">
                                        <asp:SqlDataSource ID="SqlDataSource_Leaves_For_Approval" runat="server" ConnectionString="<%$ ConnectionStrings:Leave_ManagementConnectionString %>"
                                            ...
                                            UpdateCommand="Update_Leave_Request1" UpdateCommandType="StoredProcedure">
                                            <UpdateParameters>
                    ...
                    <td style="width: 33%; vertical-align: top;">
                        <div class="bxmain inner_content">
                            ...
                            <asp:CheckBoxList ID="CheckBoxList_Dates_Of_Leaves" runat="server" AutoPostBack="True" Height="24px" Enabled="false">
                            </asp:CheckBoxList>
                            <br />
    ...
    <asp:SqlDataSource ID="SqlDataSource_Employee_Leaves" runat="server" ConnectionString="<%$ ConnectionStrings:Leave_ManagementConnectionString %>"
        ...
        SelectCommand="SELECT Employee_Leaves.Emp_Leave_Id, Employee_Leaves.Emp_Id,convert(varchar, Employee_Leaves.Start_Date,103) as Start_Date , convert(varchar, Employee_Leaves.End_Date ,103) as End_Date, Employee_Leaves.Leave_Days, Employee_Leaves.Description, Employee_Leaves.Type_Detail_Id, Employee_Leaves.Office_Ins_Id, Leave_Type_Detail.Leave_Name, ISNULL(Employee.EFName, '') + ' ' + ISNULL(Employee.EMName, '') + ' ' + ISNULL(Employee.ELName, '') AS [Employee Name] , case when  Employee_Leaves.is_approved is null then 'Pending' when  Employee_Leaves.is_approved = 0 then 'Rejected' else 'Approved' end as L_Status FROM Employee_Leaves INNER JOIN Leave_Type_Detail ON Employee_Leaves.Type_Detail_Id = Leave_Type_Detail.Type_Detail_id INNER JOIN Employee ON Employee_Leaves.Emp_Id = Employee.EmpID 
where Employee_Leaves.Emp_Id=@Emp_ID"
