<%@ Page Language="VB" AutoEventWireup="false"  MasterPageFile="~/hacims_masterpage_admin.master" CodeFile="Employee_Leaves_Cancel_Request.aspx.vb"
    Inherits="LM_Employee_Leaves_Cancel_Request" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    &nbsp;<div class="bxmain inner_content">
        <h2> Employee Leave Cancel Request</h2>
               ...
               <asp:FormView ID="FormView1" runat="server" DataKeyNames="EmpID" DataSourceID="dsEmployeeInfo"
                ...
                <tr>
                    <td style="width:33%;  vertical-align:top;" >
                        ...
                        <div class="bxmain inner_content" style="display:none">
                            <h2>Approval Authorities</h2>
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="Grid_1" EmptyDataText="No Record Found . . ." Width="98%" Visible="false">
                                <Columns>
                    ...
                    <tr>
                        <td align="right">
                            <asp:SqlDataSource ID="SqlDataSource_Leaves_For_Approval" runat="server" ConnectionString="<%$ ConnectionStrings:Leave_ManagementConnectionString %>"
                                ...
                                UpdateCommand="Usp_ApplyLeaveCancelRequest" UpdateCommandType="StoredProcedure">
                                <UpdateParameters>
                                   <%-- <asp:Parameter Name="Start_Date" Type="DateTime" />
                                    ...
                                    <asp:Parameter Name="is_Approved" Type="Int32" />
                                    <asp:Parameter Name="Emp_Leave_Id" Type="Int32" />
                                    <%--<asp:Parameter Name="Recommend_Id" Type="Decimal" />--%>
                                    <asp:Parameter Name="emp_id" Type="Int32" />
                                   <%-- <asp:Parameter Name="leaveType" Type="Int32" />
                                    <asp:Parameter Name="LeaveEmpSubdeptID" Type="Int32" />
                                    <asp:Parameter Name="LoginEmpSubdeptID" Type="Int32" />
                                    <asp:Parameter Name="LeaveEmpLogApprovalID" Type="Int32" />
                                    <asp:Parameter Name="Leave_Cat_Id" Type="Int32" />
                                    <asp:Parameter Name="Requested_Days" Type="Int32" />--%>
                                    <asp:Parameter Name="data" Type="String" />
                                     <asp:Parameter Name="ApproveStatus" Type="String" />
                                </UpdateParameters>
                            </asp:SqlDataSource>
                        </td>
                        <td>
                    ...
                    <tr>
                                <td align="right">
                                    <asp:SqlDataSource ID="SqlDataSource_Leave_Type_Detail" runat="server" ConnectionString="<%$ ConnectionStrings:Leave_ManagementConnectionString %>"
                                        SelectCommand="Select Leave_Type_Detail.Leave_Name,Leave_Type_Detail.Type_Detail_id,Leave_Types.Leave_Type_Name,ISNULL(Leave_Type_Detail.Salary_Day,1) AS Salary_Day
                                ...
                                <td>
                                    ...
                                    <asp:Button ID="Button_approve" runat="server" Text="Apply" />
                                    <asp:Button ID="ButtonRejected" runat="server" Text="Rejected" Visible="false"/>
                                    <asp:Button Visible="false" ID="btnRefresh" runat="server" OnClick="btnRefresh_Click" Text="Rejected" />
                    ...
                    <td style="width:33%; vertical-align:top; " >
                        <div class="bxmain inner_content" style="display:none"><h2>Employee Cancel Leave Request</h2>
                <asp:GridView ID="GridView2" runat="server" EmptyDataText="No Record Found . . ." AutoGenerateColumns="False" 
                     Width="98%" CssClass="Grid_1" Visible="false">
                    <Columns>                         
                    ...
                    <AlternatingRowStyle CssClass="GridAltItem" />
                        ...
                        <div class="bxmain inner_content">
                            <h2>Select Leave(s) For Cancel</h2>
                            <asp:CheckBoxList ID="CheckBoxList_Dates_Of_Leaves" runat="server" Height="24px">
                            </asp:CheckBoxList>
                            <br />
    ...
    <asp:SqlDataSource ID="SqlDataSource_Employee_Leaves" runat="server" ConnectionString="<%$ ConnectionStrings:Leave_ManagementConnectionString %>"
        ...
        SelectCommand="SELECT Employee_Leaves.Emp_Leave_Id, Employee_Leaves.Emp_Id,convert(varchar, Employee_Leaves.Start_Date,103) as Start_Date ,
 convert(varchar, Employee_Leaves.End_Date ,103) as End_Date, Employee_Leaves.Leave_Days, Employee_Leaves.Description,
  Employee_Leaves.Type_Detail_Id, Employee_Leaves.Office_Ins_Id, Leave_Type_Detail.Leave_Name,
   ISNULL(Employee.EFName, '') + ' ' + ISNULL(Employee.EMName, '') + ' ' + ISNULL(Employee.ELName, '') AS [Employee Name] ,
    case when  Employee_Leaves.is_approved is null then 'Pending' when  Employee_Leaves.is_approved = 0 then 'Rejected' else 'Approved' end as L_Status,
	Convert(varchar,teld.Leave_Date,103) AS LeaveDate,case when ECL.IsApproved is null then 'Pending' else 'Approved' end AS iSApproved,ECL.Remarks
	FROM Employee_Leaves 
	INNER JOIN Leave_Type_Detail ON Employee_Leaves.Type_Detail_Id = Leave_Type_Detail.Type_Detail_id
	INNER JOIN Employee ON Employee_Leaves.Emp_Id = Employee.EmpID
	inner join tbl_Employee_Leave_Detail teld on Employee_Leaves.Emp_Leave_Id = teld.Emp_Leave_id
	inner join EmployeeLeaveCancelLogs ECL on teld.id = ECL.LeaveID AND ApproveStatus = 'HOD'
where Employee_Leaves.Emp_Id=@Emp_ID" UpdateCommand="UPDATE [Employee_Leaves] SET [Emp_Id] = @Emp_Id, [Start_Date] = @Start_Date, [End_Date] = @End_Date, [Leave_Days] = @Leave_Days, [Description] = @Description, [Type_Detail_Id] = @Type_Detail_Id, [Office_Ins_Id] = @Office_Ins_Id WHERE [Emp_Leave_Id] = @Emp_Leave_Id">
    ...
    <div class ="inner_content bxmain">
        <h2>Previous Leaves Cancel History</h2>
    <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" DataKeyNames="Emp_Leave_Id"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="End_Date" HeaderText="End Date" SortExpression="End_Date" />--%>
             <asp:BoundField DataField="LeaveDate" HeaderText="Leave Date" SortExpression="Leave Date" />
            <asp:BoundField DataField="Leave_Days" HeaderText="Leave Days" SortExpression="Leave_Days" />
            <asp:BoundField DataField="Description" HeaderText="Description" SortExpression="Description" />
            <%--<asp:BoundField DataField="L_Status" HeaderText="Leave Status" SortExpression="L_Status" />--%>
            <asp:BoundField DataField="Remarks" HeaderText="Reason" SortExpression="Reason" />
            <asp:BoundField DataField="IsApproved" HeaderText="Leave Status" SortExpression="IsApproved" />
        </Columns>
        <RowStyle CssClass="GridItem" />
        <FooterStyle CssClass="GridPager" />
        <SelectedRowStyle CssClass="gridselect" />
