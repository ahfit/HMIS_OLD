<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/hacims_masterpage_admin.master" CodeFile="EmployeeLeavesRequestStatus.vb"
     Inherits="EmployeeLeavesRequestStatus" EnableEventValidation="false" Theme="theme_hacims" ViewStateEncryptionMode="Never" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="bxmain inner_content " style="width: 100%">
        <h2><span>Employee Leaves Request Status</span></h2>
            ...
            <tr>
                ...
                <td align="right">
                   Status:</td><td align="left"> <asp:DropDownList ID="DDL_Status" runat="server" Width="116px">                        
                        <asp:ListItem Selected="True" Value="2">IN Process</asp:ListItem>
...
<asp:BoundField DataField="EmpID" HeaderText="Emp ID" SortExpression="EmpID" />
            ...
            <asp:BoundField DataField="ApproveBy" HeaderText="Last Approved/Reject By" SortExpression="ApproveBy" />
             <asp:BoundField DataField="ApproveDate" HeaderText="Approve/Reject Date" SortExpression="ApproveDate" />

            <asp:BoundField DataField="NextApproval" HeaderText="Next Pending At" SortExpression="NextApproval" />
