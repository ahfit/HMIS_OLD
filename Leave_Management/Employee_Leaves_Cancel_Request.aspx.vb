...
Partial Class LM_Employee_Leaves_Cancel_Request
    ...
    Private Sub GetDaysList()
        ...
        cmd.Parameters.AddWithValue("@Status", "HOD")
            ...
            While sdr.Read()
                ...
                If CheckBoxList_Dates_Of_Leaves.Items.Count > 0 Then
                    ...
                    If sdr("IsLeaveApplied").ToString() <> "0" Then
                        ...
                        If sdr("IsApproved").ToString() = True Or sdr("LeaveID") Then
    ...
    Private Sub Approve_Reject_leave(status As Boolean)
        ...
        Try
            ...
            SqlDataSource_Leaves_For_Approval.UpdateParameters("ApproveStatus").DefaultValue = "HOD"
