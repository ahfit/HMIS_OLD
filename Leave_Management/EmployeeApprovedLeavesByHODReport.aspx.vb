...
Partial Class Leave_EmployeeApprovedLeavesByHODReport
    ...
    Private Sub ShowReport()
        ...
        Try
            ...
            cmd = New SqlCommand("usp_GetLeavesApprovedByHOD", con)
            ...
            cmd.Parameters.AddWithValue("@SubDeptID", Request.QueryString("SubdeptId"))
            ...
            da.Fill(dt)
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("EmployeeApprovedLeavesByHODReport.rdlc")
