...
Public Class ShowImage
    ...
    Public Function ShowEmpImage(ByVal RegNo As String) As Stream
        Dim conn As String = ConfigurationManager.ConnectionStrings("BasicDataInfoConnectionString").ConnectionString
        Dim connection As SqlConnection = New SqlConnection(conn)
                            
        Dim sql As String = "SELECT Attachment as Picture FROM Hospital WHERE (Hospital_ID = @RegNo)"
