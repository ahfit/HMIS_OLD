...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
     ...
     <%--<script type="text/javascript">
         $(document).ready(function (e) {
             ...
             $("#" + "<%=TextBoxGridDiscount.ClientID%>").on("blur", function () {
                var totalamount = 0;
                $("[id$='GridViewMedicine'] tr.GridItem,tr.GridAltItem").each(function () {



                    var totaldiscount = $("#" + "<%=TextBoxGridDiscount.ClientID%>").val();
                    $(this).find("[id$='txtboxDiscount']").val(totaldiscount);


                    var amount = $(this).find("[id$='TextBox_RetailPrice']").html();
                    var totaldiscountAmount = amount - ((amount * totaldiscount) / 100);
                    if (totaldiscountAmount < 0) {
                        totaldiscountAmount = 0;
                    }
                    $(this).find("[id$='TextBox_RetailPrice']").html(totaldiscountAmount);

                    debugger;
                    totalamount = parseFloat(totalamount.toString()) + parseFloat($(this).find("[id$='TextBox_RetailPrice']").html());
                });
                //$("[id$='GridView1'] tr.GridPager").each(function () {

                //    $(this).find("[id$='LblDisTotalAmount']").html(totalamount);
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="table">
                    ...
                    <tr id="isPatient" runat="server" style="display: contents">
                        ...
                        <td colspan="3">
                          ...
                          <td colspan="3"><div id="divEmployeeLimit" runat="server" style="display:none">
                    ...
                    <table style="width:100%;">
                     ...
                     <td align="right">&nbsp;
                          ...
                          <td> <strong>||</strong> Total Amount :
                            <asp:Label ID="LblTAmount" runat="server" Font-Bold="True" ForeColor="#FF3300"></asp:Label>
                              &nbsp;
                              <asp:HiddenField ID="hdf_LimitId" runat="server" Value="0" />
                          </td>

                          <td>Consumed Amount :<asp:Label ID="LblCAmount" runat="server" Text="" ForeColor="#FF3300"></asp:Label>
                          </td>

                             <td>Remaining Amount :<asp:Label ID="LblRAmount" runat="server" Text="" ForeColor="#FF3300"></asp:Label>
                          </td>
                    </tr>
                    </table>
                </div></td>
        ...
        <td valign="top" width="33%" style="background: url(../images_hacims/img_dots_ver.png) top right repeat-y;">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl_form">
                ...
                <tr id="med" runat="server">
                    ...
                    <td>
                        <asp:TextBox ID="TextBox_specificMedicine" runat="server" CssClass="input_txt" Width="239px" BackColor="#66CCFF" BorderColor="#0066FF" Font-Bold="True" Font-Size="Medium" Height="28px"></asp:TextBox>

                    </td>

                </tr>
                  <asp:AutoCompleteExtender ID="aceItems" runat="server" ServiceMethod="SearchItems"
                                        MinimumPrefixLength="3" CompletionInterval="5" EnableCaching="false" CompletionSetCount="10"
                                        TargetControlID="TextBox_specificMedicine" FirstRowSelected="true"    CompletionListCssClass="AutoExtender" CompletionListItemCssClass="AutoExtenderList" 
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Button ID="Button1" runat="server" Text="Search" Width="80px" />
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Expire Date " SortExpression="exp">
                            ...
                            <ItemTemplate>
                               ...
                               <%-- <asp:TextBox ID="txtexp" runat="server" Text='<%# Bind("exp") %>' TextMode="DateTime" ></asp:TextBox>--%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Qty Issue">
                            <ItemTemplate>
                                <asp:TextBox ID="TextBox_Qty" Visible="true" runat="server" Text='<%# Bind("PQty") %>' CssClass="input_txt" Width="50px"></asp:TextBox>
                                ...
                                <asp:HiddenField ID="HfIsNarcotic" runat="server" Value='<%# Bind("Is_Narcotic") %>' />
                                 <asp:HiddenField ID="hdfexp" runat="server" Value='<%# Bind("exp") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Discount" >
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtboxDiscount" TextMode="Number" onblur="discountfunction()" onkeyup="discountfunction()"  min="0" max="50" MaxLength="2" runat="server" Text='<%# Bind("discount")%>' Width="50px" ReadOnly="true"></asp:TextBox>
...
GROUP BY ISNULL(Batch_No, 'Nil')"
            ...
            <div align="center">
                ...
                <%--</ContentTemplate></asp:UpdatePanel>--%>
                 <asp:Button ID="Btn_Bill" runat="server" Text="Add to Bill"
                    ...
                    <asp:Button ID="Button_Consumption" runat="server" Text="Issue" AutoPostBack="True"
                 ...
                 <asp:Button ID="btn_CreditPayment" runat="server" Text="Credit Payment"
                     Enabled="true" Visible="true" />
                        ...
                        <strong>Flat Discount(%) :</strong>
                        <asp:TextBox ID="TextBoxGridDiscount" SkinID="number" runat="server" Width="150px" Text="0" OnTextChanged="TextBoxGridDiscount_TextChanged" AutoPostBack="true"></asp:TextBox>
       ...
       <asp:Panel ID="pnladditions" visible="false" runat="server">
       <fieldset>
  <legend>Additions:</legend>
       ...
       <table style="width:100%" >
        ...
        Subtract : 
               ...
               <td>
                   <asp:TextBox ID="txtSubtract" runat="server" Width="100px" textmode="number" AutoPostBack="true" min="0" max="500">0</asp:TextBox>
               </td>
               <td>
       Addition : 
                   </td>
               <td>
                   <asp:TextBox ID="txtAddition"   Width="100px" textmode="number" runat="server" AutoPostBack="true" min="0" max="10">0</asp:TextBox>
               </td>
               </tr>
           <tr  >
               <td>
        Total Bill : 
               ...
               <td>
                   <asp:Label ID="lblBillTotalAmount" runat="server" Text="0">0</asp:Label>
               </td>
               </tr>
           <tr>
               <td>
               ...
               <td>
                   <asp:TextBox ID="txtCashReceived" Width="100px" runat="server" AutoPostBack="true" textmode="number" min="0" >0</asp:TextBox>
               </td>
               </tr>
           <tr> 
               <td>
        Remaning Cash : 
               ...
               <td>
                   <asp:Label ID="lblGreatGrandTotal" runat="server">0</asp:Label>
               </td>
               </tr>
           <tr>
               <td>&nbsp;</td>
