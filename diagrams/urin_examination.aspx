<%@ page language="VB" autoeventwireup="false" inherits="urin_examination, App_Web_ntfdmjyx" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
<body>
    ...
    <div>
        ...
        <asp:HiddenField ID="HiddenField_DiagramID" runat="server" Value="2" />
    </div>
    </form>
</body>
</html>
