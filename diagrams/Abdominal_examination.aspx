<%@ page language="VB" autoeventwireup="false" inherits="diagrams_Abdominal_examination, App_Web_ntfdmjyx" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
<body>
    ...
    <div>
        ...
        <asp:HiddenField ID="HiddenField_DiagramID" runat="server" Value="1" />
        <br />
