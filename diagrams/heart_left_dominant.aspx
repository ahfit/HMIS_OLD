<%@ page language="VB" autoeventwireup="false" inherits="heartleft_dominant, App_Web_ntfdmjyx" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
<body>
    ...
    <div>
        ...
        <asp:HiddenField ID="HiddenField_DiagramID" runat="server" Value="3" />
        <br />
