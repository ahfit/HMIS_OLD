<%@ page language="VB" autoeventwireup="false" inherits="heart_right_dominant, App_Web_ntfdmjyx" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
<body>
    ...
    <div>
        ...
        &nbsp;&nbsp;<asp:SqlDataSource ID="SqlDataSource_insert_dermatomes" runat="server"
            ConnectionString="<%$ ConnectionStrings:TreatmentConnectionString %>" InsertCommand="dermatomes_insert"
        ...
        <asp:HiddenField ID="HiddenField_DiagramID" runat="server" Value="4" />
        <br />
