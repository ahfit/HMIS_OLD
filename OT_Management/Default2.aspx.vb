...
Partial Class Default2
    ...
    Sub MAin_Function()
        ...
        For i As Integer = 0 To ds.Tables("Days").Rows.Count - 1
            ...
            Next
        Next
        GridView1.DataSource = ds.Tables("days")
        GridView1.DataBind()
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        'Dim row As TableRow = Table1.FindControl("row1")
        Dim tbl As TableCell = Table1.FindControl("cell2") ' row.FindControl("cell1")
        tbl.BackColor = Drawing.Color.Pink
    End Sub
End Class
