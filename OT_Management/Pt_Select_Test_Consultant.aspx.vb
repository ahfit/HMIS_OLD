...
Partial Class Pt_Select_Test_Consultant
    ...
    Public strHiddenFieldTBID_val As String
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button_Save.Click
        Try
            ...
            End If
            Button_Save.CssClass = "btn_hacims_change"
            Button_Save.Text = "Data Saved"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Button_Save.CssClass = "btn_hacims"
    ...
    Sub Phy_Elements_Values(ByVal e_code As Integer, ByVal e_name As String, ByVal e_field As String, ByVal e_id As String, ByVal MG_Code As Integer, ByVal Already_Save_Values As DataSet, ByVal Tooltip As String, ByVal Range_Value As String, ByVal main_id As Integer, ByVal Max_Length As Integer)
        Try
            Dim a As String = ConfigurationManager.ConnectionStrings("Admin_OT_ConnectionString").ConnectionString
            Dim con As SqlConnection = New SqlConnection(a)
    ...
    '    con.Close()
    'End Sub
    Sub InsertMain(ByVal Max_Main_Id As String)
        Try
            Dim a As String = ConfigurationManager.ConnectionStrings("OT_ManagementConnectionString").ConnectionString
    ...
    Function Check_Insert(ByVal TB_ID As String) As Boolean
    ...
    Protected Sub ButtonFinal_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonFinal.Click
        Try
            ...
            Try
                If Not (Session("PatientMobilephone") Is Nothing) Then
                    If Session("PatientMobilephone").ToString().Length() > 5 Then
                        'Response.Write(Session("PatientMobilephone"))
                        Session("PatientInfo") = Session("PatientInfo") + "Your report (" + DropDownList_TestName.SelectedItem.Text + ") is ready. Please collect from radiology department."
                        Dim dt As DataTable = Session("Header_DT")
                        'Session("PatientInfo") = Session("PatientInfo") + dt.Rows(0)("Hospital_Name").ToString() + " " + dt.Rows(0)("TehsilName").ToString() + " Phone:" + dt.Rows(0)("Hospital_Phone").ToString()
                        Session("PatientInfo") = dt.Rows(0)("Hospital_Name").ToString() + " " + dt.Rows(0)("TehsilName").ToString() + " (Phone:" + dt.Rows(0)("Hospital_Phone").ToString() + ") " + Session("PatientInfo")

                        SqlDataSourceUpdate.Insert()
    ...
    Protected Sub LinkButton_Show_Report_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LinkButton_Show_Report.Click
        ...
        Response.Redirect("Patient_Result_Report.aspx?RegNo=" + Session("RegistrationNo") + "&YearlyNo=" + Session("YearlyNo") + "&TGID=" + HiddenField_MS_TGID.Value + "&Main_ID=" + Request.QueryString("Main_ID") + "&TB_ID=" + HiddenField_TBID.Value)
    End Sub
    ...
    Protected Sub DropDownList_TestName_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownList_TestName.DataBound
        If DropDownList_TestName.SelectedItem IsNot Nothing Then
    ...
    Protected Sub Search(ByVal Mr_No As String, ByVal Visit_No As String, ByVal Sample_No As String)
        ...
        Dim command As New SqlCommand
        Dim reader As SqlDataReader
        connection.ConnectionString = ConfigurationManager.ConnectionStrings("OT_ManagementConnectionString").ConnectionString
        command = connection.CreateCommand
    ...
    Protected Sub DataList1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataList1.SelectedIndexChanged
        ...
        strHiddenFieldTBID_val = "<a href=Administrator/search-test-template.aspx?ID=" & HiddenField_TBID.Value.ToString() & ">Edit templates</a>"
    ...
    Protected Sub ListBox_Radiology_templates_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListBox_Radiology_templates.SelectedIndexChanged
        ...
        Try
            ...
            TextBox_Description.text = TextBox_Description.text + ListBox_Radiology_templates.SelectedValue
    ...
    Protected Sub print_report_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles print_report.Click
        Response.Redirect("Radiology_Para_Report.aspx?RegNo=" + Session("RegistrationNo") + "&YearlyNo=" + Session("YearlyNo") + "&TB_ID=" + HiddenField_TBID.Value + "&Main_ID=" + Request.QueryString("Main_ID") + "&tittle=" + DropDownList_TestName.SelectedItem.Text)
    End Sub
    ...
    Protected Sub LinkButton_AppDate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LinkButton_AppDate.Click
