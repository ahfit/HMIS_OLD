<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HospitalPatientSearch.aspx.vb" Inherits="HospitalPatientSearch"  MasterPageFile="~/hacims_masterpage_admin.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <asp:Label ID="Label_Header" runat="server" CssClass="err" ></asp:Label>
  <asp:Label ID="Label_message" runat="server" CssClass="err"></asp:Label>

 

            <asp:Panel ID="Panel2" runat="server"  Width="100%" Visible="False"></asp:Panel>
            <br />
<div align="center"><asp:Button ID="Button1" runat="server" Text="Search" CssClass="btn1" Visible="False" />&nbsp;</div>
