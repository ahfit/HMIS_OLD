<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="DoctorAssesment.aspx.cs" Inherits="OT_Management_DoctorAssesment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="text-align: center">
        <h2 class="title" id="heading" runat="server">Patient Assesment (Doctor)</h2>
    </div>
