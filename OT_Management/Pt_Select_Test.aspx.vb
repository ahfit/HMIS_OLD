...
Partial Class Pt_Select_Test1
    ...
    Dim str_RegNo_SampleNo As String = ""
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            'Session.Add("Sample_No", Request.QueryString("sample_No"))
            HiddenField_SystemIP.Value = Request.ServerVariables("Remote_Addr")
        ...
        Try
            DropDownList_Patients.SelectedItem.Text = Request.QueryString("sample_No").ToString
        Catch ex As Exception

        End Try

        'If Page.IsPostBack = True Then
        '    If str_RegNo_SampleNo = "" Then
        '        str_RegNo_SampleNo = ""
        '    Else
        '        DropDownList_Patients.SelectedValue = str_RegNo_SampleNo
        '    End If
        'End If
    ...
    Protected Sub ButtonFinal_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonFinal.Click
        ...
        End Try
        DropDownList_Patients.DataBind()
    ...
    Protected Sub Button_Sesch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button_Sesch.Click
        Dim strRegNo, strSampleNo, str, strYearlyNo, strMainId As String

        Dim x, y, z As Integer
        str = DropDownList_Patients.SelectedValue
        str_RegNo_SampleNo = str
        'Response.Write(str)
        x = InStr(str, "REG", CompareMethod.Text)
        strSampleNo = Left(str, x - 1)
        str = Right(str, Len(str) - (x + 2))
        y = InStr(str, "YearlyNo", CompareMethod.Text)
        strRegNo = Left(str, y - 1)

        str = Right(str, Len(str) - (y + 7))
        z = InStr(str, "MainId", CompareMethod.Text)
        strYearlyNo = Left(str, z - 1)


        strMainId = Right(str, Len(str) - (z + 5))


        Response.Redirect("pt_select_test.aspx?Reg_No=" + strRegNo + "&YearlyNo=" + strYearlyNo + "&Main_ID=" + strMainId + "&sample_No=" + strSampleNo + "&status=1", True)


        'Dim strRegNo, strSampleNo, str As String
        'Dim YearlyNo As Long
        'Dim x, y As Integer
        'str = DropDownList_Patients.SelectedValue
        'x = InStr("REG", str, CompareMethod.Text)
        'strRegNo = Left(str, x)
        ''Response.Write(str)
        'Response.Write(strRegNo)
    ...
    Protected Sub DropDownList_Patients_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownList_Patients.SelectedIndexChanged
        ...
        'Response.Redirect("pt_select_test.aspx?Reg_No=" + strRegNo + "&YearlyNo=" + strYearlyNo + "&Main_ID=" + strMainId + "&sample_No=" + strSampleNo + "&status=1")
