...
Partial Class Patient_Search
    ...
    Sub search1(ByVal indx As Integer)
        Try
            ...
            store_procedure = "Search_hospital_Pt_Room_Bed_Wise"
    ...
    Sub Grid_Col(ByVal BTN_TXT As String, ByVal CMD As String, ByVal NextPage As String)
        For i As Integer = 0 To GridView2.Rows.Count - 1
            ...
            lnk_btn.PostBackUrl = NextPage + "?Reg_No=" + GridView2.Rows(i).Cells(2).Text + "&YearlyNo=" + GridView2.Rows(i).Cells(15).Text + "&Main_ID=" + GridView2.Rows(i).Cells(14).Text + "&status_ID=" + DropDownList_Status.SelectedValue
    ...
    Function search_Patient_New_new(ByVal pnl As Panel, ByVal procedure As String, ByVal constr As String, ByVal subdeptid As Integer) As Collection
        ...
        param = mycommand.Parameters.AddWithValue("@Ward_id", DropDownList_Ward.SelectedValue)
        param = mycommand.Parameters.AddWithValue("@Bed_id", DropDownList_Bed.SelectedValue)

        If procedure = "Search_hospital_Pt_Room_Bed_Wise" Then
