...
Partial Class Delivery_Reception
    ...
    Sub search1(ByVal a As Integer)
        Try
            ...
            Procedure_Name = "Search_Emg_Dept_Patient_Pathalogy_Deliver"
    ...
    Protected Sub GridView2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView2.SelectedIndexChanged
        Try
            ...
            ' If Session("Procedure_Path") = 0 Then
            Response.Redirect("Report_reciver.aspx?YearlyNo=" & Record_ID & "&RegNo=" & PIN_No & "&cmo=cmo")
            'ElseIf Session("Procedure_Path") = 1 Then
