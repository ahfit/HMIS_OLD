...
Partial Class Admin_General_Examination_Languages
    ...
    Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles GridView1.RowUpdating
        ...
        HiddenField_GroupPara.Value = GridView1.Rows(e.RowIndex).Cells(7).Text.ToString
        HiddenField_ReportSubGroup.Value = GridView1.Rows(e.RowIndex).Cells(8).Text.ToString
