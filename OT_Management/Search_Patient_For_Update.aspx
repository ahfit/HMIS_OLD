<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Search_Patient_For_Update.aspx.vb"  MasterPageFile="~/hacims_masterpage_admin.master" Inherits="Pathology_Search_Patient_For_Update" %>
              ...
              <asp:GridView ID="GridView2" runat="server" AllowPaging="True" CssClass="Grid_1"
                ...
                <AlternatingRowStyle CssClass="GridAltItem" />
                  <Columns>
                      ...
                      <asp:ButtonField CommandName="Test" Text="Test" />
                  </Columns>
                  </asp:GridView>
<br />
