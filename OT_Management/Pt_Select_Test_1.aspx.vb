...
Partial Class Pt_Select_Test_1
    ...
    Dim contols_name() As String
    Dim focus_flag As String
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button_Save.Click
        Try
            ...
            InsertMain(HiddenFieldMainID.Value, HiddenField_TBID.Value)
            Check_Controls()
    ...
    Protected Sub DataListMainGroup_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataListMainGroup.SelectedIndexChanged
        ...
        'Response.Write(hid_main_group.Value & "fdssf")
        ...
        Phy_Elements(DataListMainGroup.SelectedValue, 38, dss, HiddenFieldMainID.Value, HiddenField_TBID.Value)
    ...
    Sub Check_For_Table_Rows(ByVal MG_Code As Integer, ByVal i As Integer, ByVal j As Integer, ByVal ds As DataSet, ByVal Already_Save_Values As DataSet, ByVal main_id As Integer, ByVal TB_ID As Integer)
        ...
        End Try
    End Sub
    Sub Phy_Elements_Values(ByVal e_code As Integer, ByVal e_name As String, ByVal e_field As String, ByVal e_id As String, ByVal MG_Code As Integer, ByVal Already_Save_Values As DataSet, ByVal Tooltip As String, ByVal Range_Value As String, ByVal main_id As Integer, ByVal Max_Length As Integer, ByVal TB_ID As Integer, ByVal height As String, ByVal width As String)
        Try
            ...
            Next
            'End If
            Make_Control(ds1, e_id, e_name, MG_Code, e_field, Save_Record_Color, Already_Save_Values, e_code, Tooltip, Range_Value, main_id, Test_Date_Time, TB_ID, height, width)

        Catch ex As Exception
            Response.Write(ex.Message)
        End Try
    End Sub
    Sub Make_TextBox(ByVal E_Id As String, ByVal Already_Save_Values As DataSet, ByVal E_Code As Integer, ByVal Tooltip As String, ByVal Range_value As String, ByVal main_id As Integer, ByVal TB_ID As Integer, ByVal height As String, ByVal width As String)
    ...
    Sub Draw_web(ByVal E_Id As String, ByVal Already_Save_Values As DataSet, ByVal E_Code As Integer, ByVal Tooltip As String, ByVal Range_value As String, ByVal main_id As Integer, ByVal TB_ID As Integer, ByVal height As String, ByVal width As String)

        'Dim webdate As New Infragistics.WebUI.WebSchedule.WebDateChooser
        'webdate.ID = id1
        'webdate.Value = Date.Now
        'webdate.Width = width1
        'p3.Controls.Add(webdate)
            ...
            For count1 As Integer = 0 To count_total
                ...
                Else
                    Try
                        ...
                        ' Response.Write(control.Toolbar.Items(flag).type.ToString + " ")
        ...
        If dds.Tables(0).Rows.Count <> 0 Then
            control.Text = dds.Tables(0).Rows(0).Item(1).ToString.Trim
        End If
        ' control.Attributes.Add("onchange", "return CheckRequiredField('" + "web" & E_Id + "','" + HiddenField_TBID.Value + "')")
        'control.CssClass = "text_titles_01"
        Panel1.Controls.Add(control)
        'Label_For_Range_Values(Range_value)
    ...
    Sub Make_Control(ByVal ds As DataSet, ByVal e_id As String, ByVal e_name As String, ByVal Mg_code As Integer, ByVal e_field As String, ByVal Save_Record_Color As String, ByVal Already_Save_Values As DataSet, ByVal E_Code As Integer, ByVal Tooltip As String, ByVal Range_value As String, ByVal main_id As Integer, ByVal Test_Date_Time As String, ByVal TB_ID As Integer, ByVal height As String, ByVal width As String)
        Try
            Label_For_Table("<td width ='10%' bgcolor='" & Save_Record_Color & "' class='text_titles_01'>")
            Make_Label(e_id, e_name, Mg_code, Already_Save_Values, Tooltip, height, width)
            Label_For_Table("</td>")
            If e_field = "TextBox" Then
                Label_For_Table("<td width='80%' bgcolor='" & Save_Record_Color & "' class='text_titles_01' style='text-align:right;'>" & Test_Date_Time)
                Make_TextBox(e_id, Already_Save_Values, E_Code, Tooltip, Range_value, main_id, 100, TB_ID, height, width)
                Label_For_Table("</td>")
            ElseIf e_field.ToLower = "html" Then
                Label_For_Table("<td width='80%' bgcolor='" & Save_Record_Color & "' class='text_titles_01' style='text-align:left;'>" & Test_Date_Time)
                Draw_web(e_id, Already_Save_Values, E_Code, Tooltip, Range_value, main_id, TB_ID, height, width)
                Label_For_Table("</td>")
            ...
            ElseIf e_field = "DropDownList" Then
                ...
                Next
                Make_DropDownList(ArrayList_RadioButtonList, e_id, Mg_code, Already_Save_Values, E_Code, Tooltip, Range_value, main_id, TB_ID, height, width)
            ...
            ElseIf e_field = "RadioButtonList" Then
                ...
                For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                    ...
                    ArrayList_RadioButtonList_ID.Add(ds.Tables(0).Rows(i).Item(0).ToString)
                Next
                Make_RadioButtonList(ArrayList_RadioButtonList, e_id, Mg_code, Already_Save_Values, Tooltip, Range_value, TB_ID, height, width)
                ArrayList_RadioButtonList.Clear()
                Label_For_Table("</td>")
            ElseIf e_field = "CheckBoxList" Then
                ...
                For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                    ...
                    ArrayList_RadioButtonList_ID.Add(ds.Tables(0).Rows(i).Item(0).ToString)
                Next
                Make_CheckBoxLIst(ArrayList_RadioButtonList, e_id, Mg_code, Already_Save_Values, Tooltip, Range_value, TB_ID, height, width)
                ArrayList_RadioButtonList.Clear()
                Label_For_Table("</td>")
            End If
        Catch ex As Exception
        ...
        End Try
    End Sub
    Sub Make_Label(ByVal e_id As String, ByVal e_name As String, ByVal MG_Code As Integer, ByVal Already_Save_Values As DataSet, ByVal Tooltip As String, ByVal height As String, ByVal width As String)
        Try
        ...
        End Try
    End Sub
    Sub Make_TextBox(ByVal E_Id As String, ByVal Already_Save_Values As DataSet, ByVal E_Code As Integer, ByVal Tooltip As String, ByVal Range_value As String, ByVal main_id As Integer, ByVal Max_Length As Integer, ByVal TB_ID As Integer, ByVal height As String, ByVal width As String)
        Dim control As New TextBox
        control.ID = "TextBox" & E_Id
        control.EnableViewState = True
        control.Width = 786
        ...
        Label_For_Range_Values(Range_value)
    End Sub
    Sub Make_DropDownList(ByVal ArrayList_Radio As ArrayList, ByVal E_Id As String, ByVal MG_Code As Integer, ByVal Already_Save_Values As DataSet, ByVal E_Code As Integer, ByVal Tooltip As String, ByVal Range_value As String, ByVal main_id As Integer, ByVal TB_ID As Integer, ByVal height As String, ByVal width As String)
        ...
        Label_For_Range_Values(Range_value)
    End Sub
    Sub Make_RadioButtonList(ByVal ArrayList_Radio As ArrayList, ByVal E_Id As String, ByVal MG_Code As Integer, ByVal Already_Save_Values As DataSet, ByVal Tooltip As String, ByVal Range_value As String, ByVal TB_ID As Integer, ByVal height As String, ByVal width As String)
        ...
        Label_For_Range_Values(Range_value)
    End Sub
    Sub Make_CheckBoxLIst(ByVal ArrayList_Radio As ArrayList, ByVal E_Id As String, ByVal MG_Code As Integer, ByVal Already_Save_Values As DataSet, ByVal Tooltip As String, ByVal Range_value As String, ByVal TB_ID As Integer, ByVal height As String, ByVal width As String)
    ...
    Sub Label_For_Range_Values(ByVal Value As String)
        Dim Lbl As New Label
        If Value <> "" Then
            Lbl.Text = "<td style='text-align:right; '>" & Value & "</td>"
        Else
    ...
    '    con.Close()
    'End Sub
    Sub InsertMain(ByVal Max_Main_Id As Integer, ByVal TBID As Integer)
        Try
            Dim a As String = ConfigurationManager.ConnectionStrings("OT_ManagementConnectionString").ConnectionString
            ...
            mycommand.Parameters.AddWithValue("@TB_ID", TBID)
            ...
            For i As Integer = 0 To Panel1.Controls.Count - 1
                ...
                ElseIf Panel1.Controls(i).GetType().ToString.Contains("DropDownList") = True Then
                    ...
                    For j As Integer = 0 To DDL.Items.Count - 1
                        ...
                        End If
                    Next
                ElseIf Panel1.Controls(i).GetType().ToString.Contains("WebHtmlEditor") = True Then

                    Dim txt As Infragistics.WebUI.WebHtmlEditor.WebHtmlEditor = Panel1.FindControl(Panel1.Controls(i).ID.ToString)
                    ' For j As Integer = 0 To txt.Items.Count - 1
                    'If DDL.Items(j).Selected = True And DDL.Items(j).Text <> "" Then
                    InsertTest(txt.Text, Mid(Panel1.Controls(i).ID.ToString, 14), 0)
                    'Dim val As String = Mid(Panel1.Controls(i).ID.ToString, 14)
                    'Response.Write("    " & val)
                    ' End If
                    ' Next
    ...
    Protected Sub GridView_Test_Status_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView_Test_Status.SelectedIndexChanged
        Try
            ...
            Session.Add("RSGID", GridView_Test_Status.SelectedValue)
            Image(Convert.ToInt32(HiddenField_new_TGID.Value))
        Catch ex As Exception
        ...
        Phy_Elements(HiddenField_MS_TGID.Value, 3, dss, HiddenFieldMainID.Value, HiddenField_TBID.Value)
    ...
    Protected Sub ListBox_Radiology_templates_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListBox_Radiology_templates.SelectedIndexChanged
        '  Dim txt As 
        Dim pre_index As Int32

        Try

            Panel3.Visible = True
            WebHtmlEditor1.Text = ListBox_Radiology_templates.SelectedValue
            'For count As Integer = 0 To Panel1.Controls.Count - 1



            '    If Panel1.Controls(count).GetType().ToString.Contains("WebHtmlEditor") Then


            '        Dim txt As Infragistics.WebUI.WebHtmlEditor.WebHtmlEditor = Panel1.FindControl(Panel1.Controls(count).ID.ToString)

            '        If Session("focus_flag") = count Then
            '            Response.Write(count)
            '            Dim foc_txt As Infragistics.WebUI.WebHtmlEditor.WebHtmlEditor = Panel1.FindControl(Panel1.Controls(count).ID.ToString)
            '            foc_txt.Text = foc_txt.Text + ListBox_Radiology_templates.SelectedValue
            '            Exit For
            ...
            '    ' Response.Write(Panel1.Controls.Item(count))
            '            Next
        Catch ex As Exception
    ...
    Protected Sub ListBox_Radiology_templates_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListBox_Radiology_templates.DataBound
        'For count As Integer = 0 To Panel1.Controls.Count - 1
    ...
    Protected Sub Panel1_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Panel1.Disposed
        'For count As Integer = 0 To Panel1.Controls.Count - 1
    ...
    Protected Sub Button_close_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button_close.Click
