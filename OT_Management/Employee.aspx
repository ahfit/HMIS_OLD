...
<title>Services Hospital, Lahore(DMC) </title>
...
<table width="1003" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        <td width="20" valign="top" style="height: 32px"><!--DWLayoutEmptyCell-->&nbsp;</td>
            <td width="937" valign="middle" class="text_heading_02" style="height: 32px">Employee Record </td>
          </tr>
            ...
            <td height="453" colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td height="448" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td width="50" height="99">&nbsp;</td>
                        <td width="824" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0"  >
                          <!--DWLayoutTable-->
                          <tr>
                          ...
                          <tr>
                            <td height="30" align="right" valign="middle"><span  style="width: 164px">First Name :&nbsp;</span></td>
                              <td width="175" valign="middle"><span style="width: 329px">
                                <asp:TextBox ID="txtEFName" runat="server"  Width="146px"  ></asp:TextBox>
                              </span></td>
                              <td width="139" align="right" valign="middle"><span  style="width: 164px; height: 11px">Middle Name  :&nbsp;</span></td>
                              <td width="175" valign="middle"><span style="height: 25px; width: 329px;">
                                <asp:TextBox ID="txtEMName" runat="server"  Width="146px"  ></asp:TextBox>
                              </span></td>
                            <td width="194" valign="middle"><span style="vertical-align: top; text-align: left">
                ...
                Display="Dynamic" ErrorMessage="Please Enter First Name" ID="RequiredFieldValidatorPFName" runat="server"></asp:RequiredFieldValidator>
                          ...
                          <tr>
                            <td height="30" align="right" valign="middle"><span  style="width: 164px">Last Name :&nbsp;</span></td>
                              ...
                              <td valign="middle"><span style="width: 329px">
                                <asp:DropDownList  DataTextField="SexDescription"
                        DataValueField="SexID" ID="Dropdownlistsex" runat="server" Width="100px" DataSourceID="SqlDataSourceGender"> </asp:DropDownList>
                              </span></td>
...
<asp:TextBox ID="txtyear" runat="server"
                        ...
                        <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0"  >
                          ...
                          <tr>
                            <td width="139" height="33" align="right" valign="middle"><span  style="width: 164px">Designation  :&nbsp;</span></td>
                              <td width="175" valign="middle"><span style="width: 329px">
                                <asp:DropDownList 
                        DataTextField="Designation_Name" DataValueField="Designation_ID" ID="DropDownListdesignation" runat="server" Width="175px" DataSourceID="SqlDataSourceDesignation" TabIndex="4"> </asp:DropDownList>
                              </span></td>
                ...
                ValidationExpression="\d{7}" SetFocusOnError="True"></asp:RegularExpressionValidator>
                      ...
                      <tr>
                        <td height="72">&nbsp;</td>
                        <td colspan="2" valign="top"><asp:SqlDataSource ID="SqlDataSourceDesignation" runat="server" ConnectionString="<%$ ConnectionStrings:LGHConnectionString %>"
                        ProviderName="<%$ ConnectionStrings:LGHConnectionString.ProviderName %>" SelectCommand="SELECT [Designation_Name], [Designation_ID] FROM [Designation]"> </asp:SqlDataSource>
                          <asp:SqlDataSource ID="SqlDataSourceGender" runat="server" ConnectionString="<%$ ConnectionStrings:LGHConnectionString %>"
                        SelectCommand="SELECT [SexDescription], [SexID] FROM [PatientSex]"></asp:SqlDataSource>
                        ...
                        ProviderName="<%$ ConnectionStrings:LGHConnectionString.ProviderName %>" InsertCommandType="StoredProcedure" SelectCommand="select * from employee">
                            <InsertParameters>
                    ...
                    SelectCommand="SELECT [SubDept_Id], [SubDept_Name] FROM [SubDepartment] WHERE ([Dept_Id] = @DeptId)">
                          ...
                          <asp:SqlDataSource ID="SqlDataSourceProfession" runat="server" ConnectionString="<%$ ConnectionStrings:LGHConnectionString %>"
                    ProviderName="<%$ ConnectionStrings:LGHConnectionString.ProviderName %>" SelectCommand="SELECT Profession_Name, Profession_Code FROM Admin_Employee_Profession"> </asp:SqlDataSource>
                          <span style="height: 30px">
                          <asp:ImageButton ID="ImageButtonhome" ImageUrl="images/image_bt_home.gif" Width="64" Height="30" runat="server" Visible="false" />                                                  </span><span style="height: 30px">
