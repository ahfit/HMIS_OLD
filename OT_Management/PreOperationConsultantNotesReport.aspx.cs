    ...
    protected void bindReport()
    {
        try
        {
            ...
            SqlParameter[] sqlParam = { 
                                          new SqlParameter("@OrderId",Convert.ToString(Request.QueryString["Order_Id"])),
            ...
            dt = dbMgr.ExecuteDataTable("Select_PreOperatioConsultantRecommendedNotesReport", "TreatmentConnectionString", sqlParam);
