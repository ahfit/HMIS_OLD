<%@ page language="VB" autoeventwireup="false" masterpagefile="~/hacims_masterpage_admin.master" CodeFile="~/OT_Management/PatientSearchOT_IPD.aspx.vb" inherits="OT_Management_patientsearchOT_IPD"%>
...
<asp:GridView ID="GridViewSearch" runat="server" AllowPaging="True"
              ...
              <Columns>
                  ...
                  <asp:ButtonField CommandName="Cencel" Text="Medicine"  />
                  <asp:ButtonField CommandName="Editrecord" Text="Edit" Visible="False" />
                  <asp:ButtonField CommandName="View" Text="Add Limit" Visible="False" />
                  ...
                  <asp:BoundField DataField="CNIC" HeaderText="CNIC" SortExpression="CNIC"/>
                   <asp:BoundField DataField="Patient_type" HeaderText="Patient Category" SortExpression="Patient_type"/>
