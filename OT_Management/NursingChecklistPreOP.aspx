<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="NursingChecklistPreOP.aspx.cs" Inherits="OT_Management_NursingChecklistPreOP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="text-align: center">
        <h2 class="title" id="heading" runat="server">Nursing Pr-OP Checklist</h2>
    </div>
