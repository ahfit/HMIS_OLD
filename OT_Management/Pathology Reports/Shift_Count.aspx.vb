...
Partial Class Pathology_Reports_Shift_Count
    ...
    Protected Sub GridView2_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView2.PreRender
        Dim cf As New HyperLinkField
        Dim st() As String = {"Days"}
        cf.HeaderText = "Template"
        cf.DataTextField = "Days"
        cf.DataNavigateUrlFields = st
        cf.DataNavigateUrlFormatString = "abc.aspx?TGName={0}"
