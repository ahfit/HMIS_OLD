<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Today_Patient_Report.aspx.vb"  MasterPageFile="~/hacims_masterpage_admin.master" Inherits="Pathology_Reports_Today_Patient_Report" %>
...
<table cellpadding="0" cellspacing="0" class="tbl_form" width="100%" >
      ...
      <tr>
        ...
        <td ><asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" RepeatColumns="3"
