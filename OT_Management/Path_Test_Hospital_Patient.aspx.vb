...
Partial Class Path_Test_Hospital_Patient
    ...
    Protected Sub GridGorSubGroup_SelectedIndexChanged1(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridGorSubGroup.SelectedIndexChanged
    ...
    Sub Main_Group()
        Try
            ...
            'Response.Write(Session("YearlyNo") & "  hkjhkjhjkhjk   " & Session("RegistrationNo"))
