<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Pathology_Test_Fee_Payment.aspx.vb" Inherits="Pathology_Test_Fee_Payment" %>
...
<table width="50%" border="0" cellspacing="0" cellpadding="0" class="form_table" align="center">
  <tr>
    <td align="right">Total Price :</td>
    <td><asp:TextBox ID="TextBox_Total_Price" runat="server" ReadOnly="true" BorderWidth="0px" style="color:#990000; font-size:12px; font-weight:bold; font-family:tahoma;"  
                    BorderStyle="None"  ></asp:TextBox>     </td>
  </tr>
  <tr>
    <td align="right">Grand Discount :</td>
    <td> <asp:TextBox AutoPostBack="True" ID="TextBox_Grand_discount" runat ="server" CssClass="input_txt" Width="50px" >0</asp:TextBox>
  ...
  <tr>
    ...
    <td> <asp:TextBox ID="TextBox_Grand_total" ReadOnly="True" 
                    runat="server"  BorderStyle="None" BorderWidth="0px" style="color:#006600; font-size:12px; font-weight:bold; font-family:tahoma;" 
                    ></asp:TextBox></td>
  </tr>
</table>
...
<div align="center"> <asp:Button ID="ButtonSave" runat="server" Text="Save" UseSubmitBehavior="False" cssclass="btn1"  /></div>
