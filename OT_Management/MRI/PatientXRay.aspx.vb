...
Imports System.Data
Partial Class Administrator_PatientXRay
    ...
    Protected Sub GridView4_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView4.SelectedIndexChanged
        ...
        Response.Redirect("Ptxrayinsert.aspx?Xray_ID=" + GridView4.SelectedValue.ToString + "&payId=" + Request.QueryString(0) + "&reg_no=" + Request.QueryString(1))
    End Sub
