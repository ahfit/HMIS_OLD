...
Partial Class PT_ASSIGN_RADIOLOGY_TESTS
    ...
    Sub checkTests(ByVal checkbox As CheckBoxList)
        Try
            ...
            Dim mycommand1 As New System.Data.SqlClient.SqlCommand("SELECT [RID] FROM [Pt_Radiology_LabTest] Where ((PayID = " & Session("YearlyNo") & ") and (RegNo = @RegNo) and (Status = 'Not Done'))", con1)
        ...
        Try
            ...
            For b = 0 To checkboxlist.Items.Count - 1
                If checkboxlist.Items(b).Selected = True Then
                    ...
                    param = mycommand.Parameters.AddWithValue("@RSGID", 37) 'DataListRadiology.SelectedValue)
                    Try
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        'Dim Assign_Time As DateTime = 
        HiddenField_Appointment_Date.Value = WebDateChooser1.Text
        HiddenFieldAppointment_Time.Value = DropDownList_Hr.SelectedValue & ":" & DropDownList_MIn.SelectedValue 'WebDateTimeEdit1.Text
        ...
        Checkboxlistcheck_Medicine(CheckBoxList1)
        ...
        'Response.Redirect("MRI_Test_Medicine.aspx")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        TextBox_next_Date.Attributes.Add("onBlur", "return Validate()")
        Try
            Dim a As String = ConfigurationManager.ConnectionStrings("LGHConnectionString").ConnectionString
            Dim con As SqlConnection = New System.Data.SqlClient.SqlConnection(a)
        ...
        'Dim time As DateTime = "08:00"
        'WebDateTimeEdit1.MinValue = time
    ...
    Protected Sub RadioButtonList_Type_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles RadioButtonList_Type.SelectedIndexChanged
        If RadioButtonList_Type.SelectedValue = "plain" Then
            For b As Integer = 0 To CheckBoxList1.Items.Count - 1
                CheckBoxList1.Items(b).Selected = False
            Next
            Panel1.Visible = False
        ElseIf RadioButtonList_Type.SelectedValue = "Contrast" Then
            Panel1.Visible = True
            For b As Integer = 0 To CheckBoxList1.Items.Count - 1
        ...
        End If
    End Sub
    Sub Checkboxlistcheck_Medicine(ByVal checkboxlist As CheckBoxList)
        Try
            Dim b As Integer
            Dim abc As String
            Dim array(checkboxlist.Items.Count - 1) As String
    ...
    Protected Sub Button_save_new_area_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        SqlDataSource1.Insert()
        CheckBoxListForRadiologySG.DataBind()
        TextBox_new_Area.Text = ""
        TextBox_Fee.Text = ""
