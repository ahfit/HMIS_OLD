...
Partial Class PatientMRI
    ...
    Protected Sub GridView4_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView4.SelectedIndexChanged
        ...
        'Response.Redirect("PtMRIInsert.aspx?RID=" + GridView4.SelectedValue.ToString + "&payId=" + Request.QueryString(0) + "&regno=" + Request.QueryString(1) + "&Radiology_Id=" + GridView4.Rows(GridView4.SelectedIndex).Cells(4).Text)
    End Sub
