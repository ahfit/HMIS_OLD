<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PtMRIinsert.aspx.vb" Inherits="PtMRIinsert" %>
    ...
    <td width="957" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        <td height="435" colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="mainframe_bg1">
          <!--DWLayoutTable-->
          <tr>
            <td width="20" rowspan="5" valign="top" style="width: 20px"><img src="images1/img_spacer.gif" width="20" height="2" alt=""/></td>
          ...
          <tr>
            <td colspan="2" valign="top" style="height: 95px">
      ...
      scrolling="No" frameborder="0" id="Iframe1"></iframe>            </td>
          ...
          <tr>
            <td colspan="2" valign="top" style="text-align: center; height: 81px;">
                        <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False"
                    DataKeyNames="Table_ID" DataSourceID="SqlDataSource1" Width="100%"  EnableTheming="True">
                    <Columns>
...
Where ((YearlyNo = @YearlyNo) and (RegNo = @RegNo) and (Xray_ID = @XRay_ID))">
          ...
          <tr>
            <td height="227" colspan="2" valign="top" style="width: 831px; text-align: center;"><span style="width: 100px">
                  &nbsp;</span><br />
                  <span  style="text-align:left" >Report for the MRI</span><br />

                    <ighedit:WebHtmlEditor ID="TextBoxXrayReport" runat="server" Width="100%">
                        <Toolbar>
                            ...
                            <ighedit:ToolbarMenuButton runat="server" Type="InsertTable">
                                ...
                                </Menu>                            </ighedit:ToolbarMenuButton>
                            ...
                            <ighedit:ToolbarMenuButton runat="server" Type="Zoom">
                                <Menu Width="180px">
                                    <ighedit:HtmlBoxMenuItem runat="server" Act="Zoom25">                                    </ighedit:HtmlBoxMenuItem>
...
&nbsp;&nbsp;<span style="vertical-align: middle; text-align: center">
                    ...
                    <asp:Button ID="btnSave" runat="server" Text="Save Description" Width="143px" /></td>
                      ...
                      <asp:Button ID="Button1" runat="server" Text="View Report" /></td>
                                      <td style="width: 100px">
                      <asp:Button ID="Button_Complete" runat="server" Text="Complete For Deliver" Width="175px" /></td>
                                  </tr>
                              </table>
                           
                            <br />
                    <span style="height: 30px">                    </span><span style="height: 30px">
