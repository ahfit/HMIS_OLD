<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Patient_Attach_Result.aspx.vb" Inherits="Patient_Attach_Result" %>
    ...
    <td width="957" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        <td width="19" valign="top" style="height: 25px"><!--DWLayoutEmptyCell-->&nbsp;</td>
            <td width="938" valign="middle" class="text_lables3" style="height: 25px">
                Add Result</td>
          </tr>
      <tr>
        <td height="487" colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="mainframe_bg1">
          ...
          <tr>
            <td height="55" valign="top" ><table width="917" class="table1" border="0" cellpadding="0" cellspacing="0" >
              <!--DWLayoutTable-->
              <tr>
          ...
          <tr>
            <td height="470" valign="top" style="width: 905px"><span style="height: 390px">
