<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master"
    AutoEventWireup="true" CodeFile="~/DashBoards/TotalPatientAdmissiondetail.aspx.cs" Inherits="DashBoards_TotalPatientAdmissiondetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="sdsPatientCount" runat="server"
     ...
     SelectCommand="usp_AdmissionSummaryDeatail" SelectCommandType="StoredProcedure"
    >
        <SelectParameters>
