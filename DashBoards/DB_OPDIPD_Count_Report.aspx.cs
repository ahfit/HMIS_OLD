...
public partial class DashBoards_DB_OPDIPD_Count_Report : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            FillHospital();
            wdcStartDate.Value = DateTime.Now.AddMonths(-2);
    ...
    {         
            ...
            string reportPath = Server.MapPath("~/DashBoards/DB_OPDIPD_TotalPatient_Report1.rdlc");        
            ReportViewer1.LocalReport.ReportPath = reportPath;
            ReportViewer1.LocalReport.SetParameters(para);
            ReportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("TotalPatients", dt));
