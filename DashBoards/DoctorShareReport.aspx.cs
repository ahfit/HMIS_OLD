...
public partial class DashBoards_DoctorShareReport : System.Web.UI.Page
{
    ...
    private void ShowReport()
    {
        try
        {
           ...
           new SqlParameter("@S_ID", DropDownListServices.SelectedValue),
                new SqlParameter("@shiftid", ddl_shift.SelectedValue)   ,
                 new SqlParameter("@Patient_Type", ddl_type.SelectedValue)     
                                  };
