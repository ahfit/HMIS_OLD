<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master"
    AutoEventWireup="true" CodeFile="ServicesStrengthActivityReportWithDoctor.aspx.cs" Inherits="DashBoards_ServicesStrengthActivityReportWithDoctor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="sdsPatientCount" runat="server"
     ...
     SelectCommand="ServicesStrengthActivityService_ReportWithDoctor" SelectCommandType="StoredProcedure"
    >
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="DropDownListOPDIPD" Name="OPDIPD" PropertyName="SelectedValue" Type="String" />
