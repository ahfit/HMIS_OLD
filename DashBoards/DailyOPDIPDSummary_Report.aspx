<%@ page title="" language="C#" masterpagefile="~/hacims_masterpage_admin.master" autoeventwireup="true" inherits="DashBoards_DailyOPDIPDSummary_Report, App_Web_csihqmfb" enableeventvalidation="false" theme="theme_hacims" viewstateencryptionmode="Never" maintainscrollpositiononpostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tbl_form">
            ...
            <tr>
                <td class="style1">
                    From Time :</td>
                <td class="style2">
                     <asp:textbox id="txtTimeFrom" runat="server" textmode="Time"></asp:textbox></td>
            </tr>
            <tr>
                <td class="style1">
                    To Time :</td>
    ...
    <asp:SqlDataSource ID="sdsPatientCount" runat="server"
     ...
     SelectCommand="DailyOPIPDSummary_Report" SelectCommandType="StoredProcedure"
    >
        <SelectParameters>
