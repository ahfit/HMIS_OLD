<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master"
    AutoEventWireup="true" CodeFile="ServicesStrengthActivityServiceWise.aspx.cs" Inherits="DashBoards_ServicesStrengthActivityServiceWise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="sdsPatientCount" runat="server"
     ...
     SelectCommand="ServicesStrengthActivityServiceWise_Report" SelectCommandType="StoredProcedure"
    >
        <SelectParameters>
