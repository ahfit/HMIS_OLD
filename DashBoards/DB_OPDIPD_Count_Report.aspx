<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master"
    AutoEventWireup="true" CodeFile="DB_OPDIPD_Count_Report.aspx.cs" Inherits="DashBoards_DB_OPDIPD_Count_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="sdsPatientCount" runat="server"
     ...
     SelectCommand="usp_Patient_Count_Dept_Wise" SelectCommandType="StoredProcedure">
        <SelectParameters>
