<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master"
    AutoEventWireup="true" CodeFile="ServicesStrengthActivityServiceWiseWithOutDoctor.aspx.cs" Inherits="DashBoards_ServicesStrengthActivityServiceWiseWithOutDoctor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="sdsPatientCount" runat="server"
     ...
     SelectCommand="ServicesStrengthActivityServiceWise_ReportWithoutDoctor" SelectCommandType="StoredProcedure"
    >
        <SelectParameters>
