<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="DB_TotalPt_Genderwise_report.aspx.cs" Inherits="DashBoards_DB_TotalPt_Genderwise_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <div class="bxmain inner_content " style="width: 100%;">
    ...
    <asp:SqlDataSource ID="sdsPatientCount" runat="server"
     ...
     SelectCommand="usp_OPDIPD_PType_Gender_Count" SelectCommandType="StoredProcedure"
    >
        <SelectParameters>
            <asp:Parameter Name="Start_Date" Type="DateTime" />
            <asp:Parameter Name="End_Date" Type="DateTime" />
            <asp:ControlParameter ControlID="DropDownList1" Name="PType" 
