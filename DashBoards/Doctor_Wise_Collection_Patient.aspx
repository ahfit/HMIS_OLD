<%@ page title="" language="C#" masterpagefile="~/hacims_masterpage_admin.master" autoeventwireup="true" inherits="Doctor_Wise_Collection_Patient, App_Web_0myvw0cp" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr style="text-align: center; width: 100%;">
            <td style="padding-bottom: 10px; text-align: right;" class="style1">
                Department:</td>
            <td style="padding-bottom: 10px; text-align: left;" class="style1">
        ...
        <tr style="text-align: center; width: 100%;">
            <td style="padding-bottom: 10px; text-align: right;" class="style2">
                <spna style="font-weight: bold;">From Date:&nbsp;&nbsp;</spna>
            </td>
            <td style="padding-bottom: 10px; text-align: left;" class="style2">
                ...
                <div class="bxmain2 margin_right10 inner_content" style="height: 250px;">
                    ...
                    <div class="data_scroll">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
                            SelectCommand="usp_get_Patient_By_Doctor" 
...
FROM         Department INNER JOIN
                      Hospital ON Department.Hospital_ID = Hospital.Hospital_ID INNER JOIN
                      SubDepartment ON Department.Dept_ID = SubDepartment.Dept_Id
WHERE     (SubDepartment.SubDept_Type = 1)
and    (@Hospital_ID =0 or Hospital.Hospital_ID = @Hospital_ID)">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlHospital" Name="Hospital_ID" 
                ...
                <div class="bxmain3 margin_right10 inner_content" style="height: 255px;">
                    ...
                    <div class="data_scroll" style="text-align: center;">
                        <asp:Chart ID="Chart2" runat="server" DataSourceID="SqlDataSource2" 
                            ...
                            <Series>
                                <asp:Series ChartType="StackedColumn" Name="Series1" XValueMember="Doc_Name" 
                            ...
                            <ChartAreas>
                                ...
                                <asp:ChartArea Name="ChartArea1">
                                    <AxisX Interval="1" MaximumAutoSize="100">
                                    </AxisX>
