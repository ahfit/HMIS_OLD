<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master"
    AutoEventWireup="true" CodeFile="DB_Laboratory_User_Radiology.aspx.cs" Inherits="DashBoards_DB_Laboratory_User_Radiology" %>
                        ...
                        <asp:GridView ID="gvIPDOPDGroupSummary" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Total" HeaderText="Total" ReadOnly="True"
                                    ItemStyle-CssClass="AmountAlign" SortExpression="Total Amount" />
                            </Columns>
                        </asp:GridView>
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
                            SelectCommand="usp_GetLabServicesCountByGroupRadiology" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                ...
                <div class="bxmain2 margin_right10 inner_content" style="height: 250px;">
                    ...
                    <div class="data_scroll">
                        <asp:GridView ID="gvIPDOPDGroupAmountSummary" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundField DataField="GroupName" HeaderText="GroupName"
                                    ItemStyle-CssClass="AmountAlign" SortExpression="GroupName" />
                                <asp:BoundField DataField="IPD_Total" HeaderText="IPD_Total" ReadOnly="True"
                                    ItemStyle-CssClass="AmountAlign" SortExpression="IPD_Total" />
                                <asp:BoundField DataField="OPD_Total" HeaderText="OPD_Total" ReadOnly="True"
                                    ItemStyle-CssClass="AmountAlign" SortExpression="OPD_Total" />
                                <asp:BoundField DataField="Total_Amount" HeaderText="Total_Amount"
                                    ItemStyle-CssClass="AmountAlign" ReadOnly="True" 
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
                            SelectCommand="usp_GetLabServicesAmountCountByGroupRadiology" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                <asp:Parameter Name="Date_From" Type="DateTime" />
                                <asp:Parameter Name="Date_To" Type="DateTime" />
                            </SelectParameters>
