<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master"
    AutoEventWireup="true" CodeFile="Patient_DoctorAccumulate_Count_Report.aspx.cs" Inherits="DashBoards_Patient_DoctorAccumulate_Count_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="sdsPatientCount" runat="server"
     ...
     SelectCommand="Patient_Count_Report" SelectCommandType="StoredProcedure"
    >
        <SelectParameters>
