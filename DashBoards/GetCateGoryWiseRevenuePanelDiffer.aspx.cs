...
public partial class GetCateGoryWiseRevenuePanelDiffer : System.Web.UI.Page
{
    ...
    protected void getData()
    {
        ...
        {
            con.Open();
            cmd.CommandText = "GetCategoryWiseRevenuePanelDiffer";
            cmd.Connection = con;
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/DashBoards/PanelDifferRevenueReport.rdlc");
            ...
            ReportParameter rp3 = new ReportParameter("PatientType", ddl_PatientType.SelectedItem.Text);
            ReportParameter rp4 = new ReportParameter("Party", DropDownList_Parties.SelectedItem.Text);
