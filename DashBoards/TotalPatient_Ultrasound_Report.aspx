<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master"
    AutoEventWireup="true" CodeFile="TotalPatient_Ultrasound_Report.aspx.cs" Inherits="DashBoards_TotalPatient_Ultrasound_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tbl_form">
            ...
            <td>
                ...
                <td align="right" style="width: 10%;">
                 ...
                 <td>
                      <asp:DropDownList ID="ddlDepartment" runat="server" Width="202px"></asp:DropDownList>
                </td>
        </tr>
             <tr>
                <td align="right" style="width: 10%;">
                ...
                <td style="width: 10%;">
                    <asp:DropDownList ID="ddlCategory" runat="server" DataTextField="Asc_Name" DataValueField="Asc_id" Width="202px">
                    </asp:DropDownList>
                </td>
                <td align="right" style="width: 10%;">
                    <b>From Date : </b>
    ...
    <asp:SqlDataSource ID="sdsPatientCount" runat="server" ConnectionString="<%$ ConnectionStrings:Reg_ConnectionString %>"
        SelectCommand="PatientCount_Ultrasound_Report" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:Parameter Name="Start_Date" Type="DateTime" />
            <asp:Parameter Name="End_Date" Type="DateTime" />
            <asp:Parameter Name="CategoryId" Type="Int16" />
            <asp:Parameter Name="SubDeptID" Type="Int16" />
