<%@ Page Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="LAB_Investigation_Haematology_Amount.aspx.cs" Inherits="Finance_Reports_LAB_Investigation"  %>
        ...
        <tr>
          ...
          From Date : </td>
            <td >
                ...
                </igsch:WebDateChooser>  <asp:HiddenField ID="HiddenField1" runat="server" />
