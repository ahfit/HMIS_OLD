...
public partial class Finance_PostVoucher : System.Web.UI.Page
{
    ...
    {
        SqlParameter[] para = { };
        DataTable dt = execDataTablewithQuery("select Financial_Year_Id,Financial_Year from Financial_Year order by End_Date Desc", conStr, para);
    ...
    private void bindParties()
    {
        ...
        else if (ddlAccountHead.SelectedValue == "33301") //for Advance to staff
        {
            SqlParameter[] para = { };
            dt = execDataTablewithQuery("select EmpID as Party_Id,Name as Party_Name from Employee", conStr, para);
        }
