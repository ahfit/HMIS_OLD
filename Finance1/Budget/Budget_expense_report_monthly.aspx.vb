...
Partial Class Finance_Budget_expense_report_monthly
    ...
    Public Sub LOAD_REPORT()
        ...
        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~\Finance\Budget\Budget_expense_report_monthly.rdlc")
    ...
    Protected Sub load_financial_dates()
        ...
        End If
    End Sub
    Protected Sub DropDownList_FinancialCompany_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles DropDownList_FinancialCompany.SelectedIndexChanged
        DropDownList_CompanyBranches.DataBind()
    End Sub

    Protected Sub Btn_view_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Btn_view.Click
        LOAD_REPORT()
    End Sub
End Class
