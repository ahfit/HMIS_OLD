<%@ Page Language="C#" AutoEventWireup="true" Inherits="PO_ReceivingPOST" MasterPageFile="~/tcp_masterpage.master" CodeFile="PO_ReceivingFirst.aspx.cs" Theme="SkinFile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="bxmain inner_content" style="width:100%; margin-bottom:10px;">
       <h2><span>Deparmental Delivery Issue Voucher Post</span></h2>
     <table class="style1">
        <tr>
            <td colspan="2">
                <div style="width: 100%;">
                    <table style="width: 700px; margin: auto;">
                        <tr>
                            ...
                            <td style="font-weight: bold;">PO Branch
                            </td>
                            <td>
                                <strong>:</strong>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: bold;">Receiveing Branch</td>
                            <td>
                                <strong>:</strong>
                            </td>
                            <td>
