<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Payment_To_Vender.aspx.vb"
    MasterPageFile="~/hacims_masterpage_admin.master" Inherits="Payment_To_Vendor"
    Title="Voucher Receipts Payments" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="bxmain inner_content" style="width:100%;">
        <h2><span>Payment to Vendor</span></h2>
...
ORDER BY E_Name Desc"></asp:SqlDataSource>
     ...
     <%--   <tr>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="BTN_Save" runat="server" Text="Save" OnClientClick="return confirm('Are you sure you want to save?');" />
