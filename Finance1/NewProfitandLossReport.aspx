<%@ Page Title="" Language="VB" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="false" CodeFile="NewProfitandLossReport.aspx.vb" Inherits="Finance_NewProfitandLossReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="bxmain inner_content" style="width: 100%;">
        <h2><span>Profit and Loss</span></h2>
...
">
        ...
        <tr>
            ...
            <tr >
             ...
             <tr >
                <td width="40%" align="right">Cost Center :</td>
                <td width="60%">
