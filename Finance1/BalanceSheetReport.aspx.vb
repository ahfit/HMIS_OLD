...
Partial Class Finance_BalanceSheetReport
    ...
    Private Sub ShowReport()
        Try
            ...
            Dim cmd As SqlCommand = New SqlCommand("uspGetBalanceSheet", con)
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Finance/BSReport.rdlc")
