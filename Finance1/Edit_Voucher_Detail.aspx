<%@ Page Title="" Language="VB" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="false" CodeFile="Edit_Voucher_Detail.aspx.vb" Inherits="Finance_Edit_Voucher_Detail" %>
...
WHERE     (Voucher_Trans_Id = @Voucher_Trans_Id) "
    ...
    <asp:GridView ID="gvVoucherDetail" Width="100%" runat="server" ShowFooter="True"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Cost Center" HeaderStyle-Width="100px">
                <ItemTemplate>
                    <asp:DropDownList ID="ddlCostCenter" Width="100px" DataSourceID="sqlCost_Center"  
                         DataTextField="CostCenterName"  AppendDataBoundItems="True"
                        DataValueField="CostCenterID" runat="server" 
                         >
                    </asp:DropDownList>                    
                    <asp:HiddenField ID="hfCostCenter" runat="server" Value='<%#Eval("CostCenterID")%>' />
            ...
            <asp:TemplateField HeaderText="Description">
                <ItemTemplate>
                    <asp:TextBox ID="txtDescription" runat="server" Width="400px" TextMode="MultiLine" Rows="3" Text='<%#Eval("Description") %>'></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
...
where     Reciept_Disbursement_Detail_Id=@Reciept_Disbursement_Detail_Id"
        ...
        <asp:SqlDataSource ID="sqlCost_Center" runat="server" 
        ConnectionString="<%$ ConnectionStrings:FinanceConnectionString %>" 
        SelectCommand="select 0 as CostCenterID,'' as CostCenterName union select CostCenterID,CostCenterName from CostCenter"
        UpdateCommand="UPDATE    Reciept_Disbursement_Detail SET  CostCenterID =@CostCenter where     Reciept_Disbursement_Detail_Id=@Reciept_Disbursement_Detail_Id" >
            <UpdateParameters>
