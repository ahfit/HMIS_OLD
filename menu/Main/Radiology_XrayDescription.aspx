<%@ page language="C#" autoeventwireup="true" inherits="Radiology_XrayDescription, App_Web_3j2dqz20" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
window.open("patientxray.aspx?PayId=" + yearly + "&RegNo=" + reg,"_top","");
}
 ...
 document.getElementById('wait').childNodes[0].nodeValue="please wait instaling";
  ...
  /////////////////////////////////////////////////////////////////////////      
        if(object1)
        {
            ...
            object1.open("GET","http://"+location.host+"/lgh/xrayhandler.ashx?a="+argsName+"&b="+argsValue,false);
...
//alert(reg+" "+yearly+" "+xray);
      ...
      if(object1)
        {
            object1.open("GET","http://"+location.host+"/lgh/XRayInsertionHandler.ashx?a="+reg+"&b="+yearly+"&c="+xray+"&d="+empID,false);
            object1.onreadystatechange=function()
               {
                   if(object1.readyState==COMPLETE)
                    {
...
<form id="form1" runat = server>
  ...
  <tr>
    ...
    <td align="center" style="width: 322px"><div id="wait" style="display:none;">
        &nbsp;</div></td>
    <td></td>
    <td></td>
  </tr>
  ...
  <tr>
    ...
    <td style="height: 5px; width: 322px;" align="center"><table style="width: 100%; height: 100%">
        ...
        ...
                    <input id="Button_Next" style="width: 101px" type="button" value="Next" onclick="Move_Next()"/></div>
                </td>
            </tr>
        </table></td>
