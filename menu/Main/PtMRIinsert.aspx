<%@ page language="VB" autoeventwireup="false" inherits="PtMRIinsert, App_Web_rbfdm1yf" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
<table width="1003" border="0" cellpadding="0" cellspacing="0">
  <!--DWLayoutTable-->
  <tr>
    <td height="24" colspan="3" valign="top"><img src="../images/img_border_top.gif" width="1003" height="24" alt=""/></td>
  </tr>
  <tr>
    <td width="23" height="617" valign="top" class="left_border"><img src="../images/img_border_left.gif" width="23" height="15" alt=""/></td>
    <td width="957" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        <td height="435" colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="mainframe_bg1">
          <!--DWLayoutTable-->
          <tr>
            <td rowspan="6" valign="top" style="width: 20px"><img src="../images/img_spacer.gif" width="20" height="2" alt=""/></td>
                  <td height="10" colspan="2" valign="top" style="text-align: center">
                        <asp:Label ID="Label_message" runat="server" ForeColor="Blue" Width="638px"></asp:Label></td>
                  <td width="20" rowspan="6" valign="top"><img src="../images/img_spacer.gif" width="20" height="2" alt=""/></td>
                </tr>
          <tr>
...
Where ((YearlyNo = @YearlyNo) and (RegNo = @RegNo) and (Xray_ID = @XRay_ID))">
          ...
          <tr>
            <td height="25" align="right" valign="middle" style="width: 247px"><span  style="width: 143px">Report for the MRI :&nbsp;</span></td>
                <td rowspan="2" valign="top" style="width: 831px; text-align: center;"><span style="width: 100px">
                  &nbsp;</span><br />
                    <ighedit:WebHtmlEditor ID="TextBoxXrayReport" runat="server" Width="649px">
                        <Toolbar>
                  ...
                  <span style="vertical-align: middle; text-align: center">&nbsp; <br />
                    ...
                    <asp:Button ID="btnSave" runat="server" Text="Save Description" Width="143px" /></td>
                                      <td style="width: 100px">
                      <asp:Button ID="Button2" runat="server" Text="Move To Treatment" OnClick="Button2_Click" /></td>
                                      <td style="width: 100px"><asp:Button ID="Button_Lab_test" runat="server" Text="Move To Lab. Test" OnClick="Button_Lab_test_Click" /></td>
                                  </tr>
                              </table>
                              <asp:Label ID="Label_Description" runat="server" ForeColor="Blue"></asp:Label>
                          </ContentTemplate>
                      </asp:UpdatePanel><asp:Button ID="Button1" runat="server" Text="View Report" Visible="False" />
                      &nbsp;
                      <asp:Button ID="Button_Complete" runat="server" Text="Complete For Deliver" Width="175px" Visible="False" />
                      &nbsp; &nbsp;&nbsp; &nbsp;<br />
...
Where ((YearlyNo = @YearlyNo) and (RegNo = @RegNo) and (Pt_Test_ID= @Pt_Test_ID))">
    ...
    <td width="32" valign="top" class="right_border" ><img alt="" src="../images/img_border_right.gif" width="23" height="15" alt=""/></td>
  </tr>
  <tr>
    <td height="24" colspan="3" valign="top"><img alt="" src="../images/img_border_bottom.gif" width="1003" height="24" alt=""/></td>
  </tr>
</table>
<script type="text/javascript" src="../images/flash_01.js">function Button1_onclick() {
