...
Partial Class Administrator_Add_New_Company
    ...
    Dim constrF As String = ConfigurationManager.ConnectionStrings("FinanceConnectionString").ToString()
    ...
    Protected Sub LoadControls(ByVal AN As Integer)
        ...
        While reader.Read
            ...
            ddlPartyType.SelectedItem.Text = reader.Item("Party_Type").ToString()
