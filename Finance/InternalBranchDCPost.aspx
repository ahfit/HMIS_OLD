<%@ Page Language="C#" AutoEventWireup="true" Inherits="InternalBranchDCPost" MasterPageFile="~/tcp_masterpage.master" CodeFile="InternalBranchDCPost.aspx.cs" Theme="SkinFile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   <div class="bxmain inner_content" style="width:100%; margin-bottom:10px;">
       <h2><span>Deparmental Delivery Voucher Posting</span></h2>
     <table class="style1">
        <tr>
            <td colspan="2">
                <div style="width: 100%;">
                    <table style="width: 700px; margin: auto;">
                        <tr>
                            ...
                            <td style="font-weight: bold;">From Branch
                            </td>
                            <td>
                                <strong>:</strong>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: bold;">To Branch</td>
                            <td>
                                <strong>:</strong>
                            </td>
                            <td>
