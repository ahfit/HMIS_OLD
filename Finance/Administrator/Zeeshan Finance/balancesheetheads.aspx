<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="balancesheetheads.aspx.cs" Inherits="Finance_balancesheetheads" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="bxmain inner_content" style="width: 100%; height=100%">
        ...
        <table width="100%" style="align-items: center; align-content: center; align-self: center">
            <tr align="center">
                ...
                <td align="left">
                    ...
                    <asp:Label ID="balance_sheet_id" runat="server" Text="" Visible="false"></asp:Label>
                </td>
            </tr>
            ...
            <tr align="center">
                <td align="right">Main Sort Order :&nbsp</td>
                <td align="left">
                    <asp:TextBox ID="main_sort_order" runat="server"></asp:TextBox>
                </td>
            </tr>
        ...
        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="false">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Balance Sheet Id" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="blncid" runat="server" Text='<%# Bind("Balance_Sheet_Id") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Main Sort Order" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:Label ID="mnsrtordr" runat="server" Text='<%# Bind("MainSort_Order") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:Button ID="Editbtn" Text="Edit" runat="server" CommandArgument='<%# Eval("Balance_Sheet_Id") %>' OnClick="LinkButton" />
                    </ItemTemplate>
                </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Finance_ConnectionString %>" SelectCommand="SELECT Distinct [Group_type] FROM [Balance_Sheet_Heads]"></asp:SqlDataSource>
</asp:Content>
