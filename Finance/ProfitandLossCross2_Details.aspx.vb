...
Partial Class Finance_ProfitandLossCross2_Details
    ...
    Private Sub ShowReport()
        Try
            ...
            Dim cmd As SqlCommand = New SqlCommand("GetProfitLossReport_DetailbyNotes", con)
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Finance/ProfitLossSheetCrossProduct_bynotes.rdlc")
