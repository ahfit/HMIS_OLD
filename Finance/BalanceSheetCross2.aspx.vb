...
Partial Class Finance_BalanceSheetCross2
    ...
    Private Sub ShowReport()
        Try
            ...
            Dim cmd As SqlCommand = New SqlCommand("GetBalanceSheet", con)
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Finance/BalanceSheetCrossProduct.rdlc")
            ...
            ReportViewer1.LocalReport.SetParameters(New ReportParameter("AsOnDate1", txtAsOnDate1.Text))
            ReportViewer1.LocalReport.SetParameters(New ReportParameter("AsOnDate2", txtAsOnDate2.Text))
