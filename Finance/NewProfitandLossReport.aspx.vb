...
Partial Class Finance_NewProfitandLossReport
    ...
    Private Sub ShowReport()
        Try
            ...
            Dim cmd As SqlCommand = New SqlCommand("uspGetProfitLossReportNew", con)
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Finance/NewProfitandLossReport.rdlc")
