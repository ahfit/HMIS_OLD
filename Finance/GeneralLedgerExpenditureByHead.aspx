<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/hacims_masterpage_admin.master"
    CodeFile="GeneralLedgerExpenditureByHead.aspx.vb" Inherits="audit_GeneralLedger" %>
                                ...
                                <td width="75%" align="left">
                                   <asp:DropDownList ID="DDL_Other_Currency" runat="server" Width="184px" AutoPostBack="True"
                                    ...
                                    <asp:SqlDataSource ID="SDS_Currency" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
                                        SelectCommand="SELECT  [Currency_Name], [Currency_Abbrivation] FROM [Currency]">
                                    </asp:SqlDataSource>    
                                 </td>
                            </tr>
            <tr>
    ...
    <asp:SqlDataSource ID="SqlDataSourceforGrid" runat="server" ConnectionString="<%$ ConnectionStrings:Finance_ConnectionString %>"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="hfPaymentToId" Name="E_Code" PropertyName="Value"
             ...
             <asp:ControlParameter ControlID="DDLVoucher" Name="postedUnposted" PropertyName="SelectedValue"
                Type="Int32" />
            ...
            <asp:ControlParameter ControlID="DDL_Other_Currency" Name="Currancy" PropertyName="SelectedValue" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    <br />
    <br />
