...
public partial class Finance_Reports_LAB_Investigation : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            HiddenField3.Value = "LAB_Investigation_Haematology.rpt";
    ...
    protected void ShowRpt()
    {
        ...
        AdminReportsTableAdapters.LAB_Investigation_HaematologyTableAdapter da = new AdminReportsTableAdapters.LAB_Investigation_HaematologyTableAdapter();
        ...
        {
            da.Fill(ds.LAB_Investigation_Haematology, Convert.ToDateTime(HiddenField1.Value), Convert.ToDateTime(HiddenField2.Value), DropDownList_HospitalId.SelectedValue, DropDownList_TGID.SelectedValue, RadioButtonList1.SelectedValue, DropDownListSubDepartment.SelectedValue);
        }
        else
        {
            da.Fill(ds.LAB_Investigation_Haematology, Convert.ToDateTime(HiddenField1.Value), Convert.ToDateTime(HiddenField2.Value), DropDownList_HospitalId.SelectedValue, DropDownList_TGID.SelectedValue, RadioButtonList1.SelectedValue, "%");
        }
      ...
      //  Response.Write(ds.LAB_Investigation_Haematology.Rows.Count);
        hda.Fill(ds.Hospital_Header, i);
        
        
       // String path = Server.MapPath("LAB_Investigation_Haematology.rpt");
        String path = Server.MapPath(HiddenField3.Value);
        doc.FileName = path;
        doc.Database.Tables["Hospital_Header"].SetDataSource(ds.Tables["Hospital_Header"]);
        doc.Database.Tables["LAB_Investigation_Haematology"].SetDataSource(ds.Tables["LAB_Investigation_Haematology"]);
    ...
    {
        HiddenField3.Value = "LAB_Investigation_Haematology_A.rpt";
        DateTime t;
        t = Convert.ToDateTime(WebDateChooser1.Value);
        HiddenField1.Value = Convert.ToString(t.ToShortDateString()) + " 12:00:00 AM";
        t = Convert.ToDateTime(WebDateChooser2.Value);
