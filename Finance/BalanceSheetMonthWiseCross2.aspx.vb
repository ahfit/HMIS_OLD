...
Partial Class Finance_BalanceSheetMonthWiseCross2
    ...
    Private Sub ShowReport()
        Try
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Finance/BalanceSheetMonthWiseCrossProduct.rdlc")
    ...
    Private Sub LOADDATE()
        ...
        If TMonth <= 6 Then
            txtAsOnDate1.Text = (TYear - 2).ToString() + "-06-30"
