...
Partial Class Finance_ProfitandLossCross2
    ...
    Private Sub ShowReport()
        Try
            ...
            Dim cmd As SqlCommand = New SqlCommand("GetProfitLossReport", con)
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Finance/ProfitLossSheetCrossProduct.rdlc")
