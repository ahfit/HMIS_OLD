<%@ page language="VB" autoeventwireup="true" masterpagefile="~/hacims_masterpage_admin.master" CodeFile="~/Finance/Trial_Balance_Report_New.aspx.vb" inherits="Finance_Trial_Balance_Report_New" %>
...
SELECT  CostCenterID, CostCenterName   FROM CostCenter">
 ...
 where [Financial_Company_Id] in (SELECT Financial_Company_ID FROM Employee_Rights_Company_Wise WHERE (Emp_ID = @Emp_id))">
       ...
       <asp:SqlDataSource ID="SQL_Branchname" runat="server" 
           ConnectionString="<%$ ConnectionStrings:FinanceConnectionString %>" SelectCommand="select 0 AS Company_Branch_Id, '--- ALL ---' AS Company_Branch_Name union SELECT     Company_Branch_Id, Company_Branch_Name
...
">
 ...
 >
     <SelectParameters>
         ...
         <asp:ControlParameter ControlID="hfPaymentToId" Name="E_Code" PropertyName="Value" Type="String" />
     </SelectParameters>
    </asp:SqlDataSource>
