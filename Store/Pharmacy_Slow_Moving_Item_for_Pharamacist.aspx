<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="Pharmacy_Slow_Moving_Item_for_Pharamacist.aspx.cs" Inherits="Pharmacy_Slow_Moving_Item_for_Pharamacist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="bxmain inner_content" style="width: 100%; margin-bottom: 10px;">
        <h2><span>Pharmacy Slow Moving Items for Pharamacist</span></h2>
