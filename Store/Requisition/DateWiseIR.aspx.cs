...
public partial class Store_DateWiseIR : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            if (Request.QueryString["T"].ToString() == "IW")
            {
                lblHeader.Text = "Item Wise Requisitions";
                ItemDiv.Visible = true;
            }
            if (Request.QueryString["T"].ToString() == "CW")
            {
                lblHeader.Text = "Category Wise Requisitions";
                category.Visible = true;
            }
            if (Request.QueryString["T"].ToString() == "GRN")
            {
                lblHeader.Text = "GRN Wise Requisitions";
            }
            if (Request.QueryString["T"].ToString() == "DEW")
            {
                lblHeader.Text = "Department Wise Requisitions";
            }
        }
    }
            ...
            if (Request.QueryString["T"] == "DW") {
                SqlParameter[] sqlParam = {
                    ...
                    new SqlParameter("@FromDate",Convert.ToDateTime(wdcFromDate.Value).ToString("yyyy-MMMM-dd")),
                                        ...
                                        new SqlParameter("@RequisitionNo", txtRequisitionNo.Text)};
                dt = dbMgr.ExecuteDataTable("DateWiseInternalRequisition", "STOREConnectionString", sqlParam);
                 path = Server.MapPath("DateWiseIR.rdlc");
            }
           else if (Request.QueryString["T"] == "IW")
            {
                SqlParameter[] sqlParam = {
                    new SqlParameter("@From_Dept_ID", ddlDepartment.SelectedValue),
                    new SqlParameter("@FromDate",Convert.ToDateTime(wdcFromDate.Value).ToString("yyyy-MMMM-dd")),
                                        new SqlParameter("@ToDate",Convert.ToDateTime(wdcToDate.Value).ToString("yyyy-MMMM-dd")),
                                          new SqlParameter("@RequisitionNo", txtRequisitionNo.Text),
                                        new SqlParameter("@itemName", hfItemCode.Value)};
                dt = dbMgr.ExecuteDataTable("ItemWiseInternalRequisition", "STOREConnectionString", sqlParam);
                path = Server.MapPath("ItemWiseIR.rdlc");
            }

            else if (Request.QueryString["T"] == "DEW")
            {
                SqlParameter[] sqlParam = {
                    new SqlParameter("@From_Dept_ID", ddlDepartment.SelectedValue),
                    new SqlParameter("@FromDate",Convert.ToDateTime(wdcFromDate.Value).ToString("yyyy-MMMM-dd")),
                                        ...
                                        new SqlParameter("@RequisitionNo", txtRequisitionNo.Text)};
                dt = dbMgr.ExecuteDataTable("DateWiseInternalRequisition", "STOREConnectionString", sqlParam);
                path = Server.MapPath("DepartmentWiseIR.rdlc");
            }

            else if (Request.QueryString["T"] == "CW")
            {
                SqlParameter[] sqlParam = {
                    new SqlParameter("@From_Dept_ID", ddlDepartment.SelectedValue),
                    new SqlParameter("@FromDate",Convert.ToDateTime(wdcFromDate.Value).ToString("yyyy-MMMM-dd")),
                                        new SqlParameter("@ToDate",Convert.ToDateTime(wdcToDate.Value).ToString("yyyy-MMMM-dd")),
                                        new SqlParameter("@RequisitionNo", txtRequisitionNo.Text)};
                dt = dbMgr.ExecuteDataTable("CategoryWiseInternalRequisition", "STOREConnectionString", sqlParam);
                path = Server.MapPath("CateogoryWiseIR.rdlc");
            }

            else if (Request.QueryString["T"] == "GRN")
            {
                SqlParameter[] sqlParam = {
                    new SqlParameter("@From_Dept_ID", ddlDepartment.SelectedValue),
                    new SqlParameter("@FromDate",Convert.ToDateTime(wdcFromDate.Value).ToString("yyyy-MMMM-dd")),
                                        new SqlParameter("@ToDate",Convert.ToDateTime(wdcToDate.Value).ToString("yyyy-MMMM-dd")),
                                        new SqlParameter("@RequisitionNo", txtRequisitionNo.Text)};
                dt = dbMgr.ExecuteDataTable("GRNWiseInternalRequisition", "STOREConnectionString", sqlParam);
                path = Server.MapPath("GRNWiseIR.rdlc");
            }
