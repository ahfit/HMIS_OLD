<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/hacims_masterpage_admin.master" CodeFile="Item_Wise_Stock_Report.aspx.cs" Inherits="Store_Item_Wise_Stock_Report" %>
    ...
    <div class="bxmain inner_content" style="width: 100%;">
        ...
        <table class="style1">
            ...
            <tr>
               ...
               <tr>
                <td class="style2">Zero Quantity <strong> :</strong></td>
                <td class="style3">
                    <asp:RadioButtonList runat="server" ID="rb_list" RepeatDirection="Horizontal"     >
<asp:ListItem Text="Include Zero" Selected="True" Value="0"></asp:ListItem>
<asp:ListItem Text="Exclude Zero" Value="1"></asp:ListItem>
                        </asp:RadioButtonList>
                </td>
            </tr>
            ...
            <tr >
                <td class="style2">Order By :<strong> :</strong></td>
                <td class="style3">
