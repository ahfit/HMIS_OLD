...
public partial class Store_DeptWiseItemDetailReport : System.Web.UI.Page
{
    ...
    protected void bindReport()
    {
        ...
        dt = dbMgr.ExecuteDataTable("DeptWise_uspItemLedger", "STOREConnectionString", sqlParam);
        ReportDataSource rds = new ReportDataSource();
        rds.Name = "DataSet1";
        rds.Value = dt;
        ReportViewer1.LocalReport.DataSources.Clear();
        ReportViewer1.LocalReport.ReportPath = Server.MapPath("DeptWiseItemDetailReport.rdlc");
