...
public partial class Store_SearchItemsStatus : System.Web.UI.Page
{
    ...
    protected void btnMarkExpensive_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow row in GridView1.Rows)
        {
            ...
            if (chkbox.Checked)
            {
                ...
                dbmgr.ExecuteNonQuery("usp_MarkItemStatus", "STOREConnectionString", para);
            }
            lblNewMsg.Visible = true;
            lblNewMsg.ForeColor = System.Drawing.Color.Green;
            lblNewMsg.Text ="Items Successfully Marked InActive...";
            FillGridView();
        }
    }
    ...
    protected void btnUnmark_Click(object sender, EventArgs e)
    {
        ...
        DbManager dbmgr = new DbManager();
                ...
                dbmgr.ExecuteNonQuery("usp_UnMarkItemStatus", "STOREConnectionString", para);
        FillGridView();
        lblNewMsg.Visible = true;
        lblNewMsg.ForeColor = System.Drawing.Color.Green;
