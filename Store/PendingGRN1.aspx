<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="PendingGRN1.aspx.cs" Inherits="Store_PendingGRN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <asp:GridView runat="server" ID="gvPendingGRN" AutoGenerateColumns="false" AllowPaging="true"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Post">
                        <ItemTemplate>
                            <asp:CheckBox ID="chkPost" runat="server" Visible='<%# Eval("PostVis") %>' OnCheckedChanged="chkPost_CheckedChanged"
                                    AutoPostBack="true" />
                            <asp:LinkButton ID="lnkPostView" runat="server" Text="View" 
                                CommandArgument='<%# Eval("Post_Voucher_Trans_ID") %>' Visible="false" OnClick="lnkPostView_Click"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
    ...
    <asp:Panel ID="pnlPost" runat="server" CssClass="lightbox" Visible="false">
        <table border="0" cellpadding="0" cellspacing="0" class="tbl_form" width="100%">
            <tr>
                <td align="right" width="40%"><b>Dr. Head : </b></td>
                <td align="left" width="60%">
                    <asp:DropDownList ID="ddlPostDr" runat="server" DataTextField="E_Name" DataValueField="E_Code" Width="350px"></asp:DropDownList>
                </td>
            </tr>
            <tr>
