...
public partial class Store_Pharmacy_Fast_Moving_Item_for_Pharamacist : System.Web.UI.Page
{
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=FastMoving.xls");
        Response.Charset = "";
        ...
        using (StringWriter sw = new StringWriter())
        {
            ...
            GridAdminService.HeaderRow.BackColor = Color.White;
    ...
    private void bindGrid()
    {
        ...
        dt = dbMgr.ExecuteDataTable("PharmacyMoving_Item_for_Pharamacist", "STOREConnectionString", sqlParam);
    ...
    protected void GridAdminService_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        bindGrid(); // Replace this with your actual data-binding method
    }
}