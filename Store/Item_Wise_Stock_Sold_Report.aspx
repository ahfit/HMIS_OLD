<%@ page language="C#" autoeventwireup="true" masterpagefile="~/hacims_masterpage_admin.master" inherits="Store_Item_Wise_Stock_Report, App_Web_tnnmgguv" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
           ...
           <h2><span>Item Wise Consumption and Stock</span></h2>
                ...
                <tr>
                        <td class="auto-style1">
                            Department :</td>
                        <td class="style3">
                            <asp:DropDownList ID="DropDownList_Subdepartment" runat="server" AutoPostBack="false" DataTextField="SubDept_Name" DataValueField="SubDept_Id" Width="200px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                <tr>
