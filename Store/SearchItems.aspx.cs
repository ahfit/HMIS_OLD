...
public partial class Store_SearchItems : System.Web.UI.Page
{
    ...
    protected void btnMarkExpensive_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow row in GridView1.Rows)
        {
            ...
            if (chkbox.Checked)
            {
                ...
                dbmgr.ExecuteNonQuery("usp_MarkExpensive", "STOREConnectionString", para);
            }
            lblNewMsg.Visible = true;
            lblNewMsg.ForeColor = System.Drawing.Color.Green;
            lblNewMsg.Text ="Items Successfully Marked as Expensive";
            FillGridView();
        }
    }
    ...
    protected void btnUnmark_Click(object sender, EventArgs e)
    {
        ...
        DbManager dbmgr = new DbManager();
                ...
                dbmgr.ExecuteNonQuery("usp_UnMarkExpensive", "STOREConnectionString", para);
        FillGridView();
        lblNewMsg.Visible = true;
        lblNewMsg.ForeColor = System.Drawing.Color.Green;
