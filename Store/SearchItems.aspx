<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="SearchItems.aspx.cs" Inherits="Store_SearchItems" %>
     ...
     <table style="width: 100%; margin: auto">
        ...
        <tr>
            <td align="center" colspan="4">
                ...
                <asp:Button ID="btnMarkExpensive" runat="server" Text="Mark Critical"  OnClick="btnMarkExpensive_Click" />
            ...
            <td align="center" colspan="4">
              ...
              <Columns>
                  ...
                  <asp:TemplateField HeaderText="Is Critical">
                      <ItemTemplate>
                          <asp:HiddenField ID="hfIs_Expensive" runat="server" Value='<%# Eval("Is_Expensive") %>' />
