...
public partial class Store_Item_Wise_Stock_Report : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            bindHospital();
            DDLbranch.SelectedValue = Session["HospitalID"].ToString();
            bindSubdepartment();
    ...
    private void ShowReport()
    {
        ...
        try
        {
            ...
            cmd.Parameters.AddWithValue("@Hospital_Id", DDLbranch.SelectedValue);
            cmd.Parameters.AddWithValue("@zero_quantity", rb_list.SelectedValue);
            cmd.Parameters.AddWithValue("@Sdate", txtStartDate.Text);
            ...
            dv.Sort = "Item_Name " + ddlorderBy.SelectedValue+"";
            dt = dv.ToTable();
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("Item_Wise_Stock_Report.rdlc");
            ReportViewer1.LocalReport.DataSources.Clear();
