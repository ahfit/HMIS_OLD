<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" 
    CodeFile="MinimumAuthorityLevel.aspx.cs" Inherits="Store_MinimumAuthorityLevel" %>
...
<asp:GridView ID="gvApprovalAuthorities" runat="server" AutoGenerateColumns="False" 
    ...
    <asp:SqlDataSource ID="sqlDs_MinApprovalAuthorities" runat="server" 
        ConnectionString="<%$ ConnectionStrings:STOREConnectionString %>" SelectCommand="SELECT     Min_Authority_Level.Min_Approval_Auth_Id, Min_Authority_Level.SubDept_Id, Min_Authority_Level.Auth_Level, SubDepartment.SubDept_Name
FROM         Min_Authority_Level INNER JOIN
SubDepartment ON Min_Authority_Level.SubDept_Id = SubDepartment.SubDept_Id" 
        DeleteCommand="Delete From Min_Authority_Level Where Min_Approval_Auth_Id = @Min_Approval_Auth_Id" 
        UpdateCommand="usp_SaveMinApprovalAuthority" UpdateCommandType="StoredProcedure">
        <DeleteParameters>
