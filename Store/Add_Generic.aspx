<%@ page title="" language="C#" masterpagefile="~/hacims_masterpage_admin.master" autoeventwireup="true" inherits="Store_Add_Generic, App_Web_tnnmgguv" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
<h2><span>Add Generic</span></h2>
    ...
    <asp:GridView ID="gvAllManufacturer" runat="server" AllowPaging="True" Width="100%"
        PageSize="20" AutoGenerateColumns="False" DataKeyNames="Generic_Name" DataSourceID="sdsAllManufacturer">
        <Columns>
            <asp:TemplateField>
                <HeaderTemplate>
...
<%--            <asp:BoundField DataField="Id" HeaderText="Manufacturer_Id" Visible="false"
    ...
    <asp:SqlDataSource ID="sdsAllManufacturer" runat="server" ConnectionString="<%$ ConnectionStrings:STOREConnectionString %>"
