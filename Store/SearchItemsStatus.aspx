<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="SearchItemsStatus.aspx.cs" Inherits="Store_SearchItemsStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <asp:ScriptManager id="ScrMn" runat="server"></asp:ScriptManager>
     <div class="bxmain inner_content" style="width:100%;">
           <h2><span>Mark Items Active/InActive </span></h2>
     <table style="width: 100%; margin: auto">
        ...
        <tr>
            <td align="center" colspan="4">
                ...
                <asp:Button ID="btnMarkExpensive" runat="server" Text="Mark InActive"  OnClick="btnMarkExpensive_Click" />
        ...
        <tr>
            <td align="center" colspan="4">
              ...
              <Columns>
                  ...
                  <asp:TemplateField HeaderText="Is InActive">
                      <ItemTemplate>
                          <asp:HiddenField ID="hfIs_Expensive" runat="server" Value='<%# Eval("Is_Active") %>' />
