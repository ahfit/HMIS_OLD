<%@ page language="VB" autoeventwireup="false" inherits="Telemedicine_Reports_Diagosis, App_Web_aflja2q4" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
<body><iframe 
    ...
    <div>
        &nbsp;<CR:CrystalReportSource ID="CrystalReportSourceDiagnosis" runat="server">
            <Report FileName="\\Server\D\Projects\Telemedicine\Telemedicine Application\Telemedicine_Reports\withDiagosis.rpt">
                <Parameters>
        ...
        &nbsp; &nbsp;<asp:Button CssClass="bt1up" ID="ButtonDiagnosis" runat="server" Text="Diagnosis" /><asp:Button 
            ID="ButtonExamination" runat="server" Text="Examination" Width="90px" /><asp:Button CssClass="bt1up" ID="ButtonHistories"
                runat="server" Text="Histories" /><asp:Button CssClass="bt1up" ID="ButtonMedication" runat="server"
                    Text="Medication" /><asp:Button CssClass="bt2up" ID="ButtonPathologyTest" runat="server" Text=" Pathology Test" Width="95px" />
        <asp:Button CssClass="bt2up"
                        ID="ButtonPhysicianOrder" runat="server" Text="Physician Order"  Width="125px" /><asp:Button CssClass="bt1up" ID="ButtonRadiology"
                            runat="server" Text="Radiology" />
        <asp:Button CssClass="bt2up" ID="ButtonSympotoms" runat="server"
                                Text="Sympotoms" /><asp:Button CssClass="bt1up" ID="ButtonVital" runat="server" Text="Vital" />
        <asp:Button CssClass="bt1up"
                                    ID="ButtonXray" runat="server" Text="Xray" />&nbsp;
        <CR:CrystalReportSource ID="CrystalReportSourceExamination"
                                        runat="server">
                                        <Report FileName="\\Server\D\Projects\Telemedicine\Telemedicine Application\Telemedicine_Reports\withExamination.rpt">
                                            <Parameters>
                                                <CR:ControlParameter ControlID="HiddenFieldYearly_No" ConvertEmptyStringToNull="False"
                                                    DefaultValue="" Name="@Yearly_No" PropertyName="Value" ReportName="" />
                                                <CR:ControlParameter ControlID="HiddenFieldReg_No" ConvertEmptyStringToNull="False"
        ...
        <CR:CrystalReportSource ID="CrystalReportSourceHistories" runat="server">
            <Report FileName="\\Server\D\Projects\Telemedicine\Telemedicine Application\Telemedicine_Reports\withHistories.rpt">
                <Parameters>
                    <CR:ControlParameter ControlID="HiddenFieldYearly_No" ConvertEmptyStringToNull="False"
                        DefaultValue="" Name="@Yearly_No" PropertyName="Value" ReportName="" />
                    <CR:ControlParameter ControlID="HiddenFieldReg_No" ConvertEmptyStringToNull="False"
        ...
        <CR:CrystalReportSource ID="CrystalReportSourceMedication" runat="server">
            <Report FileName="\\Server\D\Projects\Telemedicine\Telemedicine Application\Telemedicine_Reports\withMedication.rpt">
                <Parameters>
                    <CR:ControlParameter ControlID="HiddenFieldYearly_No" ConvertEmptyStringToNull="False"
                        DefaultValue="" Name="@Yearly_No" PropertyName="Value" ReportName="" />
                    <CR:ControlParameter ControlID="HiddenFieldReg_No" ConvertEmptyStringToNull="False"
        ...
        <CR:CrystalReportSource ID="CrystalReportSourcePathalogyTest" runat="server">
            <Report FileName="\\Server\D\Projects\Telemedicine\Telemedicine Application\Telemedicine_Reports\withPathalogyTest.rpt">
                <Parameters>
                    <CR:ControlParameter ControlID="HiddenFieldYearly_No" ConvertEmptyStringToNull="False"
                        DefaultValue="" Name="@Yearly_No" PropertyName="Value" ReportName="" />
                    <CR:ControlParameter ControlID="HiddenFieldReg_No" ConvertEmptyStringToNull="False"
        ...
        <CR:CrystalReportSource ID="CrystalReportSourcePhysicianOrder" runat="server">
            <Report FileName="\\Server\D\Projects\Telemedicine\Telemedicine Application\Telemedicine_Reports\withPhysicianOrder.rpt">
                <Parameters>
                    <CR:ControlParameter ControlID="HiddenFieldYearly_No" ConvertEmptyStringToNull="False"
                        DefaultValue="" Name="@Yearly_No" PropertyName="Value" ReportName="" />
                    <CR:ControlParameter ControlID="HiddenFieldReg_No" ConvertEmptyStringToNull="False"
        ...
        <CR:CrystalReportSource ID="CrystalReportSourceRadiology" runat="server">
            <Report FileName="\\Server\D\Projects\Telemedicine\Telemedicine Application\Telemedicine_Reports\withRadiology.rpt">
                <Parameters>
                    <CR:ControlParameter ControlID="HiddenFieldYearly_No" ConvertEmptyStringToNull="False"
                        DefaultValue="" Name="@Yearly_No" PropertyName="Value" ReportName="" />
                    <CR:ControlParameter ControlID="HiddenFieldReg_No" ConvertEmptyStringToNull="False"
        ...
        <CR:CrystalReportSource ID="CrystalReportSourceSymptoms" runat="server">
            <Report FileName="\\Server\D\Projects\Telemedicine\Telemedicine Application\Telemedicine_Reports\withSympotoms.rpt">
                <Parameters>
                    <CR:ControlParameter ControlID="HiddenFieldYearly_No" ConvertEmptyStringToNull="False"
                        DefaultValue="" Name="@Yearly_No" PropertyName="Value" ReportName="" />
                    <CR:ControlParameter ControlID="HiddenFieldReg_No" ConvertEmptyStringToNull="False"
        ...
        <CR:CrystalReportSource ID="CrystalReportSourceVital" runat="server">
            <Report FileName="\\Server\D\Projects\Telemedicine\Telemedicine Application\Telemedicine_Reports\withVitals.rpt">
                <Parameters>
                    <CR:ControlParameter ControlID="HiddenFieldYearly_No" ConvertEmptyStringToNull="False"
                        DefaultValue="" Name="@Yearly_No" PropertyName="Value" ReportName="" />
                    <CR:ControlParameter ControlID="HiddenFieldReg_No" ConvertEmptyStringToNull="False"
        ...
        <CR:CrystalReportSource ID="CrystalReportSourceXray" runat="server">
            <Report FileName="\\Server\D\Projects\Telemedicine\Telemedicine Application\Telemedicine_Reports\withXray.rpt">
                <Parameters>
                    <CR:ControlParameter ControlID="HiddenFieldReg_No" ConvertEmptyStringToNull="False"
                        DefaultValue="" Name="@reg_No" PropertyName="Value" ReportName="" />
                    <CR:ControlParameter ControlID="HiddenFieldYearly_No" ConvertEmptyStringToNull="False"
        ...
        &nbsp;<CR:CrystalReportSource ID="CrystalReportSourceMainReport" runat="server">
