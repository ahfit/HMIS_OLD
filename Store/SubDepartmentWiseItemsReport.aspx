<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/hacims_masterpage_admin.master" CodeFile="SubDepartmentWiseItemsReport.aspx.cs" Inherits="Store_SubDepartmentWiseItemsReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
           ...
           <h2><span>Items Sale And Purchase Report</span></h2>
                <table class="style1">
                    <tr>
                        <td class="style2">
                            Department :
                    ...
                    <tr>
                        ...
                        <td class="style3">
                            <asp:DropDownList ID="ddl_Manufacturer" runat="server" 
                                DataTextField="Manufacturer_Name" DataValueField="Manufacturer_Id" 
                                Width="200px" AutoPostBack="false">
                            </asp:DropDownList>
                        </td>
                    </tr>
