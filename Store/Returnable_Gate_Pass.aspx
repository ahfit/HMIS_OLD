<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="Returnable_Gate_Pass.aspx.cs" Inherits="Store_Returnable_Gate_Pass" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="bxmain inner_content" style="width: 100%;">
        <h2>
            <span>Returnable Gate Pass</span></h2>
        <table class="style1">
            <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlType" runat="server" Width="300px" Height="30px" OnSelectedIndexChanged="ddlType_SelectedIndexChanged">
            ...
            <tr>
                ...
                <td>
                    <igsch:WebDateChooser ID="drReturnDate" runat="server" Width="300px" 
                        Height="30px">
                        <CalendarLayout Culture="English (United Kingdom)">
                        </CalendarLayout>
                </igsch:WebDateChooser>
    ...
    >
        <InsertParameters>
           ...
           <asp:Parameter Direction="InputOutput" Name="GP_ID" Type="Int32" />
            <asp:ControlParameter ControlID="ddlType" Name="Type" PropertyName="Text" Type="String" />
    ...
    <asp:HiddenField ID="HF_Type" runat="server" value="RETURNABLE"/>
