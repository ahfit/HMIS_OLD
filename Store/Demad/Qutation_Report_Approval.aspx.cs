...
public partial class Store_Qutation_Report_Approval : System.Web.UI.Page
{
    ...
    protected void LoadReport()
    {
        ...
        if (Request.QueryString["RQ_ID"] != null)
        {
            ...
            DataTable dt = dbm.ExecuteDataTable("uspGetPreviousApprovedItems", "STOREConnectionString", sp);
         ...
         //   DataTable dt1 = dbm1.ExecuteDataTable("uspGetQutationApprovalAuthoritiesReport", "STOREConnectionString", sp1);
            ...
            //else
            //{
            reportPath = Server.MapPath("QuatotionReportForApproval.rdlc");
         //   }
