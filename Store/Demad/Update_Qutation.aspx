<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="~/Store/Demad/Update_Qutation.aspx.cs" Inherits="Store_Update_Qutation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="bxmain inner_content" style="width: 100%;">
        <h2><span>Update Qutation</span></h2>
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbl_form" style="text-align: center;">
            <tr align="center">
                <td align="right" width="25%">Vendor : 
                </td>
                <td align="left" width="25%">
                    <asp:DropDownList ID="ddlVendor" runat="server" DataSourceID="SDS_Vendor"
                        DataTextField="Party_Name" DataValueField="Party_Id" Width="300px">
                    </asp:DropDownList>
                </td>
                <td></td>

                <td align="right" width="25%">Date : 
                </td>
                <td align="left" width="25%">
                    <asp:TextBox ID="txtDate" runat="server" TextMode="Date" Width="300px"></asp:TextBox>
                </td>
            </tr>
            <tr align="center">
                <td align="right" width="25%">Contact Person : 
                </td>
                <td align="left" width="25%">
                    <asp:TextBox ID="txtPerson" runat="server" Width="300px"></asp:TextBox>
                </td>
                <td></td>
                <td align="right" width="25%">Person Contact # : 
                </td>
                <td align="left" width="25%">
                    <asp:TextBox ID="txtContactNo" runat="server" Width="300px" MaxLength="11"></asp:TextBox>
                </td>
            </tr>
            <tr align="center">
                <td align="right" width="25%">With Effect Date : 
                </td>
                <td align="left" width="25%">
                    <asp:TextBox ID="txtWEDate" runat="server" Width="300px" TextMode="Date"></asp:TextBox>
                </td>
                <td></td>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DropDownList_potype" OnSelectedIndexChanged="DropDownList_potype_SelectedIndexChanged"
                         AutoPostBack="true" runat="server" Width="184px">
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="SDS_Currency" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
                        SelectCommand="Select '' as [Currency_Name] , '' as [Currency_Abbrivation] union SELECT [Currency_Name], [Currency_Abbrivation] FROM [Currency]"></asp:SqlDataSource>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlDistributor" DataSourceID="DataSourceDistributor" runat="server" Width="184px" DataTextField="Distributor" DataValueField="Distributor">
                    </asp:DropDownList>
                     <asp:SqlDataSource ID="DataSourceDistributor" runat="server" ConnectionString="<%$ ConnectionStrings:STOREConnectionString %>"
                        SelectCommand="select Distinct Distributor from Store_Items"></asp:SqlDataSource>
                </td>
                <td></td>
                <td align="right">Current Rate :
                </td>
                <td>
                    <asp:TextBox ID="txtCurrencyRate" runat="server" Enabled="false" Style="width: 184px; height: 1.7em; margin-bottom: -1em;"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtWarranty" runat="server" style="width: 184px;" Enabled="false"></asp:TextBox>
                </td>
                <td></td>
                <td align="right">
                ...
                <td>
                    <asp:TextBox ID="txtOrigin" runat="server" style="width: 184px;" Enabled="false"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">
                ...
                <td>
                    <asp:TextBox ID="txtInstallInPak" runat="server" style="width: 184px;" Enabled="false"></asp:TextBox>
                </td>
                <td></td>
                <td align="right">
                   Stock Availability:
                ...
                <td>
                    <asp:DropDownList ID="ddlStockAvailability" runat="server" Enabled="false">
            ...
            <tr>
                <td colspan="5" style="padding-bottom: 30px; padding-top: 30px;">
                     <asp:GridView ID="GridView1" runat="server" DataSourceID="SDS_GV" Width="100%"
                        AutoGenerateColumns="false" ShowFooter="True"
                        OnPreRender="GridView1_PreRender" Visible="false">
                        <Columns>
                    ...
                    <asp:GridView ID="GridView2" runat="server" DataSourceID="sds_Sub" Width="100%"
            ...
            <tr align="center" valign="top">
                ...
                <td align="left" valign="top">
                    <asp:TextBox ID="txtPayment" runat="server" Width="300px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtTerms" runat="server" Width="295px" Height="150px" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>

            <tr>
                <td align="right" valign="top" colspan="4" style="padding-right: 125px;">
    ...
    <asp:SqlDataSource ID="SDS_GV" runat="server" ConnectionString="<%$ ConnectionStrings:STOREConnectionString %>"
        SelectCommand="SELECT     Store_Items.Item_Name,Demand_Requisition_Sub.Item_Qty,Demand_Requisition_Sub.Item_Code,PR.Rate UnitRate,PR.Rate*Demand_Requisition_Sub.Item_Qty TotalAmount
FROM         Demand_Requisition_Main INNER JOIN
                      Demand_Requisition_Sub ON Demand_Requisition_Main.Demand_RQ_ID = Demand_Requisition_Sub.Demand_RQ_ID INNER JOIN
                      Store_Items ON Demand_Requisition_Sub.Item_Code = Store_Items.Item_Code Left Outer Join
							  (
								Select  ISNULL(Rate,0) Rate,I.Item_Code,PO_ID,RANK() Over(PARTITION By I.Item_Code  Order By Entry_Date Desc) R
								From Purchase_Order_Sub S Right Outer Join
									 Store_Items I On I.Item_Code=S.Item_Code 
        --Where Rate>0 
        ) PR On ISNULL(Store_Items.Item_Code,'0')=ISNULL(PR.Item_Code,'0') WHERE (Demand_Requisition_Main.Demand_RQ_ID =@Demand_RQ_ID) and (R=1 OR R=0)
        ">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="Sql_Qutation_Main" runat="server" ConnectionString="<%$ ConnectionStrings:STOREConnectionString %>"
        InsertCommand="usp_Add_Qutation_Main" InsertCommandType="StoredProcedure" OnInserted="Sql_Qutation_Main_Inserted" UpdateCommand="uspUpdateQutation" UpdateCommandType="StoredProcedure">
        <InsertParameters>
...
WHERE     (Qutation_Main_ID = @Qutation_Main_ID) AND (Item_Code = @Item_Code)">
    ...
    <asp:SqlDataSource ID="sds_Approve" runat="server" ConnectionString="<%$ ConnectionStrings:STOREConnectionString %>"
        ...
        InsertCommand="Insert_PO_from_Demand_REQ" InsertCommandType="StoredProcedure" >
