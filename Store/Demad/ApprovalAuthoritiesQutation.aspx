<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="ApprovalAuthoritiesQutation.cs" Inherits="ApprovalAuthoritiesQutation" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="bxmain inner_content" style="width:100%;">
<h2><span>Approval Authorities for Qutation</span></h2>
<table width="100%">
...
<asp:GridView ID="gvApprovalAuthorities" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="QutationSubDept" HeaderText="Qutation Department"
            SortExpression="QutationSubDept" Visible="false" />
        <asp:BoundField DataField="ApprovalSubDept" HeaderText="Approval Department"
            SortExpression="ApprovalSubDept" Visible="false" />
        <asp:BoundField DataField="Employee_Name" HeaderText="Approval Employee" 
            SortExpression="EmployeeId" />
        <asp:BoundField DataField="Aut_Level" HeaderText="Authority Level" 
            SortExpression="Aut_Level" />
...
<asp:SqlDataSource ID="sqlDs_ApprovalAuthorities" runat="server" 
        ConnectionString="<%$ ConnectionStrings:STOREConnectionString %>" SelectCommand="usp_ApprovalAutoritiesForQutation" SelectCommandType="StoredProcedure"
        DeleteCommand="Delete From Qutation_Approval Where Id = @Id"
        UpdateCommand="usp_SaveQutationAuthority" UpdateCommandType="StoredProcedure">
        <DeleteParameters>
        ...
        <UpdateParameters>
            ...
            <asp:ControlParameter ControlID="ddlEmployeeSubdept" Name="EmployeeSubDept" 
                PropertyName="SelectedValue" Type="Int32" />
            <asp:ControlParameter ControlID="ddlAuthority" Name="EmployeeId" 
                PropertyName="SelectedValue" Type="Int32" />
            <asp:ControlParameter ControlID="DDL_AuthorityLevel" Name="Aut_Level" 
                PropertyName="SelectedValue" Type="Int32" />
