<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true"
    CodeFile="Service_Requisition.aspx.cs" Inherits="Store_Service_Requisition" %>
        ...
        <tr>
            <td valign="top" width="50%">
                <div class="bxmain inner_content" style="width: 98%">
                    <h2>
                        <span>Service Requisition</span></h2>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl_form">
                     <tr>
                            <td align="right" width="30%">Types:
                            </td>
                            <td>
                              <asp:DropDownList  Width="250px" Enabled="false"  runat="server" ID="ddltypes">
                                  <asp:ListItem Selected="True" Value="Service">Service</asp:ListItem>
                                    <asp:ListItem Value="Demand">Demand</asp:ListItem>
                              </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                               ...
                               <asp:SqlDataSource ID="SqlDataSourceStore" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
                                                  ...
                                                  SelectCommand="SELECT SubDept_Id, SubDept_Name FROM SubDepartment Where SubDept_Name Like '%Store%' or SubDept_Name Like '%Purchase%'
                                   or SubDept_Name Like '%Main%'   order by SubDept_Name ">
...
Order BY E.E_Code + ' (' + E.E_Name + ')'">
    ...
    <asp:SqlDataSource ID="SqlDataSource_Medicine_Sub" runat="server" ConnectionString="<%$ ConnectionStrings:STOREConnectionString %>"
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="Item_Specification" Type="String" DefaultValue="&quot;&quot;" />
