<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="SupplierwiseServiceRequisitionReport.aspx.cs" Inherits="Store_SupplierwiseServiceRequisitionReport" %>
...
<h2><span>Supplier wise Service Requisition Report</span></h2>
...
<table style="width: 100%;">
      ...
      <tr>
           ...
           <td>
                <asp:DropDownList ID="ddl_Cat" Width="230px" runat="server" 
                    DataSourceID="sqlDsCategory" DataTextField="Item_Type" 
                    DataValueField="Item_Type_Id" AutoPostBack="True" >
                 
                </asp:DropDownList>
                <asp:SqlDataSource ID="sqlDsCategory" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:STOREConnectionString %>" 
                    
                    SelectCommand="select 0 as Item_Type_Id, '---ALL---' Item_Type Union  select Item_Type_Id, Item_Type from Store_Item_Types"></asp:SqlDataSource>
            </td>
