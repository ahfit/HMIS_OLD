...
public partial class Store_DatewiseServiceRequisitionReport : System.Web.UI.Page
{
    ...
    protected void bindReport()
    {
        ...
        try
        {
            SqlCommand sc = new SqlCommand("usp_GetServiceRequisitionsReport", conn);
        ...
        finally
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "Store/Demad/serviceReports/DatewiseServiceRequisitionReport.rdlc";
