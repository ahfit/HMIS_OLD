...
public partial class Store_ItemwiseServiceRequisitionReport : System.Web.UI.Page
{
    ...
    protected void bindReport()
    {
        ...
        try
        {
            SqlCommand sc = new SqlCommand("usp_ItemWiseServiceReport", conn);
        ...
        finally
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "Store/Demad/serviceReports/ItemwiseServiceRequisitionReport.rdlc";
