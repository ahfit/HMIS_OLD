...
public partial class Store_CategorywiseServiceRequisitionReport : System.Web.UI.Page
{
    ...
    protected void bindReport()
    {
        ...
        try
        {
            SqlCommand sc = new SqlCommand("usp_CategoryWiseServiceRequisitions", conn);
        ...
        finally
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "Store/Demad/DemandReports/CategorywiseDemandRequisitionReport.rdlc";
