...
public partial class Store_ItemwiseDemandRequisitionReport : System.Web.UI.Page
{
    ...
    protected void bindReport()
    {
        ...
        try
        {
            SqlCommand sc = new SqlCommand("usp_ItemWiseRequisitionsReport", conn);
            ...
            sc.Parameters.AddWithValue("@itemcode", txtItemName.Text);
        ...
        finally
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "Store/Demad/DemandReports/ItemwiseDemandRequisitionReport.rdlc";
