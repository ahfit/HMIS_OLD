<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="SelectedDateStockReport.aspx.cs" Inherits="Store_SelectedDateStockReport" %>
...
<asp:ListItem Text="Include Zero" Value="0"></asp:ListItem>
<asp:ListItem Text="Exclude Zero" Value="1" Selected="True" ></asp:ListItem>
                        </asp:RadioButtonList>
                </td>
            </tr>
            <tr>
