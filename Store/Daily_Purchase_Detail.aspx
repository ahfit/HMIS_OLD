<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="Daily_Purchase_Detail.aspx.cs" Inherits="Store_Daily_Purchase_Detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="bxmain inner_content" style="width: 100%;">
        <h2><span>Daily Purchase Detail Report</span></h2>
        <table width="100%">
             <tr>
