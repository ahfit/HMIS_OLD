...
public partial class ItemsRecieveRequisition : System.Web.UI.Page
{
    ...
    private void ShowReport()
    {
        ...
        dt = dbm.ExecuteDataTable("uspGetItemIssueByIPOApproved", "STOREConnectionString", sp);
    ...
    protected void GridView2_PreRender(object sender, EventArgs e)
    {
        foreach (GridViewRow Row in GridView2.Rows)
        {
            ...
            HiddenField status = (HiddenField)Row.FindControl("HiddenField2");
