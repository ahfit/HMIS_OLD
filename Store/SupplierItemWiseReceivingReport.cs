...
public partial class Store_SupplierItemWiseReceivingReport : System.Web.UI.Page
{
    ...
    private void ShowReport()
    {
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("uspGetVendorWiseGRN", conn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Receive_Sub_dept_Id",ddl_SubDeptId.SelectedValue);
            cmd.Parameters.AddWithValue("@Party_Id", ddl_Manufacturer.SelectedValue);
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("SupplierItemWiseReceivingReport.rdlc");
            ReportViewer1.LocalReport.DataSources.Clear();
            ReportViewer1.LocalReport.DataSources.Add(reportDataSource);


            ReportParameter rp = new ReportParameter("ReportParameter1", Convert.ToDateTime(txtStartDate.Text).ToString("dd-MMMM-yyyy"));
            ReportParameter rp2 = new ReportParameter("ReportParameter2", Convert.ToDateTime(txtEndDate.Text).ToString("dd-MMMM-yyyy"));
