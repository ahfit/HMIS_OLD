...
public partial class Store_DateWiseGRNReport : System.Web.UI.Page
{
    ...
    protected void ShowReport()
    {
        ...
        try
        {
            ...
            string path = null;
                ...
                dt = dbMgr.ExecuteDataTable("DateWiseGRNReturn", "STOREConnectionString", sqlParam);
                 path = Server.MapPath("DateWiseGRNReport.rdlc");
