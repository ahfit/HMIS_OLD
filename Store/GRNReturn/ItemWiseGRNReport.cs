...
public partial class Store_ItemWiseGRNReport : System.Web.UI.Page
{
    ...
    protected void ShowReport()
    {
        ...
        try
        {
            ...
            string path = null;
                ...
                dt = dbMgr.ExecuteDataTable("ItemWiseGRNReturn", "STOREConnectionString", sqlParam);
                 path = Server.MapPath("ItemWiseGRNReport.rdlc");
