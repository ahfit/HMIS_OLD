<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true"
    CodeFile="~/Store/GRNReturn/DetailWiseGRNReport.cs" Inherits="Store_DetailWiseGRNReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="bxmain inner_content" style="width: 100%;">
        <h2>
            ...
            <span><asp:Label runat="server" ID="lblHeader" Text="Search Detail Wise GRN Return"></asp:Label> </span></h2>
