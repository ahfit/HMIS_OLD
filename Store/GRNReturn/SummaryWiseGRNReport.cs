...
public partial class Store_SummaryWiseGRNReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            ddlDepartment.SelectedValue = Session["SubDeptID"].ToString();
        ...
        try
        {
            ...
            string path = null;
                ...
                SqlParameter[] sqlParam = {
                    ...
                    new SqlParameter("@FromDate",Convert.ToDateTime(wdcFromDate.Value).ToString("yyyy-MM-dd")),
                                        new SqlParameter("@ToDate",Convert.ToDateTime(wdcToDate.Value).ToString("yyyy-MM-dd")),
                                        new SqlParameter("@itemcode",hfItemCode.Value), 
                                        new SqlParameter("@RequisitionNo", txtRequisitionNo.Text)};
                dt = dbMgr.ExecuteDataTable("POWiseGRNReturn", "STOREConnectionString", sqlParam);
                 path = Server.MapPath("POWiseGRNReturn.rdlc");
