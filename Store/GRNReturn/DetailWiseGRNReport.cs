...
public partial class Store_DetailWiseGRNReport : System.Web.UI.Page
{
    ...
    protected void ShowReport()
    {
        ...
        try
        {
            ...
            dt = dbMgr.ExecuteDataTable("DetailWiseGRNReturn", "STOREConnectionString", sqlParam);
            path = Server.MapPath("DetailWiseGRNReport.rdlc");
