<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true"
    CodeFile="~/Store/GRNReturn/SupplierWiseGRNReport.cs" Inherits="Store_SupplierWiseGRNReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="bxmain inner_content" style="width: 100%;">
        <h2>
            ...
            <span><asp:Label runat="server" ID="lblHeader" Text="Search Supplier Wise GRN Return"></asp:Label> </span></h2>
        <table style="width: 100%;">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DDLparty" runat="server" DataSourceID="SqlDataSourceParty"
                        DataTextField="Party_Name" DataValueField="Party_Id"   >
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSourceParty" runat="server" ConnectionString="<%$ ConnectionStrings:STOREConnectionString %>"
                        SelectCommand="SELECT 0 as Party_Id, '--All--' as  Party_Name UNION SELECT Party_Id,Party_Name
FROM parties ORDER BY  Party_Name "></asp:SqlDataSource>
