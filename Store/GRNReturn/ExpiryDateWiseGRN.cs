...
public partial class Store_ExpiryDateWiseGRN : System.Web.UI.Page
{
    ...
    private void ShowReport()
    {
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("ExpiryDateWiseGRNReturn", conn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@From_Dept_ID", ddl_SubDeptId.SelectedValue);
             
            cmd.Parameters.AddWithValue("@itemcode", txt_ItemName.Text.Trim());
            cmd.Parameters.AddWithValue("@RequisitionNo", txtPoNo.Text);
            cmd.Parameters.AddWithValue("@FromDate", hfIStartDate.Value);
            cmd.Parameters.AddWithValue("@ToDate",  hfEndDate.Value);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("ExpiryDateWiseGRN.rdlc");
            ReportViewer1.LocalReport.DataSources.Clear();
