<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/hacims_masterpage_admin.master" CodeFile="~/Store/GRN/POWiseGRN.cs" Inherits="Store_POWiseGRN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
           ...
           <h2><span>PO Wise Receiving Report</span></h2>
                <table class="style1">
                    <tr>
                        <td class="style2">
                            Department :
