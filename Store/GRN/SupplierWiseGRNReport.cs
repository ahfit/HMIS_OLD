    ...
    protected void ShowReport()
    {
        ...
        try
        {
            ...
            string path = null;
                ...
                dt = dbMgr.ExecuteDataTable("PartyWiseGRN", "STOREConnectionString", sqlParam);
                 path = Server.MapPath("PartyWiseGRN.rdlc");
    ...
    public static List<string> SearchItems(string prefixText, int count)
     {
        ...
        cmd.CommandText = "Select Item_Code,Item_Name, Party_Name From Store_Items Where Item_Name LIKE '%' + @Search + '%'";
