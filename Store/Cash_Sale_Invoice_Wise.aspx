<%@ page title="" language="C#" masterpagefile="~/hacims_masterpage_admin.master" autoeventwireup="true" inherits="Store_Cash_Sale_Invoice_Wise, App_Web_tnnmgguv" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
    ...
    <div class="bxmain inner_content" style="width: 100%;">
        ...
        <table class="style1">
            <tr>
                ...
                <td class="style3">
                    <asp:TextBox ID="txtStartDate" runat="server" TextMode="DateTime" Text=""  >
                    </asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td class="style3">
                    <asp:TextBox ID="txtEndDate" runat="server" TextMode="DateTime" Text="" >
                    </asp:TextBox>
                </td>
            </tr>
            <tr>
