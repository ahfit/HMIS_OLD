<%@ page title="" language="C#" masterpagefile="~/hacims_masterpage_admin.master" autoeventwireup="true" inherits="ItemsRecieveRequisition" 
     CodeFile="ItemsRecieveRequisition.aspx.cs" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                                     ...
                                     <div style="margin-bottom:15px" align="center">       <asp:Button ID="ButtonApprove" runat="server" Text="Receive Item(s)" 
                                           ...
                                           <asp:Button ID="ButtonRej" runat="server"  OnClick="ButtonRej_Click" Text="Reject Item(s)" />
                                     </div> 
...
<asp:HiddenField ID="HiddenFieldStore__issue_id" runat="server" />
    <asp:HiddenField ID="HiddenFieldStore__issue_Main_id" runat="server" />
        ...
        <asp:SqlDataSource ID="SDS_Approved" runat="server" 
            ...
            InsertCommand="Item_Receive_ByRequisition" 
