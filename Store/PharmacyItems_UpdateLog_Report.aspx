<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="PharmacyItems_UpdateLog_Report.aspx.cs" Inherits="PharmacyItems_UpdateLog_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="bxmain inner_content" style="width: 100%;">
        <h2><span>Items Update Log Report</span></h2>
        <table width="100%">
