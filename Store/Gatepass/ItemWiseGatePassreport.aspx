<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true"
    CodeFile="~/Store/Gatepass/ItemWiseGatePassreport.cs" Inherits="Store_ItemWiseGatePassreport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="bxmain inner_content" style="width: 100%;">
        <h2>
            ...
            <span><asp:Label runat="server" ID="lblHeader" Text="Search Item Wise Gate Pass"></asp:Label> </span></h2>
