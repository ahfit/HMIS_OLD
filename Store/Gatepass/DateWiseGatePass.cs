...
public partial class Store_DateWiseGatePass : System.Web.UI.Page
{
    ...
    protected void ShowReport()
    {
        ...
        try
        {
            ...
            string path = null;
                ...
                dt = dbMgr.ExecuteDataTable("DateWiseGatePass", "STOREConnectionString", sqlParam);
                 path = Server.MapPath("DateWiseGatePass.rdlc");
