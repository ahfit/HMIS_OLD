...
public partial class Store_CategoryWiseGatePass : System.Web.UI.Page
{
    ...
    protected void bindReport()
    {
        ...
        DataTable dt = new DataTable();
        dt = dbMgr.ExecuteDataTable("CategoryWiseGatePass", "STOREConnectionString", sqlParam);
        ReportDataSource rds = new ReportDataSource();
        rds.Name = "DataSet1";
        rds.Value = dt; 
        ReportViewer1.LocalReport.DataSources.Clear();
        ReportViewer1.LocalReport.ReportPath = Server.MapPath("CategoryWiseGatePass.rdlc");
