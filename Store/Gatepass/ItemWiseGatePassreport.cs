...
public partial class Store_ItemWiseGatePassreport : System.Web.UI.Page
{
    ...
    protected void ShowReport()
    {
        ...
        try
        {
            ...
            string path = null;
                ...
                dt = dbMgr.ExecuteDataTable("ItemWiseGatePass", "STOREConnectionString", sqlParam);
                 path = Server.MapPath("ItemWiseGatePassreport.rdlc");
