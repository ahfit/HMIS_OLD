...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-2">
                <h4><button style="background: no-repeat;box-shadow: none;border: none;font-size: 12px; font-weight: 700;color: #993366;  margin-top: -9px; height: 0px; " type="button"  data-toggle="collapse" data-target="#demo">
                 Receive Stock <i class="glyphicon glyphicon-chevron-down"></i></button></h4>
            </div>
        ...
        <table width="30%" border="0" cellspacing="0" cellpadding="0" class="tbl_form row table table-striped table-inverse">
            ...
            <tr class="col-md-12" style="visibility:hidden" >
                <td align="right" class="auto-style1" style="display:none;">Invoice No. :
                </td>
                <td>
                    <asp:TextBox ID="TextBox_Lc_No" runat="server" ForeColor="Black" Visible="false"></asp:TextBox>
                </td>
            </tr>
            
            <tr class="col-md-4">
                <td align="right" class="auto-style1">DC # / Invoice # :
                </td>
                <td>
                    <%--<asp:TextBox ID="TextBox_invoice_NO" runat="server" CssClass="input_txt" AutoPostBack="True"
                        OnTextChanged="TextBox_invoice_NO_TextChanged" BackColor="Pink" ></asp:TextBox>--%>
                    <asp:TextBox ID="TextBox_invoice_NO" style="width:11em;" runat="server" CssClass="input_txt" AutoPostBack="True"
                        OnTextChanged="TextBox_invoice_NO_TextChanged" BackColor="Pink"></asp:TextBox>
                    <asp:Button style="margin-top: 1em; padding: 1px 5px;" ID="Button_ReciveOrder" runat="server" Text="Receive Complete" OnClick="Button_ReciveOrder_Click" />
                </td>
            </tr>
            ...
            <tr class="col-md-4">
                ...
                <td>
                    ...
                    <asp:Button ID="Button2"
                        runat="server"  CssClass="btn1" style="margin-top: 1em; padding: 1px 32px;" Text="Attach" OnClick="Button2_Click" />
            ...
            <tr class="col-md-4">
                ...
                <td width="78%">
                    <asp:TextBox  style="width:11em;" ID="txtTotalRecQty" runat="server" BackColor="Pink" ></asp:TextBox> <br />
                    <asp:Button style="margin-top: 1em; padding: 1px 16px;" ID="btnReceieveAll" runat="server" OnClick="btnReceieveAll_Click" Text="Receive All" /> <br />
                   <strong> <asp:Label ID="lbl_MSG" runat="server" ForeColor="Red"></asp:Label></strong>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td valign="top">
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" style=" margin-top: 0.5em;" Width="225%"
                    DataSourceID="SqlDataSource_PO" DataKeyNames="Item_Code" OnSelectedIndexChanged="GridView2_SelectedIndexChanged"
                    OnPreRender="GridView2_PreRender" EnableModelValidation="True">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Receive Qty">
                            <ItemTemplate>
                                <asp:Label ID="LabelReceiveQty" runat="server"></asp:Label>
...
Group By Order_No,T.Item_Code,I.Item_Name"
    ...
    <div class="bxmain col-md-4 col-md-offset-1">
    ...
    <asp:SqlDataSource ID="SqlDataSourceReceiveQtySub" runat="server" ConnectionString="<%$ ConnectionStrings:STOREConnectionString %>"
        ...
        <InsertParameters>
            ...
            <asp:ControlParameter ControlID="TextBox_Receive_Qty" Name="Item_Qty" PropertyName="Text" />
            <asp:ControlParameter ControlID="TextBox_Batch" Name="BatchNo" PropertyName="Text"
                DefaultValue="Null" />
    ...
    <asp:SqlDataSource ID="SqlDataSource_PO" runat="server" ConnectionString="<%$ ConnectionStrings:STOREConnectionString %>"
        ProviderName="<%$ ConnectionStrings:STOREConnectionString.ProviderName %>" SelectCommand="SELECT Purchase_Order_Sub.Item_Code, Purchase_Order_Sub.Rate, Purchase_Order_Sub.Qty, ISNULL(Purchase_Order_Sub.DTL_Sample, '') AS DTL_Sample, Purchase_Order_Sub.Recieve_Qty, Purchase_Order_Sub.Qty - Purchase_Order_Sub.Recieve_Qty AS Balance, ISNULL(Store_Items.Drug_Category + ' ', '') + ISNULL(Store_Items.Item_Name + ' ', '') + ISNULL(Store_Items.Potency + ' ', '') + ISNULL(Store_Items.Unit + ' ', '') AS Medicine, Store_Items.Allow_Serial, Purchase_Order_Sub.QO_No, Purchase_Order_Sub.For_Customer, Purchase_Order_Sub.Order_No, Purchase_Order_Sub.Remarks, Purchase_Order_Sub.Specification, Purchase_Order_Sub.PO_ID_Sub FROM Purchase_Order_Sub INNER JOIN Store_Items ON Purchase_Order_Sub.Item_Code = Store_Items.Item_Code WHERE (Purchase_Order_Sub.PO_ID = @PO_ID)"
