...
public partial class Patient_Consumption_ReportWC : System.Web.UI.Page
{
    ...
    private void ShowReport()
    {
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("Usp_DatewiseConsumptionReportWithCost", conn);
            cmd.CommandType = CommandType.StoredProcedure;
            string S_date = WebDateChooser_SDate.Value.ToString();
            string E_date =  WebDateChooser_EDate.Value.ToString();

            cmd.Parameters.AddWithValue("@deptid", Session["subdeptID"].ToString());
            ...
            cmd.Parameters.AddWithValue("@ItemName", name);
             ...
             cmd.Parameters.AddWithValue("@patient_Type_ID", ddlpatient_cat.SelectedValue);
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Store/Patient_Consumption_ReportWC.rdlc");
    ...
    protected void bindSubdepartment()
    {
        ...
        SqlParameter[] sqlParam = { new SqlParameter("@deptID", DropDownList1.SelectedValue) };
