<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" Inherits="Store_PendingDemands"
    CodeFile="~/Store/Purchase/PendingDemands.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
      ...
      <div class="bxmain inner_content" style="width: 100%;">
        <h2>
            ...
            <span><asp:Label runat="server" ID="lblHeader" Text="Pending Requests"></asp:Label> </span></h2>
