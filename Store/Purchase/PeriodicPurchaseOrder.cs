...
public partial class Store_PeriodicPurchaseOrder : System.Web.UI.Page
{
    ...
    protected void ShowReport()
    {
        ...
        try
        {
            ...
            dt = dbMgr.ExecuteDataTable("PeriodicPurchaseOrder", "STOREConnectionString", sqlParam);
            path = Server.MapPath("PeriodicPurchaseOrder.rdlc");
