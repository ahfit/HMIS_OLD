...
public partial class Store_PendingPurchaseOrder : System.Web.UI.Page
{
    ...
    protected void ShowReport()
    {
        ...
        try
        {
            ...
            dt = dbMgr.ExecuteDataTable("PendingPurchaseOrder", "STOREConnectionString", sqlParam);
            path = Server.MapPath("PendingPurchaseOrder.rdlc");
