<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="~/Store/Purchase/CategoryWisePurchaseOrder.cs" Inherits="Store_CategoryWisePurchaseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="bxmain inner_content" style="width: 100%; margin-bottom: 10px;">
        <h2><span>Category Wise Purchase Order</span></h2>
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="tbl_form" width="100%">
            ...
            <tr>
                ...
                <td align="left" width="60%">
                   <asp:DropDownList ID="DropDownList_modeof_payment" runat="server" Width="200px"  >
