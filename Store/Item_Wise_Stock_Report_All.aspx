<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/hacims_masterpage_admin.master" CodeFile="Item_Wise_Stock_Report_All.aspx.cs" Inherits="Store_Item_Wise_Stock_Report_All" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="bxmain inner_content" style="width: 100%;">
        <h2><span>Items Par Level And Inventory Report</span></h2>

        <table class="style1">

                <tr>

                 <td class="style2">Items Of :</td>
                <td class="style3" >
                    <asp:DropDownList ID="ddlStore" runat="server"></asp:DropDownList></td>

                    <td class="style2">Department <strong> :</strong></td>
                <td class="style3">
        ...
        <table class="style1">
            <tr>
                <td class="style2" >Sub Department :
                    <asp:CheckBox ID="chkSelect" runat="server" OnCheckedChanged="chkSelect_CheckedChanged" Checked="true" AutoPostBack="true"/>
                </td>
                <td >
                    <asp:DropDownList ID="ddlSubDepartment" runat="server" Visible="false"></asp:DropDownList>
                    <div style="height:100px; overflow-y:scroll; background-color:white;">

                    <asp:CheckBoxList ID="chklstSubDepartments" runat="server"  RepeatDirection="Horizontal" RepeatColumns="5"></asp:CheckBoxList>
                </div>
                </td>
            </tr>
            </table>
