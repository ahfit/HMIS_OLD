<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="Pharmacy_Dead_Item_for_Pharamacist.aspx.cs" Inherits="Store_Pharmacy_Dead_Item_for_Pharamacist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="bxmain inner_content" style="width: 100%; margin-bottom: 10px;">
        <h2><span>Pharmacy Dead Items for Pharamacist</span></h2>
...
<Columns>
    ...
    <asp:TemplateField HeaderText="Item Name">
            <ItemTemplate>
            <asp:Label ID="lblmainItem" Text='<%# Bind("Item_Name") %>' runat="server" />
        </ItemTemplate>
    </asp:TemplateField>
    <%--<asp:TemplateField HeaderText="Batch No">
            <ItemTemplate>
            <asp:Label ID="BatchNo" Text='<%# Bind("BatchNo") %>' runat="server" />
        </ItemTemplate>
    </asp:TemplateField>--%>
