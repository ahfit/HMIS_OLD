...
public partial class Pharmacy_Slow_Moving_Item_for_Pharamacist : System.Web.UI.Page
{
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=SlowMoving.xls");
        Response.Charset = "";
    ...
    private void bindGrid()
    {
        ...
        dt = dbMgr.ExecuteDataTable("PharmacySlow_Item_for_Pharamacist", "STOREConnectionString", sqlParam);
