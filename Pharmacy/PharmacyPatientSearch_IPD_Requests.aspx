<%@ page language="VB" autoeventwireup="false" masterpagefile="~/hacims_masterpage_admin.master" 
    CodeFile="PharmacyPatientSearch_IPD_Requests.aspx.vb" inherits="Pharmacy_PharmacyPatientSearch_IPD_Requests"%>
...
<asp:GridView ID="GridViewSearch" runat="server" AllowPaging="True"
                 Width="100%" EmptyDataText="Record Found" PageSize="500" AutoGenerateColumns="false" >
