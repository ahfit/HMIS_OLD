<%@ page language="VB" autoeventwireup="false" masterpagefile="~/hacims_masterpage_admin.master" 
    CodeFile="PharmacyPatientSearch_IPD_Requests_ForCheck.aspx.vb" inherits="PharmacyPatientSearch_IPD_Requests_ForCheck"%>
...
<asp:GridView ID="GridViewSearch" runat="server" AllowPaging="True"
                 Width="100%" EmptyDataText="Record Found" PageSize="500" AutoGenerateColumns="false" >ssssss
              ...
              <Columns>
                  ...
                  <asp:ButtonField CommandName="View" Text="Medicine" />
                  <asp:ButtonField CommandName="Services" Text="Services" Visible="False"/>
                  <asp:ButtonField CommandName="IPDSLIP" Text="IPD SLIP" Visible="False"/>
                   <asp:ButtonField CommandName="PT_Change_Room" Text="Change Room"  Visible="False"/>

                  <asp:TemplateField HeaderText="Request ID" SortExpression="IB_ID" >
                      <ItemTemplate>
                          <asp:Label ID="lblRequestId" runat="server" Text='<%# Eval("IB_ID")%>'></asp:Label>
                          <asp:HiddenField ID="HfIBID" runat="server" Value='<%# Eval("IB_ID")%>'></asp:HiddenField>
                      </ItemTemplate>
                  </asp:TemplateField>
                 
                   <asp:TemplateField HeaderText="MR #" SortExpression="RegNo" >
                      <ItemTemplate>
                          <asp:Label ID="lblRegNo" runat="server" Text='<%# Eval("Registration No")%>'></asp:Label>
                      </ItemTemplate>
                  </asp:TemplateField>
                 
                  <asp:TemplateField HeaderText="Visit #" SortExpression="VisitNo">
                      <ItemTemplate>
                          <asp:Label ID="lblVisitNo" runat="server" Text='<%# Eval("Visit No")%>'></asp:Label>
                      </ItemTemplate>
                  </asp:TemplateField>
