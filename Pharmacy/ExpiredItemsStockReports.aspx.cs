...
public partial class ExpiredItemsStockReports : System.Web.UI.Page
{
    ...
    private void ShowReport()
    {
        ...
        try
        {
            ...
            DataTable dt = new DataTable();
            dt = dbMgr.ExecuteDataTable("usp_ExpiredItemsStock", "STOREConnectionString", sqlParam);
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("ExpiredItemsStockReports.rdlc");
            ReportViewer1.LocalReport.DataSources.Clear();
