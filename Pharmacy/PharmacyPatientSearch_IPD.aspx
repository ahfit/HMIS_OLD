<%@ page language="VB" autoeventwireup="false" masterpagefile="~/hacims_masterpage_admin.master" CodeFile="PharmacyPatientSearch_IPD.aspx.vb" inherits="Patient_Billing_Pharmacypatientsearch_IPD"%>
...
<asp:GridView ID="GridViewSearch" runat="server" AllowPaging="True"
              ...
              <Columns>
                  ...
                  <asp:ButtonField CommandName="IPDSLIP" Text="IPD SLIP" />
