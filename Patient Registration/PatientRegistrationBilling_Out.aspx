                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="auto-style2">
                                ...
                                <asp:TextBox ID="txtRegistrationNo" TabIndex="11" runat="server"></asp:TextBox></td>                          
                              
                                Mobile #:
                           
                                    

                                 <asp:TextBox ID="TextBoxMobile" TabIndex="11" runat="server" MaxLength="11" 
                ...
                <div class="bxmain" style="width: 99%; margin-bottom: 4px;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr class="rowStyle">
                            ...
                            <td>
                                <asp:RadioButtonList ID="RBLprefix" TabIndex="3" runat="server" RepeatLayout="Flow"
                                    RepeatDirection="Horizontal" Style="font-size:12px">
                        ...
                        <tr class="rowStyle">
                            ...
                            <td class="heading" align="right" colspan="2">
                                &nbsp;CNIC #:</td>
                            
                            <td>
                                
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="textboxmcode"
                                                  ValidationGroup="s"  ErrorMessage="*Please enter CNIC #:"></asp:RequiredFieldValidator>
                                <asp:TextBox AccessKey="n" ID="TextBox_CNIC_No" Style="background-color: #f9dde2;" runat="server" MaxLength="15" TabIndex="7" onkeypress= "txtChange(this)"></asp:TextBox>
                                <asp:HiddenField
                                    ID="HiddenField_Cnic_flag" runat="server" /> <span style="font-size: 10pt; color: #d92542">*</span>
                        ...
                        <tr class="rowStyle">
                            ...
                            <td style="width:215px;">
                                <asp:TextBox ID="textboxplname" TabIndex="12" runat="server" MaxLength="20" SkinID="captxt" Visible="true" 
                            ...
                            <td style="min-width: 215px;">
                                <igtxt:WebDateTimeEdit ID="WebDateTimeEdit_DOB" TabIndex="15" runat="server" Width="85px"
                                ...
                                <asp:DropDownList ID="DropDownListBIndicator" TabIndex="10" runat="server" Width="70px"
                                    AccessKey="y">
                        ...
                        <tr class="rowStyle">
                            ...
                            <td style="min-width: 215px;">
                                <asp:DropDownList ID="sex" TabIndex="16" runat="server" DataSourceID="SexSource"
    ...
    DataValueField="Religion_ID" AccessKey="g" Visible="False">
                        ...
                        <tr class="rowStyle">
                            <td class="heading">
                                &nbsp;First Name :</td>
                            <td colspan="2">
                                <asp:TextBox ID="textboxrfname" TabIndex="5" Style="background-color: #f9dde2;"
                        ...
                        <tr class="rowStyle">
                            <td class="heading" style="width: 80px;">
                                Address 1:</td>
                            <td colspan="4">
                                <asp:TextBox ID="txtAddress" TabIndex="13" Width="520px" runat="server" SkinID="captxt"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="heading">
                                Email :</td>
                            <td colspan="4">
                                <asp:TextBox ID="txtEmailAddress" TabIndex="14" Width="300px" runat="server" MaxLength="50" TextMode="Email"></asp:TextBox>
                                &nbsp;</td>
                ...
                <div class="bxmain" style="width: 99%; margin-bottom: 4px;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr class="rowStyle">
                            <td class="heading" width="15%" style="height: 42px">
                                Department :
                            </td>
                            <td colspan="3" style="height: 42px">
                                <asp:DropDownList AccessKey="d" ID="DDLDepartment" runat="server"
                                    DataSourceID="SqlDataSourceDepartment" Visible="False" DataTextField="Dept_Name"
                                    DataValueField="Dept_ID" Width="140px">
                                    <asp:ListItem Value="6">Emergency</asp:ListItem>
                                </asp:DropDownList>
                                <asp:DropDownList ID="DropDownList1" runat="server" TabIndex="14"
                                ...
                                Refer Doctor :
                                            ...
                                            <asp:TextBox ID="TextBox_refer_other" runat="server" Width="150px" hight="20px" TabIndex="16"></asp:TextBox>
                                      </td> 
                                <b style="display:none">Room:</b><asp:TextBox Style="display:none" ID="TextBox_Room_No" runat="server" TabIndex="16" Width="30px"></asp:TextBox>
                        ...
                        <tr class="rowStyle">
                            <td colspan="4" style="height: 44px">
                                <div style="width: 90%; margin: auto;">
                                    <asp:RadioButtonList ID="rblPatientType_Sub" TabIndex="16" runat="server" AutoPostBack="True"
                                                ...
                                                <asp:Panel ID="pnlPanelPatient" runat="server" Visible="false" Width="100%">
                                                    <table border="0" cellpadding="0" cellspacing="0" class="tbl_form" width="100%">
                                                        ...
                                                        <tr ID="td_Insurer" runat="Server" visible="False">
                                                            ...
                                                            <td>
                                                                <asp:Label ID="LbL1_Mg" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                                                <asp:DropDownList ID="DropDownList_Parties" runat="server" AutoPostBack="True" 
                                                                    ...
                                                                    DataValueField="Party_Id" OnSelectedIndexChanged="DropDownList_Parties_SelectedIndexChanged">
                                                                </asp:DropDownList>
...
WHERE     (Patient_Billing_Party.Patient_Type_Id = @Party_Type_Id)">
                        ...
                        <tr >
                            ...
                            <td>
                                <asp:DropDownList ID="ddlPatientType" TabIndex="17" runat="server" >
                ...
                <div class="bxmain" style="width: 99%; margin-bottom: 4px; text-align: center;">
                    ...
                    <asp:Panel ID="pnlPaymentButton" runat="server">
                        <asp:Button ID="btnMakePayment" 
                            ...
                            runat="server" 
                            Text="Save & Forward to Make Payment" TabIndex="10" 
                            >
                        </asp:Button>
                    </asp:Panel>
                </div>
                                    ...
                                    <ItemTemplate>
                                        <div style="width: 90%; margin: auto; margin-top: 2px;">
                                            ...
                                            <div style="float: right;">
                                                ...
                                                <asp:TextBox ID="TextBox_Amount" runat="server" Text='<%# Eval("S_Amount") %>' Width="50px" Enabled= '<%# Eval("Edit_Status") %>'
                                                   designer:wfdid="w4">
                                                </asp:TextBox>
                                            </div>
                                        </div>
    ...
    <asp:SqlDataSource ID="SqlDataSource_For_Grid" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
        ProviderName="<%$ ConnectionStrings:Basic_Data_ConnectionString.ProviderName %>"
        CancelSelectOnNullParameter="False" SelectCommand="get_Services_Walkin" InsertCommand="Insert_Patient_services"
    ...
    <asp:SqlDataSource ID="SqlDataSource_Packages" runat="server" ConnectionString="<%$ ConnectionStrings:Basic_Data_ConnectionString %>"
        ProviderName="<%$ ConnectionStrings:Basic_Data_ConnectionString.ProviderName %>"
        SelectCommand="SELECT '0' AS Asc_id, ' All' AS Asc_Name UNION SELECT CONVERT (varchar, Asc_id) AS Asc_id, Asc_Name FROM Admin_Service_Category ORDER BY Asc_Name">
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="SqlDataSourceUpdate" runat="server" ConnectionString="<%$ ConnectionStrings:Reg_ConnectionString %>"
        ...
        <UpdateParameters>
           ...
           <%-- <asp:Parameter DefaultValue="0" Name="Email_address" Type="String" />--%>
            <asp:ControlParameter ControlID="txtEmailAddress" Name="Email_address" PropertyName="Text"/>
