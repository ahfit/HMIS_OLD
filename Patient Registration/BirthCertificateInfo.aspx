...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="diagnosis_list">
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBoxMRNO" runat="server" MaxLength="18"></asp:TextBox>
                                
                <asp:Button ID="btn_Update" runat="server" OnClick="btn_Update_Click" Text="Search" />
                                
                <asp:Label ID="Label2" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                          <a href="../Patient Billing/BirthCertificateInfo.aspx">Edit</a>      
            </td>
        </tr>
        <tr>
            ...
            <td align="right" colspan="2">
                ...
                <asp:GridView ID="GridViewBirthCertificateInfo" runat="server" AutoGenerateColumns="False" Width="100%">
                    <Columns>
                      ...
                      <ItemTemplate>
                          <asp:Label ID="lblProcedureFor" runat="server" Text='<%#Bind("PlaceofBirth") %>'></asp:Label>
                      </ItemTemplate>
                  </asp:TemplateField>
