<%@ Page Language="VB" AutoEventWireup="false" CodeFile="~/Patient Registration/PatientEdit.aspx.vb" MasterPageFile="~/hacims_masterpage_admin.master" Inherits="Patient_Registration_PatientEdit" %>
        ...
        <ContentTemplate>--%>
            <asp:GridView ID="GridViewSearch" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkbNewVisit" runat="server" OnClick="lnkbNewVisit_Click" Visible="false">OPD Slip</asp:LinkButton>&nbsp;&nbsp;
                                        <asp:LinkButton ID="lnkbNewAdmission" runat="server" ToolTip="Admission Slip" OnClick="lnkbNewAdmission_Click" Visible="false">Admission</asp:LinkButton>&nbsp;&nbsp;
