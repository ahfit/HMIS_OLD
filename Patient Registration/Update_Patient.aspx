<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Update_Patient.aspx.vb"  MasterPageFile="~/hacims_masterpage_admin.master" Inherits="Update_Patient" %>
...
<h1 class="h1"><span>General Information</span></h1>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbl_form">
        <tr>
                ...
                <td width="35%"  ><asp:RadioButtonList ID="RBLprefix" runat="server"  RepeatLayout="Flow" RepeatDirection="Horizontal"  TabIndex="6">
              ...
              <tr>
                <td  align="right" >First Name :</td>
                        <td  ><asp:TextBox AccessKey="n"  ID="textboxpfname" style="background-color:
                        #f9dde2; text-transform:uppercase; " runat="server" TabIndex="7" MaxLength="12" SkinId="captxt"></asp:TextBox><span class="marks">*</span>          
                        ...
                        <td  align="right" >First Name :</td>
                        <td ><asp:TextBox   ID="textboxrfname" style="background-color:#f9dde2; text-transform:uppercase; " MaxLength="12" runat="server" TabIndex="10"  SkinId="captxt"  ></asp:TextBox><span class="marks">*
...
<li><h1 class="h1"><span>Address Information</span></h1></li>  
<li>  
...
<TABLE class="tbl_form" cellSpacing=0 cellPadding=0 width="100%" border=0>
    ...
    <TR>
      <TD align="right" >
          Contact # :</TD>
      <TD>
           <asp:TextBox id="textboxmcode" tabIndex=21 runat="server"   ></asp:TextBox><asp:SqlDataSource ID="SqlDataSourceUpdate" runat="server" ConnectionString="<%$ ConnectionStrings:Reg_ConnectionString %>"
          ...
          <UpdateParameters>
            ...
            <asp:ControlParameter ControlID="district" Name="DistrictCode" PropertyName="SelectedValue"
                    Type="Int32" />
            <asp:ControlParameter ControlID="tehsil" Name="TehsilCode" PropertyName="SelectedValue"
                    Type="Int32" />
            <asp:ControlParameter ControlID="textboxzipcode" Name="Zipcode" PropertyName="Text"
                    Type="Decimal" />
            <asp:ControlParameter ControlID="textboxstreetaddress" Name="StreetAddress" PropertyName="Text"
                    Type="String" />
            <asp:ControlParameter ControlID="textboxcolony" Name="Colony" PropertyName="Text"
                    Type="String" />
            <asp:ControlParameter ControlID="HiddenField_phone_no" Name="HomePhone" PropertyName="Value"
                    Type="String" />
            ...
            <asp:ControlParameter ControlID="TextBox_passport_No" Name="Passport_No" PropertyName="Text"
                    Type="Int32" />
            <asp:ControlParameter ControlID="RadioButtonList_Patient_Type" Name="Patient_Type"
                    PropertyName="SelectedValue" Type="String" />
            <asp:ControlParameter ControlID="TextBox_Email_Address" Name="Email_address" PropertyName="Text"
                    Type="String" />
...
WHERE (districtCode =@districtCode)" 
    ...
    <TR>
      ...
      <TD ><asp:TextBox ID="TextBox_Email_Address" runat="server"  TabIndex="27"></asp:TextBox> 
    ...
    <TR>
      ...
      <TD >  <asp:TextBox id="TextBox_passport_No" tabIndex=28 runat="server" ></asp:TextBox> 
  ...
  <tr>
    ...
    <td><asp:TextBox ID="textboxpfname_ot" runat="server" BackColor="White" 
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator10" runat="server"
            ...
            ValidationExpression="[A-Za-z]*"></asp:RegularExpressionValidator><span style="font-size: 10pt; color: #d92542"></span></td>
  </tr>
  <tr>
    <td align="right">Middle Name :</td>
