...
public partial class DoctorShare_DoctorWisePatientService : System.Web.UI.Page
{
    ...
    private void loadDepartment()
    {
        ...
        SqlConnection con = new SqlConnection(_conStr);
        SqlCommand cmd = new SqlCommand("SELECT   0 as Dept_ID, '--All--' Dept_Name  UNION select Department.Dept_ID, Dept_Name FROM  Department INNER JOIN SubDepartment ON Department.Dept_ID = SubDepartment.Dept_Id where SubDepartment.SubDept_Type=1 ORDER BY Dept_Name", con);
    ...
    private void LoadReport()
    {
        ...
        ReportViewer1.LocalReport.ReportPath = "DoctorShare/DoctorWisePatientReport.rdlc";
