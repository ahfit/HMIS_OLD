<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Doctor_Main_Page_New.aspx.vb"
    MasterPageFile="~/hacims_masterpage_admin.master" Inherits="Doctor_Main_Page_New" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="border: #F7F7F7 solid 1px; background: #e8e9df; border-radius: 4px; width: 100%; padding: 5px; margin-bottom: 10px; padding-left: 25px;">
        <asp:TextBox ID="txtMrNo" runat="server" Placeholder="MR #: ##-##-##" Text=""></asp:TextBox>
        ...
        <asp:DropDownList ID="ddlSubDept" runat="server" DataTextField="SubDept_Name" DataValueField="SubDept_Id"></asp:DropDownList>
        <asp:DropDownList ID="ddlDoctors" runat="server" CssClass="dropbox" DataSourceID="SqlDataSource_Employee"
            Width="200px" DataTextField="Employee Name" DataValueField="EmpID" >
        </asp:DropDownList>

        <asp:DropDownList ID="ddlCheckUpStatus" runat="server" Visible="false">
            <asp:ListItem Text="All" Value="0"></asp:ListItem>
            <asp:ListItem Text="Assesment" Value="1"></asp:ListItem>
            <asp:ListItem Text="Lab" Value="2"></asp:ListItem>
            <asp:ListItem Text="Waiting" Value="3"></asp:ListItem>
            <asp:ListItem Text="CheckUp Complete" Value="4"></asp:ListItem>
    ...
    <asp:GridView CssClass="Grid_1" ID="gvdLoadData" runat="server" AutoGenerateColumns="False" Width="100%">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Patient Name">
                <ItemTemplate>                    
                    <asp:LinkButton ID="lnkbtnPatient" OnClick="lnkbtnPatient_Click"  ToolTip='<%# Eval("RegNo") %>' CommandArgument='<%# Eval("Yearly_No") %>' runat="server" Text='<%# Eval("patient") %>'></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
             <asp:BoundField HeaderText="Relation" DataField="Relation" />
            <asp:BoundField HeaderText="Relation Name" DataField="RelationName" />
            <asp:BoundField HeaderText="Visit Type" DataField="VisitType" Visible="False" />                       
           ...
           <%-- <asp:TemplateField HeaderText="Seen">                
                <ItemTemplate>
                    ...
                    <asp:Image ID="imgLabConducted" runat="server" ImageUrl="images/waiting.jpg" Visible="false" width="30px"/>
    ...
    <asp:SqlDataSource ID="SqlDataSource_Employee" runat="server" ConnectionString="<%$ ConnectionStrings:BasicDataConnectionString %>"
        ...
        <SelectParameters>
            <asp:ControlParameter Name="Dept_type" ControlID="ddlSubDept" Type="Int32" PropertyName="SelectedValue" />
            <%--<asp:SessionParameter Name="Dept_type" SessionField="SubDeptID" Type="Int32" />--%>
