<%@ page language="VB" masterpagefile="~/hacims_masterpage_admin.master" autoeventwireup="false" inherits="Pathology_Insert_Pathology_Templates, App_Web_c1jflpj3" title="Untitled Page" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
    ...
    <table style="width: 1142px">
        <tr>
            ...
            <td style="width: 100px; height: 22px">
                Template Name :</td>
            <td style="width: 100px; height: 22px">
                <asp:TextBox ID="TextBox_Template_Name" runat="server" Width="250px"></asp:TextBox></td>
        </tr>
        <tr>
