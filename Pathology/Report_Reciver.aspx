<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_Reciver.aspx.vb"
    MasterPageFile="~/hacims_masterpage_admin.master" Inherits="Report_Reciver" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource_Grid" runat="server" ConnectionString="<%$ ConnectionStrings:Path_ConnectionString %>"
        ProviderName="<%$ ConnectionStrings:Path_ConnectionString.ProviderName %>" SelectCommand="SELECT DISTINCT  PRD.Yearly_No AS YearlyNo, PRD.Reg_no AS RegNo, Pt.PFName, Pt.PMName, Pt.PLName, Pt.Relation, ISNULL(Pt.RFName + ' ', '') + ISNULL(Pt.RMName + ' ', '') + ISNULL(Pt.RLName + ' ', '') AS PatientName, TS.Status, 
                         CONVERT(varchar, PRD.Sample_Collection_Date, 107) AS Date_Time, TG.TGName, TG.TGID, PRD.Main_ID, Dp.Dept_Name, TB.TB_Name, TB.TB_ID, ISNULL(SS.Status, 'Paid') AS P_status,
                        1 AS Chk_vis
...
">
    ...
    <asp:HiddenField ID="HfEmailAddress" runat="server" Value=""/>
    <asp:HiddenField ID="HfReportAddress" runat="server" Value=""/>
</asp:Content>
