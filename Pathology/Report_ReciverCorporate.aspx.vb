...
Partial Class Report_ReciverCorporate
        ...
        If GridView1.Rows.Count > 0 Then
            ...
            For i As Integer = 0 To GridView1.Rows.Count - 1
                ...
                If chk.Checked = True Then
                    ...
                    Using mailMessage As New MailMessage(New MailAddress("afzaalsahi81@gmail.com"), New MailAddress("afzaalsahi81@gmail.com"))
                        mailMessage.Body = "Hello"
                        mailMessage.Subject = "ok"
                        Try
                            Dim SmtpServer As New SmtpClient()
                            SmtpServer.Credentials = New System.Net.NetworkCredential("afzaalsahi81@gmail.com", "falisahia123")
                            SmtpServer.Port = 587
                            ...
                            Mail.From = New MailAddress("afzaalsahi81@gmail.com", "Afzaal", System.Text.Encoding.UTF8)
                            ...
                            Mail.To.Add("afzaalsahi81@gmail.com")
                            Mail.DeliveryNotificationOptions = DeliveryNotificationOptions.OnFailure
                            Mail.ReplyTo = New MailAddress("afzaalsahi81@gmail.com")
                            Dim client As New SmtpClient("smtp.gmail.com")
                            client.Credentials = New System.Net.NetworkCredential("afzaalsahi81@gmail.com", "falisahia123")
    ...
    Private Sub Send_Email()
        Dim From As String = "lab-report@alkhidmat.com"
        Dim ToEmail As String = txtEmail.Text
        Dim password As String = "abc123"
        Try
            Dim mail As New System.Net.Mail.MailMessage()
            'Dim client As New SmtpClient("smtp.gmail.com")
            Dim client As New SmtpClient("alkhidmat.com")
            mail.[To].Add(ToEmail)
            ' Dim at As Attachment = New Attachment("D:\Application\App\Pathology\Email\TestReport.pdf")
            Dim at As Attachment = New Attachment("D:\Application\App\Pathology\Email\TestReport.pdf")

            mail.Attachments.Add(at)
            mail.From = New MailAddress(From, "Alkhidmat Fareeda Yaqoob Hospital", System.Text.Encoding.UTF8)
            mail.Subject = "Test Result Report_" + Date.Now.ToString("dd-MMM-yyyy")
            mail.SubjectEncoding = System.Text.Encoding.UTF8
            mail.Body = "Email For Test Report.<br/><br/>Dear Sir /Madam , <br /><br />Kindly find the attachments." + "<br /> Regards, <br /> Alkhidmat Fareeda Yaqoob Hospital."
            ...
            Try
                ...
                File.Delete("D:\Application\App\Pathology\Email\TestReport.pdf")
            Catch ex As Exception
    ...
    Sub Load_Crystal_Report(ByVal tGId As Integer, ByVal tBId As Integer, ByVal tBName As String)
        ...
        Try
            ...
            End Try
            Dim fName As String = "D:\Application\App\Pathology\Email\TestReport.pdf"
