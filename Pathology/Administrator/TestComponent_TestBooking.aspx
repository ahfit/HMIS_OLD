<%@ page language="VB" autoeventwireup="false" masterpagefile="~/hacims_masterpage_admin.master" inherits="Pathology_TestComponent_TestBooking, App_Web_plqsd34j" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
<table border="0" cellpadding="0" cellspacing="0" class="tbl_form" width="100%" >
                          ...
                          <tr>
                            <td width="25%" align="right" >Group Name : </td>
                              ...
                              DataTextField="TGName" DataValueField="TGID" ID="DropDownListGName" runat="server" 
                                      DataSourceID="SqlDataSourceGName" Height="49px" Width="291px"> </asp:DropDownList>
</td>
    ...
    <tr>
        <td align="right" >
            &nbsp;</td>
        <td >
            <asp:DropDownList ID="DropDownListTestBooking" runat="server"
                                      AutoPostBack="True"  DataSourceID="SqlDataSourceGNameSave"
...
<asp:SqlDataSource ID="SqlDataSourceGNameSave" runat="server" ConnectionString="<%$ ConnectionStrings:Admin_Path_ConnStr %>"
        ...
        SelectCommand="SELECT TB_ID, TB_Name FROM Test_Booking WHERE (MG_ID = @MG_Id)">
                            <InsertParameters>
                            ...
                            <SelectParameters>
                                <asp:ControlParameter ControlID="DropDownListGName" Name="MG_Id" 
                    ...
                    DataSourceID="SqlDataSourceGrid" allowpaging="True" PageSize="200"><Columns>
<asp:BoundField DataField="TGName" HeaderText="Group Name" ReadOnly="True" SortExpression="TGName" Visible="False">
<ControlStyle Width="100px"></ControlStyle>

<ItemStyle Width="100px"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="TSGName" HeaderText="Sub Group Name" ReadOnly="True" SortExpression="TSGName" Visible="False">
<ControlStyle Width="100px"></ControlStyle>
</asp:BoundField>
...
<asp:TemplateField HeaderText="Refrence Values Male" SortExpression="TC_Range_Unit"><EditItemTemplate>
                                        <asp:TextBox ID="TextBox_R_Values" runat="server" Width="236px" 
                                            Text='<%# Bind("TC_Range_Unit") %>' TextMode="MultiLine"></asp:TextBox>
...
<asp:BoundField DataField="TCID" HeaderText="TCID" ReadOnly="True" InsertVisible="False" SortExpression="TCID" Visible="False">
...
<PagerStyle CssClass="GridPager" />
                    ...
                    SelectCommand="SELECT     TestGroup.TGName, TestSubGroup.TSGName, Test.TestName, TestComponent.ComponentName, TestComponent.TCID, TestMUnit.TUnitName, 
                      TestComponent.e_Field_Type, TestMUnit.TMUnitID, TestComponent.TC_Range_Unit, TestComponent.Priority, TestComponent.MaxLength, TestComponent.Min_Value, 
                      TestComponent.Max_Value, TestComponent.Critical_Values, TestComponent.TC_Range_Unit_Female
FROM         Test_Booking INNER JOIN
                      Test_Services ON Test_Booking.TB_ID = Test_Services.TB_ID INNER JOIN
                      Test INNER JOIN
                      ...
                      TestMUnit ON TestComponent.TMUnitID = TestMUnit.TMUnitID ON Test_Services.Test_ID = TestComponent.TID
WHERE     (Test.TGID = @TGID) AND (Test_Booking.TB_ID= @TB_ID)
order by TestComponent.Priority" 
        ProviderName="<%$ ConnectionStrings:Admin_Path_ConnStr.ProviderName %>" 
        ...
        UpdateCommand="UPDATE TestComponent SET ComponentName = @ComponentName, TMUnitID = @TMUnitID, e_Field_Type = @e_Field_Type, TC_Range_Unit = @TC_Range_Unit, Priority = @Priority, MaxLength = @MaxLength, Min_Value = @Min_Value, Max_Value = @Max_Value, Critical_Values = @Critical_Values,TC_Range_Unit_Female=@TC_Range_Unit_Female                  WHERE (TCID = @TCID)">
                            <SelectParameters>
                              <asp:ControlParameter ControlID="DropDownListGName" Name="TGID" PropertyName="SelectedValue" />
                                <asp:ControlParameter ControlID="DropDownListTestBooking" Name="TB_ID" 
                                    PropertyName="SelectedValue" />
                            </SelectParameters>
                              <DeleteParameters>
