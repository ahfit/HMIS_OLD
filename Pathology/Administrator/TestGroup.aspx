<%@ page language="VB" autoeventwireup="false" masterpagefile="~/hacims_masterpage_admin.master" inherits="TestGroup, App_Web_plqsd34j" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbl_form"  >
                          ...
                          <tr>
                            ...
                            <td   ><asp:TextBox ID="TextBoxFee" runat="server" CssClass="input_txt"  Width="100px" ></asp:TextBox></td>
                          </tr>
                          <tr>
                            <td align="right"   >&nbsp;</td>
                            <td   ><asp:Button  ID="Save" runat="server" Text="Save" /></td>
                          </tr>
                        </table>
</div><br />
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="TGID"
                    DataSourceID="SqlDataSource1" Width="100%" AllowPaging="True">
                          ...
                          <RowStyle CssClass="GridItem" /><PagerStyle CssClass="GridPager"  />
