<%@ page title="" language="C#" masterpagefile="~/hacims_masterpage_admin.master" autoeventwireup="true" inherits="Pathology_MapAdminServices, App_Web_dwve4450" enableEventValidation="false" theme="theme_hacims" viewStateEncryptionMode="Never" maintainScrollPositionOnPostBack="true" %>
               ...
               <Columns>
                   ...
                   <asp:TemplateField HeaderText="Specimen">
                       <ItemTemplate>
                           ...
                           <asp:TextBox ID="txtboxTBName" runat="server" Text='<%# Bind("Specimen_Required_By_Test") %>'></asp:TextBox>
                       </ItemTemplate>
                   </asp:TemplateField>
