...
Partial Class Pathology_Patient_Sample
    ...
    End Sub
    Protected Sub OnSelectedValueChanged()
        Dim message As String = ddPrinterLocation.SelectedItem.Value
        'Create a Cookie with a suitable Key.
        Dim nameCookie As New HttpCookie("Name")

        'Set the Cookie value.
        nameCookie.Values("Name") = message
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Dim printer As String = Session("printerLocation")
            'Dim printer As String = If(nameCookie IsNot Nothing, nameCookie.Value.Split("="c)(1), "undefined")
            'ClientScript.RegisterStartupScript(Me.[GetType](), "alert", (Convert.ToString("alert('") & printer) + "');", True)
            'ddPrinterLocation.SelectedValue = printer
            'ddPrinterLocation.SelectedItem.Text = printer
