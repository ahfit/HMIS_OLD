<%@ Page Title="" Language="C#" MasterPageFile="~/hacims_masterpage_admin.master" AutoEventWireup="true" CodeFile="PatientTestConductedRepoer.aspx.cs" Inherits="Pathology_PatientTestConductedRepoer" %>
...
order by Party_Name ">
                    ...
                    <td colspan="2" align="center" style="padding-top:20px">
                        <asp:Button ID="btnSearch" OnClick="btnSearch_Click" runat="server" Text="View Report"  
                           ...
                           <td colspan="2" align="center" style="padding-top:20px">
                        <asp:Button ID="btnDepartmentView" runat="server" Text="Department Count"  
