...
public partial class Pathology_LabRegisterReport : System.Web.UI.Page
{
    ...
    protected void ShowReport()
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("uspLabRegister", conn);
            ...
            //cmd.Parameters.AddWithValue("@Status", DDLServiceStatus.SelectedItem.Text.Trim());
        ...
        finally
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Pathology/LabRegisterReport.rdlc");
