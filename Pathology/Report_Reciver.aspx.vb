...
Partial Class Report_Reciver
    ...
    Protected Sub ButtonSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonSave.Click
        Try
            ...
            If (HfEmailAddress.Value <> "") Then
                Send_Email(HfEmailAddress.Value)
            End If
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        DropDownList_Status.SelectedValue = 6
    End Sub
    ...
    Protected Sub btnSend_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSend.Click
        ...
        '            Using mailMessage As New MailMessage(New MailAddress("qdeer.ahmad@gmail.com"), New MailAddress("qdeer.ahmad@gmail.com"))
        '                mailMessage.Body = "Hello"
        '                mailMessage.Subject = "ok"
        '                Try
        '                    Dim SmtpServer As New SmtpClient()
        '                    SmtpServer.Credentials = New System.Net.NetworkCredential("qdeer.ahmad@gmail.com", "qdeer.ahmad@12345")
        '                    SmtpServer.Port = 587
        ...
        '                    Mail.From = New MailAddress("qdeer.ahmad@gmail.com", "Qadir", System.Text.Encoding.UTF8)
        ...
        '                    Mail.To.Add("qdeer.ahmad@gmail.com")
        '                    Mail.DeliveryNotificationOptions = DeliveryNotificationOptions.OnFailure
        '                    Mail.ReplyTo = New MailAddress("qdeer.ahmad@gmail.com")
        '                    Dim client As New SmtpClient("smtp.mail.yahoo.com")
        '                    client.Credentials = New System.Net.NetworkCredential("qdeer.ahmad@gmail.com", "qdeer.ahmad@12345")
    ...
    Private Sub Send_Email(ByVal emailAddress As String)
        ...
        Try
            ...
            While reader.Read
                ...
                mail.Attachments.Add(New Attachment("E:\HMIS (02-07-19)\App\Pathology\Patientlabreports\" + CreateName))
                SmtpServer.Port = 587
    ...
    Private Sub SendEmailNew()
        ...
        Dim smtp As SmtpClient = New SmtpClient(smtpAddress, portNumber)
        smtp.Credentials = New NetworkCredential(emailFrom, password)
        'smtp.EnableSsl = enableSSL
        Try
            smtp.Send(mail)
            Response.Write("Email Sended Successfully")
    ...
    Private Sub SendEmail()
        ...
        'Dim Emails As String = grow.Cells(0).Text.Trim()
        'Dim file As String = Server.MapPath("~/Mail.html")
        'Dim mailbody As String = System.IO.File.ReadAllText(file)
        Dim mailbody As String = "Mail For Checj here..."
        Dim mailto As String = txtEmail.Text.Trim()
        Dim mailfrom As String = ""
        Dim msg As MailMessage = New MailMessage(mailfrom, mailto)
        msg.Subject = "Auto Response Email"
        msg.Body = mailbody
        'msg.BodyEncoding = Encoding.UTF8
        'msg.IsBodyHtml = True
        Dim client As SmtpClient = New SmtpClient("smtp.mail.yahoo.com", 25)
        client.DeliveryMethod = SmtpDeliveryMethod.Network
        client.UseDefaultCredentials = False
        Dim basicCredential As System.Net.NetworkCredential = New System.Net.NetworkCredential("", "")
        ...
        '    oMail.From = "raazidiagnosticsrwp@yahoo.com"
        '    oMail.[To] = ""
        '    oMail.Subject = "test email from yahoo account"
        '    oMail.TextBody = "this is a test email sent from c# project with yahoo."
        '    Dim oServer As SmtpServer = New SmtpServer("smtp.mail.yahoo.com")
        '    oServer.User = "raazidiagnosticsrwp@yahoo.com"
        '    oServer.Password = "urinere"
        '    oServer.Port = 25
    ...
    Sub Load_Crystal_Report(ByVal tGId As Integer, ByVal tBId As Integer, ByVal tBName As String)
        ...
        Try
            ...
            path_admin_table.Fill(path_admin.Tables("pro_Test_RangeValues"), Session("RegistrationNo"), tGId)
            Try
            ...
            End Try
            Dim fName As String = "D:\Applications\Office Application\App\Pathology\Email\TestReport.pdf"
